...
Console.WriteLine(Codex_multi_func_test.main());
...
public static class Codex_multi_func_test
{
    ...
    public static long apply_twice(long x, Func<long, Func<long, long>> f, long y)
    {
        return f(f(x)(y))(y);
    }
    ...
    {
        return apply_twice(3L, (a) => (b) => add(a, b), 5L);
    }
