...
public static class Codex_path_echo_test
{
    public static object main()
    {
        return ((Func<object>)(() => {
                var path = _Cce.FromUnicode(Console.ReadLine() ?? "");
                ((Func<object>)(() => { Console.WriteLine(_Cce.ToUnicode(path)); return null; }))();
                var content = _Cce.FromUnicode(File.ReadAllText(_Cce.ToUnicode(path)));
                ((Func<object>)(() => { Console.WriteLine(_Cce.ToUnicode(content)); return null; }))();
                ((Func<object>)(() => { Console.WriteLine(_Cce.ToUnicode(string.Concat("\u0017\u000D\u0012\u001D\u000E\u0014E\u0002", _Cce.FromUnicode(Convert.ToString(((long)content.Length)))))); return null; }))();
                return null;
            }))();
    }
