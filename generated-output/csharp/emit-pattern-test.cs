...
Console.WriteLine(Codex_emit_pattern_test.main());
...
public static class Codex_emit_pattern_test
{
    public static long eval(Expr e)
    {
        return ((Func<Expr, long>)((_scrutinee0_) => (_scrutinee0_ is Lit _mLit0_ ? ((Func<long, long>)((n) => n))((long)_mLit0_.Field0) : (_scrutinee0_ is Add _mAdd0_ ? ((Func<Expr, long>)((b) => ((Func<Expr, long>)((a) => (eval(a) + eval(b))))((Expr)_mAdd0_.Field0)))((Expr)_mAdd0_.Field1) : (_scrutinee0_ is Mul _mMul0_ ? ((Func<Expr, long>)((b) => ((Func<Expr, long>)((a) => (eval(a) * eval(b))))((Expr)_mMul0_.Field0)))((Expr)_mMul0_.Field1) : throw new InvalidOperationException("Non-exhaustive match"))))))(e);
    }

    public static long count_nodes(Expr e, long acc)
    {
        while (true)
        {
            var _tco_s = e;
            if (_tco_s is Lit _tco_m0)
            {
                var n = _tco_m0.Field0;
                return (acc + 1L);
            }
            else if (_tco_s is Add _tco_m1)
            {
                var a = _tco_m1.Field0;
                var b = _tco_m1.Field1;
                var _tco_0 = b;
                var _tco_1 = count_nodes(a, (acc + 1L));
                e = _tco_0;
                acc = _tco_1;
                continue;
            }
            else if (_tco_s is Mul _tco_m2)
            {
                var a = _tco_m2.Field0;
                var b = _tco_m2.Field1;
                var _tco_0 = b;
                var _tco_1 = count_nodes(a, (acc + 1L));
                e = _tco_0;
                acc = _tco_1;
    ...
    {
        return count_nodes(new Add(new Lit(1L), new Mul(new Lit(2L), new Lit(3L))), 0L);
    }
