...
Console.WriteLine(Codex_tco_list_test6.main());
...
public static class Codex_tco_list_test6
{
    public static long main()
    {
        return ((long)Enumerable.Concat(new List<T0>(), new List<T0>() { 1L, 2L, 3L }).ToList().Count);
    }
