...
Console.WriteLine(Codex_many_ctor_test.main());

public abstract record Expr;

public sealed record A0(long Field0) : Expr;
public sealed record A1(long Field0) : Expr;
public sealed record A2(long Field0) : Expr;
public sealed record A3(long Field0) : Expr;
public sealed record A4(long Field0) : Expr;
public sealed record A5(long Field0) : Expr;
public sealed record A6(long Field0) : Expr;
public sealed record A7(long Field0) : Expr;
public sealed record A8(long Field0) : Expr;
public sealed record A9(long Field0) : Expr;
public sealed record Apply(Expr Field0, Expr Field1, long Field2) : Expr;
...
public static class Codex_many_ctor_test
{
    public static List<Expr> collect(Expr e, List<Expr> acc)
    {
        while (true)
        {
            var _tco_s = e;
            if (_tco_s is Apply _tco_m0)
            {
                var f = _tco_m0.Field0;
                var a = _tco_m0.Field1;
                var ty = _tco_m0.Field2;
                var _tco_0 = f;
                var _tco_1 = Enumerable.Concat(new List<Expr>() { a }, acc).ToList();
                e = _tco_0;
                acc = _tco_1;
                continue;
            }
    ...
    {
        return ((long)collect(new Apply(new Apply(new Lit(1L), new Lit(2L), 0L), new Lit(3L), 0L), new List<Expr>()).Count);
    }
