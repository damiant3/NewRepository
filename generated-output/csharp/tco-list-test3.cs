...
Console.WriteLine(Codex_tco_list_test3.main());
...
public static class Codex_tco_list_test3
{
    public static long main()
    {
        return ((long)Enumerable.Concat(new List<T0>() { 1L }, new List<T0>() { 2L, 3L }).ToList().Count);
    }
