...
Console.WriteLine(Codex_tco_list_test5.main());
...
public static class Codex_tco_list_test5
{
    public static long main()
    {
        return ((long)Enumerable.Concat(new List<T0>() { 1L, 2L }, new List<T0>() { 3L, 4L, 5L }).ToList().Count);
    }
