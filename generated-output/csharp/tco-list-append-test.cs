...
Console.WriteLine(Codex_tco_list_append_test.main());
...
public static class Codex_tco_list_append_test
{
    public static List<long> collect(long n, List<long> acc)
    {
        while (true)
        {
            if ((n == 0L))
            ...
            {
                var _tco_0 = (n - 1L);
                var _tco_1 = Enumerable.Concat(new List<long>() { n }, acc).ToList();
                n = _tco_0;
                acc = _tco_1;
                continue;
            }
    ...
    {
        return ((long)collect(5L, new List<long>()).Count);
    }
