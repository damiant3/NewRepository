...
public static class Codex_Codex_Codex
{
    ...
    public static List<T238> map_list<T228, T238>(Func<T228, T238> f, List<T228> xs) => map_list_loop(f, xs, 0L, ((long)xs.Count), new List<T238>());
    ...
    public static T266 fold_list<T266, T257>(Func<T266, Func<T257, T266>> f, T266 z, List<T257> xs) => fold_list_loop(f, z, xs, 0L, ((long)xs.Count));
    ...
    public static string csharp_emitter_emit_type_defs(List<ATypeDef> tds, long i) => ((i == ((long)tds.Count)) ? "" : (csharp_emitter_emit_type_def(tds[(int)i]) + ("\u0001" + csharp_emitter_emit_type_defs(tds, (i + 1L)))));

    public static string csharp_emitter_emit_type_def(ATypeDef td) => td switch { ARecordTypeDef(var name, var tparams, var fields) => ((Func<string, string>)((gen) => ("public sealed record " + (sanitize(name.value) + (gen + ("(" + (csharp_emitter_emit_record_field_defs(fields, tparams, 0L) + ");\u0001")))))))(emit_tparameter_suffix(tparams)), AVariantTypeDef(var name, var tparams, var ctors) => ((Func<string, string>)((gen) => ("public abstract record " + (sanitize(name.value) + (gen + (";\u0001" + (csharp_emitter_emit_variant_ctors(ctors, name, tparams, 0L) + "\u0001")))))))(emit_tparameter_suffix(tparams)), _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string emit_tparameter_suffix(List<Name> tparams) => ((((long)tparams.Count) == 0L) ? "" : ("<" + (emit_tparameter_names(tparams, 0L) + ">")));

    public static string emit_tparameter_names(List<Name> tparams, long i) => ((i == ((long)tparams.Count)) ? "" : ((i == (((long)tparams.Count) - 1L)) ? ("T" + _Cce.FromUnicode(i.ToString())) : ("T" + (_Cce.FromUnicode(i.ToString()) + (", " + emit_tparameter_names(tparams, (i + 1L)))))));

    public static string csharp_emitter_emit_record_field_defs(List<ARecordFieldDef> fields, List<Name> tparams, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<ARecordFieldDef, string>)((f) => (emit_type_expr_tp(f.type_expr, tparams) + (" " + (sanitize(f.name.value) + (((i < (((long)fields.Count) - 1L)) ? ", " : "") + csharp_emitter_emit_record_field_defs(fields, tparams, (i + 1L))))))))(fields[(int)i]));

    public static string csharp_emitter_emit_variant_ctors(List<AVariantCtorDef> ctors, Name base_name, List<Name> tparams, long i) => ((i == ((long)ctors.Count)) ? "" : ((Func<AVariantCtorDef, string>)((c) => (emit_variant_ctor(c, base_name, tparams) + csharp_emitter_emit_variant_ctors(ctors, base_name, tparams, (i + 1L)))))(ctors[(int)i]));

    public static string emit_variant_ctor(AVariantCtorDef c, Name base_name, List<Name> tparams) => ((Func<string, string>)((gen) => ((((long)c.fields.Count) == 0L) ? ("public sealed record " + (sanitize(c.name.value) + (gen + (" : " + (sanitize(base_name.value) + (gen + ";\u0001")))))) : ("public sealed record " + (sanitize(c.name.value) + (gen + ("(" + (csharp_emitter_emit_ctor_fields(c.fields, tparams, 0L) + (") : " + (sanitize(base_name.value) + (gen + ";\u0001")))))))))))(emit_tparameter_suffix(tparams));

    public static string csharp_emitter_emit_ctor_fields(List<ATypeExpr> fields, List<Name> tparams, long i) => ((i == ((long)fields.Count)) ? "" : (emit_type_expr_tp(fields[(int)i], tparams) + (" Field" + (_Cce.FromUnicode(i.ToString()) + (((i < (((long)fields.Count) - 1L)) ? ", " : "") + csharp_emitter_emit_ctor_fields(fields, tparams, (i + 1L)))))));

    public static string csharp_emitter_emit_type_expr(ATypeExpr te) => emit_type_expr_tp(te, new List<Name>());

    public static string emit_type_expr_tp(ATypeExpr te, List<Name> tparams) => te switch { ANamedType(var name) => ((Func<long, string>)((idx) => ((idx >= 0L) ? ("T" + _Cce.FromUnicode(idx.ToString())) : when_type_name(name.value))))(find_tparam_index(tparams, name.value, 0L)), AFunType(var p, var r) => ("Func<" + (emit_type_expr_tp(p, tparams) + (", " + (emit_type_expr_tp(r, tparams) + ">")))), AAppType(var @base, var args) => (emit_type_expr_tp(@base, tparams) + ("<" + (emit_type_expr_list_tp(args, tparams, 0L) + ">"))), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string emit_type_expr_list(List<ATypeExpr> args, long i) => ((i == ((long)args.Count)) ? "" : (csharp_emitter_emit_type_expr(args[(int)i]) + (((i < (((long)args.Count) - 1L)) ? ", " : "") + emit_type_expr_list(args, (i + 1L)))));

    public static string emit_type_expr_list_tp(List<ATypeExpr> args, List<Name> tparams, long i) => ((i == ((long)args.Count)) ? "" : (emit_type_expr_tp(args[(int)i], tparams) + (((i < (((long)args.Count) - 1L)) ? ", " : "") + emit_type_expr_list_tp(args, tparams, (i + 1L)))));
    ...
    public static string generic_suffix(CodexType ty) => ((Func<List<long>, string>)((ids) => ((((long)ids.Count) == 0L) ? "" : ("<" + (emit_type_params(ids, 0L) + ">")))))(collect_type_var_ids(ty, new List<long>()));

    public static string emit_type_params(List<long> ids, long i) => ((i == ((long)ids.Count)) ? "" : ((i == (((long)ids.Count) - 1L)) ? ("T" + _Cce.FromUnicode(ids[(int)i].ToString())) : ("T" + (_Cce.FromUnicode(ids[(int)i].ToString()) + (", " + emit_type_params(ids, (i + 1L)))))));

    public static string extract_ctor_type_args(CodexType ty) => ty switch { ConstructedTy(var name, var args) => ((((long)args.Count) == 0L) ? "" : ("<" + (emit_cs_type_args(args, 0L) + ">"))), _ => "", };
    ...
    public static bool csharp_emitter_should_tco(IRDef d) => ((((long)d.@params.Count) == 0L) ? false : csharp_emitter_has_tail_call(d.body, d.name));

    public static string emit_tco_def(IRDef d, List<ArityEntry> arities) => ((Func<CodexType, string>)((ret) => ((Func<string, string>)((gen) => ("    public static " + (cs_type(ret) + (" " + (sanitize(d.name) + (gen + ("(" + (csharp_emitter_emit_def_params(d.@params, 0L) + (")\u0001    {\u0001        while (true)\u0001        {\u0001" + (emit_tco_body(d.body, d.name, d.@params, arities) + "        }\u0001    }\u0001")))))))))))(generic_suffix(d.type_val))))(get_return_type(d.type_val, ((long)d.@params.Count)));
    ...
    public static string emit_tco_match(IRExpr scrut, List<IRBranch> branches, string func_name, List<IRParam> @params, List<ArityEntry> arities) => ("            var _tco_s = " + (csharp_emitter_emit_expr(scrut, arities) + (";\u0001" + emit_tco_match_branches(branches, func_name, @params, arities, 0L, true))));
    ...
    public static string emit_tco_jump(IRExpr e, List<IRParam> @params, List<ArityEntry> arities) => ((Func<ApplyChain, string>)((chain) => (emit_tco_temps(chain.args, arities, 0L) + (emit_tco_assigns(@params, 0L) + "            continue;\u0001"))))(collect_apply_chain(e, new List<IRExpr>()));

    public static string emit_tco_temps(List<IRExpr> args, List<ArityEntry> arities, long i) => ((i == ((long)args.Count)) ? "" : ("            var _tco_" + (_Cce.FromUnicode(i.ToString()) + (" = " + (csharp_emitter_emit_expr(args[(int)i], arities) + (";\u0001" + emit_tco_temps(args, arities, (i + 1L))))))));

    public static string emit_tco_assigns(List<IRParam> @params, long i) => ((i == ((long)@params.Count)) ? "" : ((Func<IRParam, string>)((p) => ("            " + (sanitize(p.name) + (" = _tco_" + (_Cce.FromUnicode(i.ToString()) + (";\u0001" + emit_tco_assigns(@params, (i + 1L)))))))))(@params[(int)i]));

    public static string csharp_emitter_emit_def(IRDef d, List<ArityEntry> arities) => (csharp_emitter_should_tco(d) ? emit_tco_def(d, arities) : ((Func<CodexType, string>)((ret) => ((Func<string, string>)((gen) => ("    public static " + (cs_type(ret) + (" " + (sanitize(d.name) + (gen + ("(" + (csharp_emitter_emit_def_params(d.@params, 0L) + (") => " + (csharp_emitter_emit_expr(d.body, arities) + ";\u0001")))))))))))(generic_suffix(d.type_val))))(get_return_type(d.type_val, ((long)d.@params.Count))));
    ...
    public static string csharp_emitter_emit_def_params(List<IRParam> @params, long i) => ((i == ((long)@params.Count)) ? "" : ((Func<IRParam, string>)((p) => (cs_type(p.type_val) + (" " + (sanitize(p.name) + (((i < (((long)@params.Count) - 1L)) ? ", " : "") + csharp_emitter_emit_def_params(@params, (i + 1L))))))))(@params[(int)i]));
    ...
    public static string cs_type(CodexType ty)
    {
        while (true)
        {
            ...
            {
            return (sanitize(name.value) + ("<" + (emit_cs_type_args(args, 0L) + ">")));
            }
            }
    ...
    public static string emit_cs_type_args(List<CodexType> args, long i) => ((i == ((long)args.Count)) ? "" : ((Func<string, string>)((t) => ((i == (((long)args.Count) - 1L)) ? t : (t + (", " + emit_cs_type_args(args, (i + 1L)))))))(cs_type(args[(int)i])));
    ...
    public static string csharp_emitter_emit_apply_args(List<IRExpr> args, List<ArityEntry> arities, long i) => ((i == ((long)args.Count)) ? "" : ((i == (((long)args.Count) - 1L)) ? csharp_emitter_emit_expr(args[(int)i], arities) : (csharp_emitter_emit_expr(args[(int)i], arities) + (", " + csharp_emitter_emit_apply_args(args, arities, (i + 1L))))));

    public static string emit_partial_params(long i, long count) => ((i == count) ? "" : ((i == (count - 1L)) ? ("_p" + (_Cce.FromUnicode(i.ToString()) + "_")) : ("_p" + (_Cce.FromUnicode(i.ToString()) + ("_" + (", " + emit_partial_params((i + 1L), count)))))));

    public static string emit_partial_wrappers(long i, long count) => ((i == count) ? "" : ("(_p" + (_Cce.FromUnicode(i.ToString()) + ("_) => " + emit_partial_wrappers((i + 1L), count)))));
    ...
    public static string csharp_emitter_emit_builtin(string n, List<IRExpr> args, List<ArityEntry> arities) => ((n == "show") ? emit_builtin_show(args, arities) : ((n == "negate") ? ("(-" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ")")) : ((n == "print-line") ? emit_builtin_print_line(args, arities) : ((n == "text-length") ? ("((long)" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ".Length)")) : ((n == "is-letter") ? emit_builtin_is_letter(args, arities) : ((n == "is-digit") ? emit_builtin_is_digit(args, arities) : ((n == "is-whitespace") ? ("(" + (csharp_emitter_emit_expr(args[(int)0L], arities) + " <= 2L)")) : ((n == "text-to-integer") ? emit_builtin_text_to_integer(args, arities) : ((n == "integer-to-text") ? emit_builtin_integer_to_text(args, arities) : ((n == "char-code") ? csharp_emitter_emit_expr(args[(int)0L], arities) : ((n == "char-code-at") ? emit_builtin_char_code_at(args, arities) : ((n == "code-to-char") ? csharp_emitter_emit_expr(args[(int)0L], arities) : ((n == "char-to-text") ? ("((char)" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ").ToString()")) : ((n == "list-length") ? ("((long)" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ".Count)")) : ((n == "char-at") ? emit_builtin_char_at(args, arities) : ((n == "substring") ? emit_builtin_substring(args, arities) : ((n == "list-at") ? emit_builtin_list_at(args, arities) : ((n == "list-insert-at") ? emit_builtin_list_insert_at(args, arities) : ((n == "list-snoc") ? emit_builtin_list_snoc(args, arities) : ((n == "text-compare") ? emit_builtin_text_compare(args, arities) : ((n == "text-replace") ? emit_builtin_text_replace(args, arities) : ((n == "open-file") ? ("File.OpenRead(" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ")")) : ((n == "read-all") ? emit_builtin_read_all(args, arities) : ((n == "close-file") ? (csharp_emitter_emit_expr(args[(int)0L], arities) + ".Dispose()") : ((n == "read-line") ? "_Cce.FromUnicode(Console.ReadLine() ?? \"\")" : ((n == "read-file") ? emit_builtin_read_file(args, arities) : ((n == "write-file") ? emit_builtin_write_file(args, arities) : ((n == "file-exists") ? emit_builtin_file_exists(args, arities) : ((n == "list-files") ? emit_builtin_list_files(args, arities) : ((n == "text-concat-list") ? ("string.Concat(" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ")")) : ((n == "text-split") ? emit_builtin_text_split(args, arities) : ((n == "text-contains") ? emit_builtin_text_contains(args, arities) : ((n == "text-starts-with") ? emit_builtin_text_starts_with(args, arities) : ((n == "get-args") ? "Environment.GetCommandLineArgs().Select(_Cce.FromUnicode).ToList()" : ((n == "get-env") ? emit_builtin_get_env(args, arities) : ((n == "run-process") ? emit_builtin_run_process(args, arities) : ((n == "current-dir") ? "_Cce.FromUnicode(Directory.GetCurrentDirectory())" : ((n == "fork") ? ("Task.Run(() => (" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ")(null))")) : ((n == "await") ? ("(" + (csharp_emitter_emit_expr(args[(int)0L], arities) + ").Result")) : ((n == "par") ? emit_builtin_par(args, arities) : ((n == "race") ? emit_builtin_race(args, arities) : "")))))))))))))))))))))))))))))))))))))))));

    public static string emit_builtin_show(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("_Cce.FromUnicode(Convert.ToString(" + (a0 + "))"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_print_line(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("((Func<object>)(() => { Console.WriteLine(_Cce.ToUnicode(" + (a0 + ")); return null; }))()"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_is_letter(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("(" + (a0 + (" >= 13L && " + (a0 + " <= 64L)"))))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_is_digit(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("(" + (a0 + (" >= 3L && " + (a0 + " <= 12L)"))))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_text_to_integer(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("long.Parse(_Cce.ToUnicode(" + (a0 + "))"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_integer_to_text(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("_Cce.FromUnicode(" + (a0 + ".ToString())"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_char_code_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("((long)" + (a0 + ("[(int)" + (a1 + "])"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_char_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("((long)" + (a0 + ("[(int)" + (a1 + "])"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_substring(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ((Func<string, string>)((a2) => (a0 + (".Substring((int)" + (a1 + (", (int)" + (a2 + ")")))))))(csharp_emitter_emit_expr(args[(int)2L], arities))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_list_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => (a0 + ("[(int)" + (a1 + "]")))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_list_insert_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<CodexType, string>)((elem_ty) => ((Func<string, string>)((ty) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ((Func<string, string>)((a2) => ("((Func<List<" + (ty + (">>)(() => { var _l = new List<" + (ty + (">(" + (a0 + ("); _l.Insert((int)" + (a1 + (", " + (a2 + "); return _l; }))()"))))))))))))(csharp_emitter_emit_expr(args[(int)2L], arities))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities))))(cs_type(elem_ty))))(ir_expr_type(args[(int)0L]) switch { ListTy(var et) => et, _ => new ErrorTy(), });

    public static string emit_builtin_list_snoc(List<IRExpr> args, List<ArityEntry> arities) => ((Func<CodexType, string>)((elem_ty) => ((Func<string, string>)((ty) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("((Func<List<" + (ty + (">>)(() => { var _l = " + (a0 + ("; _l.Add(" + (a1 + "); return _l; }))()"))))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities))))(cs_type(elem_ty))))(ir_expr_type(args[(int)0L]) switch { ListTy(var et) => et, _ => new ErrorTy(), });

    public static string emit_builtin_text_compare(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("(long)string.CompareOrdinal(" + (a0 + (", " + (a1 + ")"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_text_replace(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ((Func<string, string>)((a2) => (a0 + (".Replace(" + (a1 + (", " + (a2 + ")")))))))(csharp_emitter_emit_expr(args[(int)2L], arities))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_read_all(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("new System.IO.StreamReader(" + (a0 + ").ReadToEnd()"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_read_file(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("_Cce.FromUnicode(File.ReadAllText(_Cce.ToUnicode(" + (a0 + ")))"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_write_file(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("File.WriteAllText(_Cce.ToUnicode(" + (a0 + ("), _Cce.ToUnicode(" + (a1 + "))"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_file_exists(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("File.Exists(_Cce.ToUnicode(" + (a0 + "))"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_list_files(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("Directory.GetFiles(_Cce.ToUnicode(" + (a0 + ("), _Cce.ToUnicode(" + (a1 + ")).Select(_Cce.FromUnicode).ToList()"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_text_split(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("new List<string>(" + (a0 + (".Split(" + (a1 + "))"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_text_contains(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => (a0 + (".Contains(" + (a1 + ")")))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_text_starts_with(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => (a0 + (".StartsWith(" + (a1 + ")")))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_get_env(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("_Cce.FromUnicode(Environment.GetEnvironmentVariable(_Cce.ToUnicode(" + (a0 + ")) ?? \"\")"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_run_process(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("_Cce.FromUnicode(((Func<string>)(() => {" + (" var _psi = new System.Diagnostics.ProcessStartInfo(" + ("_Cce.ToUnicode(" + (a0 + ("), _Cce.ToUnicode(" + (a1 + ("))" + (" { RedirectStandardOutput = true, UseShellExecute = false };" + (" var _p = System.Diagnostics.Process.Start(_psi)!;" + (" var _o = _p.StandardOutput.ReadToEnd();" + " _p.WaitForExit(); return _o; }))()"))))))))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_par(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("Task.WhenAll(" + (a1 + (".Select(_x_ => Task.Run(() => (" + (a0 + ")(_x_)))).Result.ToList()"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_race(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("Task.WhenAny(" + (a0 + ".Select(_t_ => Task.Run(() => _t_(null)))).Result.Result"))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string csharp_emitter_emit_apply(IRExpr e, List<ArityEntry> arities) => ((Func<ApplyChain, string>)((chain) => ((Func<IRExpr, string>)((root) => ((Func<List<IRExpr>, string>)((args) => root switch { IrName(var n, var ty) => (is_builtin_name(n) ? csharp_emitter_emit_builtin(n, args, arities) : (((((long)n.Length) > 0L) && is_upper_letter(((long)n[(int)0L]))) ? ((Func<CodexType, string>)((result_ty) => ((Func<string, string>)((ctor_type_args) => ("new " + (sanitize(n) + (ctor_type_args + ("(" + (csharp_emitter_emit_apply_args(args, arities, 0L) + ")")))))))(extract_ctor_type_args(result_ty))))(ir_expr_type(e)) : ((Func<long, string>)((ar) => (((ar > 1L) && (((long)args.Count) == ar)) ? (sanitize(n) + ("(" + (csharp_emitter_emit_apply_args(args, arities, 0L) + ")"))) : (((ar > 1L) && (((long)args.Count) < ar)) ? ((Func<long, string>)((remaining) => (emit_partial_wrappers(0L, remaining) + (sanitize(n) + ("(" + (csharp_emitter_emit_apply_args(args, arities, 0L) + (", " + (emit_partial_params(0L, remaining) + ")"))))))))((ar - ((long)args.Count))) : emit_expr_curried(e, arities)))))(lookup_arity(arities, n)))), _ => emit_expr_curried(e, arities), }))(chain.args)))(chain.root)))(collect_apply_chain(e, new List<IRExpr>()));
    ...
    public static string csharp_emitter_escape_text(string s) => string.Concat(csharp_emitter_escape_text_loop(s, 0L, ((long)s.Length), new List<string>()));
    ...
    public static string csharp_emitter_emit_lambda(List<IRParam> @params, IRExpr body, List<ArityEntry> arities) => ((((long)@params.Count) == 0L) ? ("(() => " + (csharp_emitter_emit_expr(body, arities) + ")")) : ((((long)@params.Count) == 1L) ? ((Func<IRParam, string>)((p) => ("((" + (cs_type(p.type_val) + (" " + (sanitize(p.name) + (") => " + (csharp_emitter_emit_expr(body, arities) + ")"))))))))(@params[(int)0L]) : ("(() => " + (csharp_emitter_emit_expr(body, arities) + ")"))));

    public static string csharp_emitter_emit_list(List<IRExpr> elems, CodexType ty, List<ArityEntry> arities) => ((((long)elems.Count) == 0L) ? ("new List<" + (cs_type(ty) + ">()")) : ("new List<" + (cs_type(ty) + ("> { " + (csharp_emitter_emit_list_elems(elems, 0L, arities) + " }")))));

    public static string csharp_emitter_emit_list_elems(List<IRExpr> elems, long i, List<ArityEntry> arities) => ((i == ((long)elems.Count)) ? "" : ((i == (((long)elems.Count) - 1L)) ? csharp_emitter_emit_expr(elems[(int)i], arities) : (csharp_emitter_emit_expr(elems[(int)i], arities) + (", " + csharp_emitter_emit_list_elems(elems, (i + 1L), arities)))));

    public static string csharp_emitter_emit_match(IRExpr scrut, List<IRBranch> branches, CodexType ty, List<ArityEntry> arities) => ((Func<string, string>)((arms) => ((Func<bool, string>)((needs_wild) => (csharp_emitter_emit_expr(scrut, arities) + (" switch { " + (arms + ((needs_wild ? "_ => throw new InvalidOperationException(\"Non-exhaustive match\"), " : "") + "}"))))))((has_any_catch_all(branches, 0L) ? false : true))))(emit_match_arms(branches, 0L, arities));

    public static string emit_match_arms(List<IRBranch> branches, long i, List<ArityEntry> arities) => ((i == ((long)branches.Count)) ? "" : ((Func<IRBranch, string>)((arm) => ((Func<string, string>)((this_arm) => (is_catch_all(arm.pattern) ? this_arm : (this_arm + emit_match_arms(branches, (i + 1L), arities)))))((csharp_emitter_emit_pattern(arm.pattern) + (" => " + (csharp_emitter_emit_expr(arm.body, arities) + ", "))))))(branches[(int)i]));
    ...
    public static string csharp_emitter_emit_pattern(IRPat p) => p switch { IrVarPat(var name, var ty) => (cs_type(ty) + (" " + sanitize(name))), IrLitPat(var text, var ty) => text, IrCtorPat(var name, var subs, var ty) => ((((long)subs.Count) == 0L) ? (sanitize(name) + " { }") : (sanitize(name) + ("(" + (csharp_emitter_emit_sub_patterns(subs, 0L) + ")")))), IrWildPat { } => "_", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string csharp_emitter_emit_sub_patterns(List<IRPat> subs, long i) => ((i == ((long)subs.Count)) ? "" : ((Func<IRPat, string>)((sub) => (emit_sub_pattern(sub) + (((i < (((long)subs.Count) - 1L)) ? ", " : "") + csharp_emitter_emit_sub_patterns(subs, (i + 1L))))))(subs[(int)i]));
    ...
    public static string csharp_emitter_emit_do(List<IRDoStmt> stmts, CodexType ty, List<ArityEntry> arities) => ((Func<string, string>)((ret_type) => ((Func<long, string>)((len) => ty switch { VoidTy { } => ("((Func<object>)(() => { " + (csharp_emitter_emit_do_stmts(stmts, 0L, len, false, arities) + " return null; }))()")), NothingTy { } => ("((Func<object>)(() => { " + (csharp_emitter_emit_do_stmts(stmts, 0L, len, false, arities) + " return null; }))()")), ErrorTy { } => ("((Func<object>)(() => { " + (csharp_emitter_emit_do_stmts(stmts, 0L, len, false, arities) + " return null; }))()")), _ => ((len == 0L) ? ("((Func<" + (ret_type + ">)(() => { return null; }))()")) : ("((Func<" + (ret_type + (">)(() => { " + (csharp_emitter_emit_do_stmts(stmts, 0L, len, true, arities) + " }))()"))))), }))(((long)stmts.Count))))(cs_type(ty));

    public static string csharp_emitter_emit_do_stmts(List<IRDoStmt> stmts, long i, long len, bool needs_return, List<ArityEntry> arities) => ((i == len) ? "" : ((Func<IRDoStmt, string>)((s) => ((Func<bool, string>)((is_last) => ((Func<bool, string>)((use_return) => (csharp_emitter_emit_do_stmt(s, use_return, arities) + (" " + csharp_emitter_emit_do_stmts(stmts, (i + 1L), len, needs_return, arities)))))((is_last ? needs_return : false))))((i == (len - 1L)))))(stmts[(int)i]));
    ...
    public static string csharp_emitter_emit_record(string name, List<IRFieldVal> fields, List<ArityEntry> arities) => ("new " + (sanitize(name) + ("(" + (emit_record_fields(fields, 0L, arities) + ")"))));

    public static string emit_record_fields(List<IRFieldVal> fields, long i, List<ArityEntry> arities) => ((i == ((long)fields.Count)) ? "" : ((Func<IRFieldVal, string>)((f) => (sanitize(f.name) + (": " + (csharp_emitter_emit_expr(f.value, arities) + (((i < (((long)fields.Count) - 1L)) ? ", " : "") + emit_record_fields(fields, (i + 1L), arities)))))))(fields[(int)i]));
    ...
    public static string codex_emitter_emit_type_defs(List<ATypeDef> tds, long i) => ((i == ((long)tds.Count)) ? "" : (codex_emitter_emit_type_def(tds[(int)i]) + ("\u0001" + codex_emitter_emit_type_defs(tds, (i + 1L)))));

    public static string codex_emitter_emit_type_def(ATypeDef td) => td switch { ARecordTypeDef(var name, var tparams, var fields) => (name.value + (" = record {" + (codex_emitter_emit_record_field_defs(fields, 0L) + "\u0001}\u0001"))), AVariantTypeDef(var name, var tparams, var ctors) => (name.value + (" =\u0001" + codex_emitter_emit_variant_ctors(ctors, 0L))), _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string codex_emitter_emit_record_field_defs(List<ARecordFieldDef> fields, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<ARecordFieldDef, string>)((f) => ((Func<string, string>)((comma) => (comma + ("\u0001 " + (f.name.value + (" : " + (codex_emitter_emit_type_expr(f.type_expr) + codex_emitter_emit_record_field_defs(fields, (i + 1L)))))))))(((i > 0L) ? "," : ""))))(fields[(int)i]));

    public static string codex_emitter_emit_variant_ctors(List<AVariantCtorDef> ctors, long i) => ((i == ((long)ctors.Count)) ? "" : ((Func<AVariantCtorDef, string>)((c) => (" | " + (c.name.value + (codex_emitter_emit_ctor_fields(c.fields, 0L) + ("\u0001" + codex_emitter_emit_variant_ctors(ctors, (i + 1L))))))))(ctors[(int)i]));

    public static string codex_emitter_emit_ctor_fields(List<ATypeExpr> fields, long i) => ((i == ((long)fields.Count)) ? "" : (" (" + (codex_emitter_emit_type_expr(fields[(int)i]) + (")" + codex_emitter_emit_ctor_fields(fields, (i + 1L))))));

    public static string codex_emitter_emit_type_expr(ATypeExpr te) => te switch { ANamedType(var name) => name.value, AFunType(var p, var r) => ("(" + (codex_emitter_emit_type_expr(p) + (" -> " + (codex_emitter_emit_type_expr(r) + ")")))), AAppType(var @base, var args) => (codex_emitter_emit_type_expr(@base) + (" " + emit_type_expr_args(args, 0L))), AEffectType(var effs, var ret) => ("[" + (emit_effect_names(effs, 0L) + ("] " + codex_emitter_emit_type_expr(ret)))), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string emit_effect_names(List<Name> effs, long i) => ((i == ((long)effs.Count)) ? "" : ((Func<string, string>)((sep) => (sep + (effs[(int)i].value + emit_effect_names(effs, (i + 1L))))))(((i > 0L) ? ", " : "")));
    ...
    public static string emit_type(CodexType ty)
    {
        while (true)
        {
            ...
            else if (_tco_s is EffectfulTy _tco_m15)
            {
                ...
                var ret = _tco_m15.Field1;
            return ("[" + (emit_type_effect_names(effs, 0L) + ("] " + emit_type(ret))));
            }
        }
    }
    ...
    public static string emit_type_effect_names(List<Name> effs, long i) => ((i == ((long)effs.Count)) ? "" : ((Func<string, string>)((sep) => (sep + (effs[(int)i].value + emit_type_effect_names(effs, (i + 1L))))))(((i > 0L) ? ", " : "")));

    public static string codex_emitter_emit_def(IRDef d, List<string> ctor_names) => (skip_def(d, ctor_names) ? "" : ((Func<string, string>)((sig) => (sig + (" =\u0001 " + (codex_emitter_emit_expr(d.body, ctor_names, 1L) + "\u0001")))))((d.name + (" : " + (emit_type(d.type_val) + ("\u0001" + (d.name + codex_emitter_emit_def_params(d.@params, 0L))))))));

    public static bool is_match_body(IRExpr e) => e switch { IrMatch(var scrut, var branches, var ty) => true, _ => false, };

    public static bool skip_def(IRDef d, List<string> ctor_names) => (list_contains(ctor_names, d.name) ? true : ((((long)d.name.Length) == 0L) ? true : ((Func<long, bool>)((first) => ((first < 13L) ? true : ((first > 38L) ? true : false))))(((long)d.name[(int)0L]))));

    public static bool is_upper(long c) => ((Func<long, bool>)((code) => ((Func<long, bool>)((code_z) => ((c >= code) && (c <= code_z))))(((long)"Z"[(int)0L]))))(((long)"A"[(int)0L]));
    ...
    public static long bin_op_prec(IRBinaryOp op) => op switch { IrOr { } => 2L, IrAnd { } => 3L, IrEq { } => 4L, IrNotEq { } => 4L, IrLt { } => 4L, IrGt { } => 4L, IrLtEq { } => 4L, IrGtEq { } => 4L, IrAppendText { } => 5L, IrAppendList { } => 5L, IrConsList { } => 5L, IrAddInt { } => 6L, IrSubInt { } => 6L, IrAddNum { } => 6L, IrSubNum { } => 6L, IrMulInt { } => 7L, IrDivInt { } => 7L, IrMulNum { } => 7L, IrDivNum { } => 7L, IrPowInt { } => 8L, _ => 0L, };
    ...
    public static string codex_emitter_emit_let(string name, IRExpr val, IRExpr body, List<string> ctors, long indent) => ("let " + (name + (" = " + (codex_emitter_emit_expr(val, ctors, (indent + 1L)) + ("\u0001" + (make_indent(indent) + ("in " + emit_let_body(body, ctors, indent))))))));

    public static string emit_let_body(IRExpr body, List<string> ctors, long indent) => body switch { IrIf(var c, var t, var el, var ty) => codex_emitter_emit_if(c, t, el, ctors, indent, 3L), _ => codex_emitter_emit_expr(body, ctors, indent), };

    public static string codex_emitter_emit_apply(IRExpr e, List<string> ctors, long indent) => ((Func<ApplyChain, string>)((chain) => ((Func<IRExpr, string>)((func) => ((Func<List<IRExpr>, string>)((args) => (codex_emitter_emit_expr(func, ctors, indent) + codex_emitter_emit_apply_args(args, ctors, indent, 0L, ((long)args.Count), is_ctor_name(func, ctors)))))(chain.args)))(chain.root)))(collect_apply_chain(e, new List<IRExpr>()));

    public static string codex_emitter_emit_apply_args(List<IRExpr> args, List<string> ctors, long indent, long i, long len, bool is_ctor) => ((i == len) ? "" : ((Func<IRExpr, string>)((arg) => (" " + (wrap_arg(arg, ctors, indent, is_ctor) + codex_emitter_emit_apply_args(args, ctors, indent, (i + 1L), len, is_ctor)))))(args[(int)i]));
    ...
    public static string codex_emitter_emit_lambda(List<IRParam> @params, IRExpr body, List<string> ctors, long indent) => ("\\" + (emit_lambda_params(@params, 0L) + (" -> " + codex_emitter_emit_expr(body, ctors, indent))));

    public static string emit_lambda_params(List<IRParam> @params, long i) => ((i == ((long)@params.Count)) ? "" : ((Func<IRParam, string>)((p) => ((Func<string, string>)((sep) => (sep + (p.name + emit_lambda_params(@params, (i + 1L))))))(((i > 0L) ? " " : ""))))(@params[(int)i]));

    public static string codex_emitter_emit_list(List<IRExpr> elems, List<string> ctors, long indent) => ("[" + (codex_emitter_emit_list_elems(elems, ctors, indent, 0L) + "]"));

    public static string codex_emitter_emit_list_elems(List<IRExpr> elems, List<string> ctors, long indent, long i) => ((i == ((long)elems.Count)) ? "" : ((Func<string, string>)((sep) => (sep + (codex_emitter_emit_expr(elems[(int)i], ctors, indent) + codex_emitter_emit_list_elems(elems, ctors, indent, (i + 1L))))))(((i > 0L) ? ", " : "")));

    public static string codex_emitter_emit_match(IRExpr scrut, List<IRBranch> branches, List<string> ctors, long indent) => ("when " + (codex_emitter_emit_expr(scrut, ctors, indent) + emit_branches(branches, ctors, indent, 0L)));

    public static string emit_branches(List<IRBranch> branches, List<string> ctors, long indent, long i) => ((i == ((long)branches.Count)) ? "" : ((Func<IRBranch, string>)((b) => ("\u0001" + (make_indent((indent + 1L)) + ("if " + (codex_emitter_emit_pattern(b.pattern) + (" -> " + (codex_emitter_emit_expr(b.body, ctors, (indent + 1L)) + emit_branches(branches, ctors, indent, (i + 1L))))))))))(branches[(int)i]));

    public static string codex_emitter_emit_pattern(IRPat p) => p switch { IrVarPat(var name, var ty) => name, IrLitPat(var text, var ty) => text, IrCtorPat(var name, var subs, var ty) => (name + codex_emitter_emit_sub_patterns(subs, 0L)), IrWildPat { } => "_", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string codex_emitter_emit_sub_patterns(List<IRPat> subs, long i) => ((i == ((long)subs.Count)) ? "" : (" (" + (codex_emitter_emit_pattern(subs[(int)i]) + (")" + codex_emitter_emit_sub_patterns(subs, (i + 1L))))));

    public static string codex_emitter_emit_do(List<IRDoStmt> stmts, List<string> ctors, long indent) => ("do" + codex_emitter_emit_do_stmts(stmts, ctors, indent, 0L));

    public static string codex_emitter_emit_do_stmts(List<IRDoStmt> stmts, List<string> ctors, long indent, long i) => ((i == ((long)stmts.Count)) ? "" : ((Func<IRDoStmt, string>)((s) => ("\u0001" + (make_indent((indent + 1L)) + (codex_emitter_emit_do_stmt(s, ctors, (indent + 1L)) + codex_emitter_emit_do_stmts(stmts, ctors, indent, (i + 1L)))))))(stmts[(int)i]));
    ...
    public static string codex_emitter_emit_record(string name, List<IRFieldVal> fields, List<string> ctors, long indent) => ((((long)fields.Count) <= 1L) ? (name + (" {" + (emit_record_fields_inline(fields, ctors, indent, 0L) + " }"))) : (name + (" {\u0001" + (emit_record_fields_multi(fields, ctors, indent, 0L) + (make_indent(indent) + "}")))));

    public static string emit_record_fields_inline(List<IRFieldVal> fields, List<string> ctors, long indent, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<IRFieldVal, string>)((f) => ((Func<string, string>)((sep) => (sep + (" " + (f.name + (" = " + (codex_emitter_emit_expr(f.value, ctors, indent) + emit_record_fields_inline(fields, ctors, indent, (i + 1L)))))))))(((i > 0L) ? "," : ""))))(fields[(int)i]));

    public static string emit_record_fields_multi(List<IRFieldVal> fields, List<string> ctors, long indent, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<IRFieldVal, string>)((f) => ((Func<string, string>)((comma) => (make_indent((indent + 1L)) + (f.name + (" = " + (codex_emitter_emit_expr(f.value, ctors, (indent + 1L)) + (comma + ("\u0001" + emit_record_fields_multi(fields, ctors, indent, (i + 1L))))))))))(((i < (((long)fields.Count) - 1L)) ? "," : ""))))(fields[(int)i]));
    ...
    public static string codex_emitter_emit_handle(string eff, IRExpr body, List<IRHandleClause> clauses, List<string> ctors, long indent) => ("handle " + (codex_emitter_emit_expr(body, ctors, indent) + (" with" + codex_emitter_emit_handle_clauses(clauses, ctors, indent, 0L))));
    ...
    public static string codex_emitter_escape_text(string s) => codex_emitter_escape_text_loop(s, 0L, ((long)s.Length), "");
    ...
    public static string escape_one_char(long c) => ((c == ((long)"\\"[(int)0L])) ? "\\\\" : ((c == ((long)"\""[(int)0L])) ? "\\\"" : ((c == ((long)"\u0001"[(int)0L])) ? "\\n" : ((char)c).ToString())));

    public static string escape_char(long c) => ((c == ((long)"\u0001"[(int)0L])) ? "\\n" : ((c == ((long)"\\"[(int)0L])) ? "\\\\" : ((c == ((long)"'"[(int)0L])) ? "\\'" : ((char)c).ToString())));

    public static string codex_emitter_emit_full_chapter(IRChapter m, List<ATypeDef> type_defs) => ((Func<List<string>, string>)((ctor_names) => ((Func<string, string>)((header) => (header + (codex_emitter_emit_type_defs(type_defs, 0L) + codex_emitter_emit_all_defs(m.defs, ctor_names, 0L)))))(((m.chapter_title == "") ? "" : ("Chapter: " + (m.chapter_title + ("\u0001\u0001" + ((m.prose == "") ? "" : (" " + (m.prose + "\u0001\u0001"))))))))))(codex_emitter_collect_ctor_names(type_defs, 0L));

    public static string codex_emitter_emit_all_defs(List<IRDef> defs, List<string> ctor_names, long i) => ((i == ((long)defs.Count)) ? "" : (codex_emitter_emit_def(defs[(int)i], ctor_names) + ("\u0001" + codex_emitter_emit_all_defs(defs, ctor_names, (i + 1L)))));

    public static string emit_def_list(List<IRDef> defs, List<string> ctor_names, long i) => ((i == ((long)defs.Count)) ? "" : (codex_emitter_emit_def(defs[(int)i], ctor_names) + ("\u0001" + emit_def_list(defs, ctor_names, (i + 1L)))));
    ...
    public static long body_depth(IRExpr e) => e switch { IrName(var n, var ty) => 1L, IrIntLit(var n) => 1L, IrTextLit(var s) => 1L, IrBoolLit(var b) => 1L, IrFieldAccess(var r, var f, var ty) => 2L, IrApply(var f, var a, var ty) => (3L + body_depth(f)), IrLet(var name, var ty, var val, var body) => (5L + body_depth(body)), IrIf(var c, var t, var el, var ty) => (5L + body_depth(t)), IrMatch(var s, var bs, var ty) => 10L, IrLambda(var ps, var b, var ty) => 5L, IrDo(var stmts, var ty) => 5L, IrRecord(var n, var fs, var ty) => 3L, _ => 1L, };
    ...
    public static long elf_bare_metal_heap_size() => 2097152L;
    ...
    public static long lookup_func_offset(List<FuncOffset> entries, string name) => lookup_func_offset_loop(entries, name, 0L, ((long)entries.Count));
    ...
    public static CodegenState patch_jcc_at(CodegenState st, long jcc_pos, long target_pos) => ((Func<long, CodegenState>)((rel32) => st_with_text(st, patch_i32_at(st.text, (jcc_pos + 2L), rel32))))((target_pos - (jcc_pos + 6L)));

    public static CodegenState patch_jmp_at(CodegenState st, long jmp_pos, long target_pos) => ((Func<long, CodegenState>)((rel32) => st_with_text(st, patch_i32_at(st.text, (jmp_pos + 1L), rel32))))((target_pos - (jmp_pos + 5L)));

    public static CodegenState patch_call_at(CodegenState st, long call_pos, long target_pos) => ((Func<long, CodegenState>)((rel32) => st_with_text(st, patch_i32_at(st.text, (call_pos + 1L), rel32))))((target_pos - (call_pos + 5L)));
    ...
    public static CodegenState patch_calls(CodegenState st) => ((Func<List<PatchEntry>, CodegenState>)((entries) => st_with_text(st, apply_all_patches(st.text, entries))))(collect_call_patches(st.call_patches, st.func_offsets, 0L, new List<PatchEntry>()));
    ...
    public static bool x86_64_code_generator_should_tco(IRDef def) => ((((long)def.@params.Count) > 0L) ? x86_64_code_generator_has_tail_call(def.body, def.name) : false);
    ...
    public static EmitResult x86_64_code_generator_emit_record(CodegenState st, List<IRFieldVal> fields, CodexType ty) => ((Func<EvalFieldsResult, EmitResult>)((evaled) => ((Func<long, EmitResult>)((field_count) => ((Func<long, EmitResult>)((total_size) => ((Func<EmitResult, EmitResult>)((ptr_loc) => ((Func<EmitResult, EmitResult>)((ptr_tmp) => ((Func<CodegenState, EmitResult>)((st1) => ((Func<CodegenState, EmitResult>)((st2) => ((Func<CodegenState, EmitResult>)((st3) => ((Func<CodegenState, EmitResult>)((st4) => load_local(st4, ptr_loc.reg)))(ty switch { RecordTy(var rname, var type_fields) => emit_store_record_fields_by_type(st3, type_fields, evaled.field_locals, ptr_loc.reg, 0L), _ => emit_store_record_fields_by_list(st3, evaled.field_locals, ptr_loc.reg, 0L), })))(st_append_text(st2, add_ri(reg_r10(), total_size)))))(store_local(st1, ptr_loc.reg, ptr_tmp.reg))))(st_append_text(ptr_tmp.state, mov_rr(ptr_tmp.reg, reg_r10())))))(alloc_temp(ptr_loc.state))))(alloc_local(evaled.state))))((field_count * 8L))))(((long)fields.Count))))(emit_eval_record_fields(st, fields, 0L, new List<FieldLocal>()));

    public static EmitResult x86_64_code_generator_emit_field_access(CodegenState st, IRExpr rec_expr, string field_name) => ((Func<CodexType, EmitResult>)((rec_ty) => ((Func<long, EmitResult>)((field_idx) => ((Func<EmitResult, EmitResult>)((rec_result) => ((Func<EmitResult, EmitResult>)((rd) => new EmitResult(state: st_append_text(rd.state, mov_load(rd.reg, rec_result.reg, (field_idx * 8L))), reg: rd.reg)))(alloc_temp(rec_result.state))))(x86_64_code_generator_emit_expr(st, rec_expr))))(rec_ty switch { RecordTy(var rname, var rfields) => find_record_field_index(rfields, field_name, 0L), _ => 0L, })))(ir_expr_type(rec_expr));

    public static EmitResult x86_64_code_generator_emit_match(CodegenState st, IRExpr scrut_expr, List<IRBranch> branches) => ((Func<bool, EmitResult>)((saved_tail) => ((Func<EmitResult, EmitResult>)((scrut_result) => ((Func<EmitResult, EmitResult>)((scrut_loc) => ((Func<CodegenState, EmitResult>)((st1) => ((Func<CodegenState, EmitResult>)((st1a) => ((Func<EmitResult, EmitResult>)((result_loc) => ((Func<MatchBranchState, EmitResult>)((mbs) => ((Func<MatchBranchState, EmitResult>)((mbs_final) => ((Func<CodegenState, EmitResult>)((st_end) => load_local(st_end, result_loc.reg)))(patch_match_end_jumps(mbs_final.cg_state, mbs_final.end_patches, 0L))))(emit_match_branch_loop(mbs, scrut_loc.reg, result_loc.reg, branches, 0L, ((long)branches.Count)))))(new MatchBranchState(cg_state: st1a, end_patches: new List<long>()))))(alloc_local(st1a))))(st_set_tail_pos(st1, saved_tail))))(store_local(scrut_loc.state, scrut_loc.reg, scrut_result.reg))))(alloc_local(scrut_result.state))))(x86_64_code_generator_emit_expr(st_set_tail_pos(st, false), scrut_expr))))(st.tco.in_tail_pos);
    ...
    public static MatchBranchState emit_one_match_branch(MatchBranchState mbs, long scrut_loc, long result_loc, IRBranch branch, bool needs_jmp_end) => ((Func<EmitPatternResult, MatchBranchState>)((pat_result) => ((Func<EmitResult, MatchBranchState>)((body_result) => ((Func<CodegenState, MatchBranchState>)((st1) => ((Func<MatchBranchState, MatchBranchState>)((st2) => ((Func<MatchBranchState, MatchBranchState>)((st3) => st3))(((pat_result.next_branch_patch >= 0L) ? new MatchBranchState(cg_state: patch_jcc_at(st2.cg_state, pat_result.next_branch_patch, ((long)st2.cg_state.text.Count)), end_patches: st2.end_patches) : st2))))((needs_jmp_end ? ((Func<long, MatchBranchState>)((jmp_pos) => new MatchBranchState(cg_state: st_append_text(st1, jmp(0L)), end_patches: ((Func<List<long>>)(() => { var _l = mbs.end_patches; _l.Add(jmp_pos); return _l; }))())))(((long)st1.text.Count)) : new MatchBranchState(cg_state: st1, end_patches: mbs.end_patches)))))(store_local(body_result.state, result_loc, body_result.reg))))(x86_64_code_generator_emit_expr(pat_result.state, branch.body))))(x86_64_code_generator_emit_pattern(mbs.cg_state, scrut_loc, branch.pattern));

    public static EmitPatternResult x86_64_code_generator_emit_pattern(CodegenState st, long scrut_loc, IRPat pat) => pat switch { IrWildPat { } => new EmitPatternResult(state: st, next_branch_patch: (0L - 1L)), IrVarPat(var name, var ty) => ((Func<EmitResult, EmitPatternResult>)((var_loc) => ((Func<EmitResult, EmitPatternResult>)((loaded) => ((Func<CodegenState, EmitPatternResult>)((st1) => new EmitPatternResult(state: add_local(st1, name, var_loc.reg), next_branch_patch: (0L - 1L))))(store_local(loaded.state, var_loc.reg, loaded.reg))))(load_local(var_loc.state, scrut_loc))))(alloc_local(st)), IrCtorPat(var name, var sub_pats, var ty) => ((Func<EmitResult, EmitPatternResult>)((scrut_load) => ((Func<EmitResult, EmitPatternResult>)((tag_reg) => ((Func<CodegenState, EmitPatternResult>)((st1) => ((Func<long, EmitPatternResult>)((expected_tag) => ((Func<CodegenState, EmitPatternResult>)((st2) => ((Func<long, EmitPatternResult>)((jcc_pos) => ((Func<CodegenState, EmitPatternResult>)((st3) => ((Func<CodegenState, EmitPatternResult>)((st4) => new EmitPatternResult(state: st4, next_branch_patch: jcc_pos)))(bind_ctor_fields(st3, scrut_loc, sub_pats, 0L))))(st_append_text(st2, jcc(cc_ne(), 0L)))))(((long)st2.text.Count))))(st_append_text(st1, cmp_ri(tag_reg.reg, expected_tag)))))(ty switch { SumTy(var sname, var ctors) => find_ctor_tag(ctors, name, 0L), _ => 0L, })))(st_append_text(tag_reg.state, mov_load(tag_reg.reg, scrut_load.reg, 0L)))))(alloc_temp(scrut_load.state))))(load_local(st, scrut_loc)), IrLitPat(var value, var ty) => new EmitPatternResult(state: st, next_branch_patch: (0L - 1L)), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static ItoaState emit_itoa_zero_check(CodegenState st) => ((Func<CodegenState, ItoaState>)((st1) => ((Func<CodegenState, ItoaState>)((st2) => ((Func<long, ItoaState>)((jne_pos) => ((Func<CodegenState, ItoaState>)((st3) => ((Func<CodegenState, ItoaState>)((st4) => ((Func<long, ItoaState>)((jmp_pos) => ((Func<CodegenState, ItoaState>)((st5) => ((Func<CodegenState, ItoaState>)((st6) => new ItoaState(cg: st6, jmp_done_zero_pos: jmp_pos)))(patch_jcc_at(st5, jne_pos, ((long)st5.text.Count)))))(st_append_text(st4, jmp(0L)))))(((long)st4.text.Count))))(emit_serial_wait_and_send(st3, 48L))))(st_append_text(st2, jcc(cc_ne(), 0L)))))(((long)st2.text.Count))))(st_append_text(st1, test_rr(reg_rbx(), reg_rbx())))))(st_append_text(st, mov_rr(reg_rbx(), reg_rax())));

    public static CodegenState emit_itoa_sign_and_digits(CodegenState st) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<long, CodegenState>)((jns_pos) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<long, CodegenState>)((loop_top) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => ((Func<CodegenState, CodegenState>)((st13) => ((Func<CodegenState, CodegenState>)((st14) => ((Func<CodegenState, CodegenState>)((st15) => st_append_text(st15, jcc(cc_ne(), (loop_top - (((long)st15.text.Count) + 6L))))))(st_append_text(st14, test_rr(reg_rbx(), reg_rbx())))))(st_append_text(st13, add_ri(reg_rcx(), 1L)))))(st_append_text(st12, push_r(reg_rdx())))))(st_append_text(st11, add_ri(reg_rdx(), 48L)))))(st_append_text(st10, mov_rr(reg_rbx(), reg_rax())))))(st_append_text(st9, idiv_r(reg_r11())))))(st_append_text(st8, cqo()))))(st_append_text(st7, mov_rr(reg_rax(), reg_rbx())))))(((long)st7.text.Count))))(st_append_text(st6, li(reg_r11(), 10L)))))(st_append_text(st5, li(reg_rcx(), 0L)))))(patch_jcc_at(st4, jns_pos, ((long)st4.text.Count)))))(st_append_text(st3, neg_r(reg_rbx())))))(emit_serial_wait_and_send(st2, 45L))))(st_append_text(st1, jcc(cc_ge(), 0L)))))(((long)st1.text.Count))))(st_append_text(st, test_rr(reg_rbx(), reg_rbx())));

    public static CodegenState emit_itoa_print_loop(CodegenState st) => ((Func<long, CodegenState>)((loop_top) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<long, CodegenState>)((je_pos) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => patch_jcc_at(st8, je_pos, ((long)st8.text.Count))))(st_append_text(st7, jmp((loop_top - (((long)st7.text.Count) + 5L)))))))(st_append_text(st6, sub_ri(reg_rcx(), 1L)))))(st_append_text(st5, pop_r(reg_rcx())))))(emit_serial_send_rdi(st4))))(st_append_text(st3, push_r(reg_rcx())))))(st_append_text(st2, pop_r(reg_rdi())))))(st_append_text(st1, jcc(cc_e(), 0L)))))(((long)st1.text.Count))))(st_append_text(st, test_rr(reg_rcx(), reg_rcx())))))(((long)st.text.Count));
    ...
    public static List<long> alu_ri(long ext, long rd, long imm) => (((imm >= (0L - 128L)) && (imm <= 127L)) ? Enumerable.Concat(new List<long> { rex_w(0L, rd), 131L, modrm(3L, ext, rd) }, write_i8(imm)).ToList() : Enumerable.Concat(new List<long> { rex_w(0L, rd), 129L, modrm(3L, ext, rd) }, write_i32(imm)).ToList());
    ...
    public static CodegenState emit_itoa_setup(CodegenState st) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<long, CodegenState>)((not_neg_pos) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => patch_jcc_at(st9, not_neg_pos, ((long)st9.text.Count))))(st_append_text(st8, li(reg_r12(), 1L)))))(st_append_text(st7, neg_r(reg_rbx())))))(st_append_text(st6, jcc(cc_ge(), 0L)))))(((long)st6.text.Count))))(st_append_text(st5, cmp_ri(reg_rbx(), 0L)))))(st_append_text(st4, li(reg_r12(), 0L)))))(st_append_text(st3, mov_rr(reg_rbx(), reg_rdi())))))(st_append_text(st2, sub_ri(reg_rsp(), 32L)))))(st_append_text(st1, push_r(reg_r12())))))(st_append_text(st0, push_r(reg_rbx())))))(record_func_offset(st, "__itoa"));

    public static ItoaZeroResult emit_itoa_zero_guard(CodegenState st) => ((Func<CodegenState, ItoaZeroResult>)((st0) => ((Func<CodegenState, ItoaZeroResult>)((st1) => ((Func<CodegenState, ItoaZeroResult>)((st2) => ((Func<long, ItoaZeroResult>)((not_zero_pos) => ((Func<CodegenState, ItoaZeroResult>)((st3) => ((Func<CodegenState, ItoaZeroResult>)((st4) => ((Func<CodegenState, ItoaZeroResult>)((st5) => ((Func<CodegenState, ItoaZeroResult>)((st6) => ((Func<long, ItoaZeroResult>)((skip_digits_pos) => ((Func<CodegenState, ItoaZeroResult>)((st7) => ((Func<CodegenState, ItoaZeroResult>)((st8) => new ItoaZeroResult(cg: st8, skip_digits_pos: skip_digits_pos)))(patch_jcc_at(st7, not_zero_pos, ((long)st7.text.Count)))))(st_append_text(st6, jmp(0L)))))(((long)st6.text.Count))))(st_append_text(st5, li(reg_rcx(), 1L)))))(st_append_text(st4, mov_store_byte(reg_rsp(), reg_rsi(), 0L)))))(st_append_text(st3, li(reg_rsi(), 3L)))))(st_append_text(st2, jcc(cc_ne(), 0L)))))(((long)st2.text.Count))))(st_append_text(st1, test_rr(reg_rbx(), reg_rbx())))))(st_append_text(st0, li(reg_r11(), 10L)))))(st_append_text(st, li(reg_rcx(), 0L)));
    ...
    public static CodegenState emit_itoa_heap_alloc(CodegenState st) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<long, CodegenState>)((no_minus_pos) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => ((Func<CodegenState, CodegenState>)((st13) => patch_jcc_at(st13, no_minus_pos, ((long)st13.text.Count))))(st_append_text(st12, li(reg_r11(), 1L)))))(st_append_text(st11, mov_store_byte(reg_rax(), reg_rsi(), 8L)))))(st_append_text(st10, li(reg_rsi(), 73L)))))(st_append_text(st9, jcc(cc_e(), 0L)))))(((long)st9.text.Count))))(st_append_text(st8, test_rr(reg_r12(), reg_r12())))))(st_append_text(st7, li(reg_r11(), 0L)))))(st_append_text(st6, mov_store(reg_rax(), reg_rdx(), 0L)))))(st_append_text(st5, add_rr(reg_r10(), reg_rsi())))))(st_append_text(st4, and_ri(reg_rsi(), (0L - 8L))))))(st_append_text(st3, add_ri(reg_rsi(), 15L)))))(st_append_text(st2, mov_rr(reg_rsi(), reg_rdx())))))(st_append_text(st1, mov_rr(reg_rax(), reg_r10())))))(st_append_text(st0, add_rr(reg_rdx(), reg_r12())))))(st_append_text(st, mov_rr(reg_rdx(), reg_rcx())));
    ...
    public static StrConcatFastResult emit_str_concat_fast_bump(CodegenState st) => ((Func<CodegenState, StrConcatFastResult>)((st0) => ((Func<CodegenState, StrConcatFastResult>)((st1) => ((Func<CodegenState, StrConcatFastResult>)((st2) => ((Func<CodegenState, StrConcatFastResult>)((st3) => ((Func<CodegenState, StrConcatFastResult>)((st4) => ((Func<CodegenState, StrConcatFastResult>)((st5) => ((Func<long, StrConcatFastResult>)((fast_done_pos) => ((Func<CodegenState, StrConcatFastResult>)((st6) => new StrConcatFastResult(cg: st6, fast_done_pos: fast_done_pos)))(st_append_text(st5, jmp(0L)))))(((long)st5.text.Count))))(st_append_text(st4, mov_rr(reg_rax(), reg_rbx())))))(st_append_text(st3, add_rr(reg_r10(), reg_r11())))))(st_append_text(st2, lea(reg_r10(), reg_rbx(), 0L)))))(st_append_text(st1, and_ri(reg_r11(), (0L - 8L))))))(st_append_text(st0, add_ri(reg_r11(), 15L)))))(st_append_text(st, mov_rr(reg_r11(), reg_r13())));

    public static CodegenState emit_str_concat_slow_alloc(CodegenState st, long slow_path_pos) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => st_append_text(st7, mov_store(reg_rax(), reg_r13(), 0L))))(st_append_text(st6, add_rr(reg_r10(), reg_r11())))))(st_append_text(st5, and_ri(reg_r11(), (0L - 8L))))))(st_append_text(st4, add_ri(reg_r11(), 15L)))))(st_append_text(st3, mov_rr(reg_r11(), reg_r13())))))(st_append_text(st2, mov_rr(reg_rax(), reg_r10())))))(st_append_text(st1, add_rr(reg_r13(), reg_rdx())))))(st_append_text(st0, mov_rr(reg_r13(), reg_rcx())))))(patch_jcc_at(st, slow_path_pos, ((long)st.text.Count)));
    ...
    public static HelpResult2 emit_ipow_setup(CodegenState st) => ((Func<CodegenState, HelpResult2>)((st0) => ((Func<CodegenState, HelpResult2>)((st1) => ((Func<CodegenState, HelpResult2>)((st2) => ((Func<long, HelpResult2>)((neg_pos) => ((Func<CodegenState, HelpResult2>)((st3) => ((Func<long, HelpResult2>)((zero_pos) => ((Func<CodegenState, HelpResult2>)((st4) => new HelpResult2(cg: st4, p1: neg_pos, p2: zero_pos)))(st_append_text(st3, jcc(cc_e(), 0L)))))(((long)st3.text.Count))))(st_append_text(st2, jcc(cc_l(), 0L)))))(((long)st2.text.Count))))(st_append_text(st1, cmp_ri(reg_rsi(), 0L)))))(st_append_text(st0, li(reg_rax(), 1L)))))(record_func_offset(st, "__ipow"));

    public static CodegenState emit_ipow_loop(CodegenState st) => ((Func<long, CodegenState>)((loop_top) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<long, CodegenState>)((skip_mul_pos) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<long, CodegenState>)((jmp_loop_pos) => ((Func<CodegenState, CodegenState>)((st8) => patch_jcc_at(st8, jmp_loop_pos, loop_top)))(st_append_text(st7, jcc(cc_g(), 0L)))))(((long)st7.text.Count))))(st_append_text(st6, cmp_ri(reg_rsi(), 0L)))))(st_append_text(st5, shr_ri(reg_rsi(), 1L)))))(st_append_text(st4, imul_rr(reg_rdi(), reg_rdi())))))(patch_jcc_at(st3, skip_mul_pos, ((long)st3.text.Count)))))(st_append_text(st2, imul_rr(reg_rax(), reg_rdi())))))(st_append_text(st1, jcc(cc_e(), 0L)))))(((long)st1.text.Count))))(st_append_text(st0, and_ri(reg_rcx(), 1L)))))(st_append_text(st, mov_rr(reg_rcx(), reg_rsi())))))(((long)st.text.Count));
    ...
    public static HelpResult1 emit_text_starts_with_head(CodegenState st) => ((Func<CodegenState, HelpResult1>)((st0) => ((Func<CodegenState, HelpResult1>)((st1) => ((Func<CodegenState, HelpResult1>)((st2) => ((Func<CodegenState, HelpResult1>)((st3) => ((Func<long, HelpResult1>)((too_long_pos) => ((Func<CodegenState, HelpResult1>)((st4) => new HelpResult1(cg: st4, p1: too_long_pos)))(st_append_text(st3, jcc(cc_g(), 0L)))))(((long)st3.text.Count))))(st_append_text(st2, cmp_rr(reg_rdx(), reg_rcx())))))(st_append_text(st1, mov_load(reg_rdx(), reg_rsi(), 0L)))))(st_append_text(st0, mov_load(reg_rcx(), reg_rdi(), 0L)))))(record_func_offset(st, "__text_starts_with"));
    ...
    public static CodegenState emit_list_cons_copy(CodegenState st) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<long, CodegenState>)((loop_top) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<long, CodegenState>)((exit_pos) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => st_append_text(st12, x86_ret())))(patch_jcc_at(st11, exit_pos, ((long)st11.text.Count)))))(st_append_text(st10, jmp((loop_top - (((long)st10.text.Count) + 5L)))))))(st_append_text(st9, add_ri(reg_r11(), 8L)))))(st_append_text(st8, mov_store(reg_rdi(), reg_rdx(), 16L)))))(st_append_text(st7, add_rr(reg_rdi(), reg_r11())))))(st_append_text(st6, mov_rr(reg_rdi(), reg_rax())))))(st_append_text(st5, mov_load(reg_rdx(), reg_rdx(), 8L)))))(st_append_text(st4, add_rr(reg_rdx(), reg_r11())))))(st_append_text(st3, mov_rr(reg_rdx(), reg_rsi())))))(st_append_text(st2, jcc(cc_ge(), 0L)))))(((long)st2.text.Count))))(st_append_text(st1, cmp_rr(reg_r11(), reg_rcx())))))(((long)st1.text.Count))))(st_append_text(st0, li(reg_r11(), 0L)))))(st_append_text(st, shl_ri(reg_rcx(), 3L)));
    ...
    public static CodegenState emit_list_append_alloc(CodegenState st) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => ((Func<CodegenState, CodegenState>)((st13) => ((Func<CodegenState, CodegenState>)((st14) => ((Func<CodegenState, CodegenState>)((st15) => ((Func<CodegenState, CodegenState>)((st16) => st_append_text(st16, mov_store(reg_rax(), reg_r13(), 0L))))(st_append_text(st15, add_rr(reg_r10(), reg_r11())))))(st_append_text(st14, shl_ri(reg_r11(), 3L)))))(st_append_text(st13, add_ri(reg_r11(), 1L)))))(st_append_text(st12, mov_rr(reg_r11(), reg_r13())))))(st_append_text(st11, mov_rr(reg_rax(), reg_r10())))))(st_append_text(st10, add_ri(reg_r10(), 8L)))))(st_append_text(st9, mov_store(reg_r10(), reg_r13(), 0L)))))(st_append_text(st8, add_rr(reg_r13(), reg_rdx())))))(st_append_text(st7, mov_rr(reg_r13(), reg_rcx())))))(st_append_text(st6, mov_load(reg_rdx(), reg_r12(), 0L)))))(st_append_text(st5, mov_load(reg_rcx(), reg_rbx(), 0L)))))(st_append_text(st4, mov_rr(reg_r12(), reg_rsi())))))(st_append_text(st3, mov_rr(reg_rbx(), reg_rdi())))))(st_append_text(st2, push_r(reg_r13())))))(st_append_text(st1, push_r(reg_r12())))))(st_append_text(st0, push_r(reg_rbx())))))(record_func_offset(st, "__list_append"));
    ...
    public static CodegenState emit_list_insert_at_shift(CodegenState st, long in_place_pos) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<long, CodegenState>)((shift_loop) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<long, CodegenState>)((shift_done_pos) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => patch_jcc_at(st12, shift_done_pos, ((long)st12.text.Count))))(st_append_text(st11, jmp((shift_loop - (((long)st11.text.Count) + 5L)))))))(st_append_text(st10, sub_ri(reg_r11(), 1L)))))(st_append_text(st9, mov_store(reg_rax(), reg_rcx(), 16L)))))(st_append_text(st8, mov_load(reg_rcx(), reg_rax(), 8L)))))(st_append_text(st7, add_rr(reg_rax(), reg_rdx())))))(st_append_text(st6, mov_rr(reg_rax(), reg_rbx())))))(st_append_text(st5, shl_ri(reg_rdx(), 3L)))))(st_append_text(st4, mov_rr(reg_rdx(), reg_r11())))))(st_append_text(st3, jcc(cc_l(), 0L)))))(((long)st3.text.Count))))(st_append_text(st2, cmp_rr(reg_r11(), reg_r12())))))(((long)st2.text.Count))))(st_append_text(st1, sub_ri(reg_r11(), 1L)))))(st_append_text(st0, mov_rr(reg_r11(), reg_r14())))))(patch_jcc_at(st, in_place_pos, ((long)st.text.Count)));
    ...
    public static CodegenState emit_text_concat_list_len_pass(CodegenState st) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<long, CodegenState>)((len_loop) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<long, CodegenState>)((len_done_pos) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => ((Func<CodegenState, CodegenState>)((st13) => ((Func<CodegenState, CodegenState>)((st14) => ((Func<CodegenState, CodegenState>)((st15) => ((Func<CodegenState, CodegenState>)((st16) => ((Func<CodegenState, CodegenState>)((st17) => ((Func<CodegenState, CodegenState>)((st18) => patch_jcc_at(st18, len_done_pos, ((long)st18.text.Count))))(st_append_text(st17, jmp((len_loop - (((long)st17.text.Count) + 5L)))))))(st_append_text(st16, add_ri(reg_r11(), 1L)))))(st_append_text(st15, add_rr(reg_r13(), reg_rax())))))(st_append_text(st14, mov_load(reg_rax(), reg_rax(), 0L)))))(st_append_text(st13, mov_load(reg_rax(), reg_rax(), 8L)))))(st_append_text(st12, add_rr(reg_rax(), reg_rbx())))))(st_append_text(st11, shl_ri(reg_rax(), 3L)))))(st_append_text(st10, mov_rr(reg_rax(), reg_r11())))))(st_append_text(st9, jcc(cc_ge(), 0L)))))(((long)st9.text.Count))))(st_append_text(st8, cmp_rr(reg_r11(), reg_r12())))))(((long)st8.text.Count))))(st_append_text(st7, li(reg_r11(), 0L)))))(st_append_text(st6, li(reg_r13(), 0L)))))(st_append_text(st5, mov_load(reg_r12(), reg_rbx(), 0L)))))(st_append_text(st4, mov_rr(reg_rbx(), reg_rdi())))))(st_append_text(st3, push_r(reg_r14())))))(st_append_text(st2, push_r(reg_r13())))))(st_append_text(st1, push_r(reg_r12())))))(st_append_text(st0, push_r(reg_rbx())))))(record_func_offset(st, "__text_concat_list"));
    ...
    public static CodegenState emit_text_concat_list_copy_inner(CodegenState st, long copy_loop, long copy_done_pos) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<long, CodegenState>)((byte_loop) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<long, CodegenState>)((byte_done_pos) => ((Func<CodegenState, CodegenState>)((st2) => ((Func<CodegenState, CodegenState>)((st3) => ((Func<CodegenState, CodegenState>)((st4) => ((Func<CodegenState, CodegenState>)((st5) => ((Func<CodegenState, CodegenState>)((st6) => ((Func<CodegenState, CodegenState>)((st7) => ((Func<CodegenState, CodegenState>)((st8) => ((Func<CodegenState, CodegenState>)((st9) => ((Func<CodegenState, CodegenState>)((st10) => ((Func<CodegenState, CodegenState>)((st11) => ((Func<CodegenState, CodegenState>)((st12) => ((Func<CodegenState, CodegenState>)((st13) => ((Func<CodegenState, CodegenState>)((st14) => ((Func<CodegenState, CodegenState>)((st15) => patch_jcc_at(st15, copy_done_pos, ((long)st15.text.Count))))(st_append_text(st14, jmp((copy_loop - (((long)st14.text.Count) + 5L)))))))(st_append_text(st13, add_ri(reg_r11(), 1L)))))(st_append_text(st12, add_rr(reg_r13(), reg_rcx())))))(patch_jcc_at(st11, byte_done_pos, ((long)st11.text.Count)))))(st_append_text(st10, jmp((byte_loop - (((long)st10.text.Count) + 5L)))))))(st_append_text(st9, add_ri(reg_rsi(), 1L)))))(st_append_text(st8, mov_store_byte(reg_rdx(), reg_rax(), 8L)))))(st_append_text(st7, add_rr(reg_rdx(), reg_rsi())))))(st_append_text(st6, add_rr(reg_rdx(), reg_r13())))))(st_append_text(st5, mov_rr(reg_rdx(), reg_r14())))))(st_append_text(st4, movzx_byte(reg_rax(), reg_rax(), 8L)))))(st_append_text(st3, add_rr(reg_rax(), reg_rsi())))))(st_append_text(st2, mov_rr(reg_rax(), reg_rdi())))))(st_append_text(st1, jcc(cc_ge(), 0L)))))(((long)st1.text.Count))))(st_append_text(st0, cmp_rr(reg_rsi(), reg_rcx())))))(((long)st0.text.Count))))(st_append_text(st, li(reg_rsi(), 0L)));
    ...
    public static HelpResult2 emit_text_split_scan_head(CodegenState st) => ((Func<long, HelpResult2>)((scan_loop) => ((Func<CodegenState, HelpResult2>)((st0) => ((Func<long, HelpResult2>)((scan_done_pos) => ((Func<CodegenState, HelpResult2>)((st1) => ((Func<CodegenState, HelpResult2>)((st2) => ((Func<CodegenState, HelpResult2>)((st3) => ((Func<CodegenState, HelpResult2>)((st4) => ((Func<CodegenState, HelpResult2>)((st5) => ((Func<long, HelpResult2>)((not_delim_pos) => ((Func<CodegenState, HelpResult2>)((st6) => new HelpResult2(cg: st6, p1: scan_done_pos, p2: not_delim_pos)))(st_append_text(st5, jcc(cc_ne(), 0L)))))(((long)st5.text.Count))))(st_append_text(st4, cmp_rr(reg_rax(), reg_r13())))))(st_append_text(st3, movzx_byte(reg_rax(), reg_rax(), 8L)))))(st_append_text(st2, add_rr(reg_rax(), reg_r11())))))(st_append_text(st1, mov_rr(reg_rax(), reg_rbx())))))(st_append_text(st0, jcc(cc_ge(), 0L)))))(((long)st0.text.Count))))(st_append_text(st, cmp_rr(reg_r11(), reg_r12())))))(((long)st.text.Count));
    ...
    public static CodegenState emit_text_split_not_delim(CodegenState st, long not_delim_pos, long scan_loop) => ((Func<CodegenState, CodegenState>)((st0) => ((Func<CodegenState, CodegenState>)((st1) => ((Func<CodegenState, CodegenState>)((st2) => st_append_text(st2, jmp((scan_loop - (((long)st2.text.Count) + 5L))))))(st_append_text(st1, add_ri(reg_r11(), 1L)))))(patch_jcc_at(st0, not_delim_pos, ((long)st0.text.Count)))))(st_append_text(st, jmp((scan_loop - (((long)st.text.Count) + 5L)))));
    ...
    public static IRExpr lower_let(List<ALetBind> binds, AExpr body, CodexType ty, LowerCtx ctx) => ((((long)binds.Count) == 0L) ? lower_expr(body, ty, ctx) : ((Func<ALetBind, IRExpr>)((b) => ((Func<IRExpr, IRExpr>)((val_ir) => ((Func<CodexType, IRExpr>)((val_ty) => ((Func<LowerCtx, IRExpr>)((ctx2) => new IrLet(b.name.value, val_ty, val_ir, lower_let_rest(binds, body, ty, ctx2, 1L))))(new LowerCtx(types: Enumerable.Concat(new List<TypeBinding> { new TypeBinding(name: b.name.value, bound_type: val_ty) }, ctx.types).ToList(), ust: ctx.ust))))(deep_resolve(ctx.ust, ir_expr_type(val_ir)))))(lower_expr(b.value, new ErrorTy(), ctx))))(binds[(int)0L]));

    public static IRExpr lower_let_rest(List<ALetBind> binds, AExpr body, CodexType ty, LowerCtx ctx, long i) => ((i == ((long)binds.Count)) ? lower_expr(body, ty, ctx) : ((Func<ALetBind, IRExpr>)((b) => ((Func<IRExpr, IRExpr>)((val_ir) => ((Func<CodexType, IRExpr>)((val_ty) => ((Func<LowerCtx, IRExpr>)((ctx2) => new IrLet(b.name.value, val_ty, val_ir, lower_let_rest(binds, body, ty, ctx2, (i + 1L)))))(new LowerCtx(types: Enumerable.Concat(new List<TypeBinding> { new TypeBinding(name: b.name.value, bound_type: val_ty) }, ctx.types).ToList(), ust: ctx.ust))))(deep_resolve(ctx.ust, ir_expr_type(val_ir)))))(lower_expr(b.value, new ErrorTy(), ctx))))(binds[(int)i]));

    public static IRExpr lower_lambda(List<Name> @params, AExpr body, CodexType ty, LowerCtx ctx) => ((Func<CodexType, IRExpr>)((stripped) => ((Func<List<IRParam>, IRExpr>)((lparams) => ((Func<LowerCtx, IRExpr>)((lctx) => new IrLambda(lparams, lower_expr(body, get_lambda_return(stripped, ((long)@params.Count)), lctx), ty)))(bind_lambda_to_ctx(ctx, @params, stripped, 0L))))(lower_lambda_params(@params, stripped, 0L))))(strip_forall_ty(ty));
    ...
    public static IRExpr lower_record(Name name, List<AFieldExpr> fields, CodexType ty, LowerCtx ctx) => ((Func<CodexType, IRExpr>)((ctor_raw) => ((Func<CodexType, IRExpr>)((record_ty) => ((Func<CodexType, IRExpr>)((actual_ty) => new IrRecord(name.value, lower_record_fields_typed(fields, actual_ty, ctx, 0L, ((long)fields.Count)), actual_ty)))(record_ty switch { ErrorTy { } => ty, _ => record_ty, })))(ctor_raw switch { ErrorTy { } => ty, _ => strip_fun_args_lower(deep_resolve(ctx.ust, ctor_raw)), })))(lookup_type(ctx.types, name.value));
    ...
    public static IRExpr lower_do(List<ADoStmt> stmts, CodexType ty, LowerCtx ctx) => new IrDo(lower_do_stmts_loop(stmts, ty, ctx, 0L, ((long)stmts.Count)), ty);
    ...
    public static LowerCtx build_def_ctx(List<TypeBinding> types, UnificationState ust, List<AParam> @params, CodexType ty) => ((Func<LowerCtx, LowerCtx>)((base_ctx) => bind_params_to_ctx(base_ctx, @params, ty, 0L)))(new LowerCtx(types: types, ust: ust));
    ...
    public static IRChapter lower_chapter(AChapter m, List<TypeBinding> types, UnificationState ust) => ((Func<List<TypeBinding>, IRChapter>)((ctor_types) => ((Func<List<TypeBinding>, IRChapter>)((all_types) => new IRChapter(name: m.name, defs: lower_defs(m.defs, all_types, ust, 0L), chapter_title: m.chapter_title, prose: m.prose, section_titles: m.section_titles)))(Enumerable.Concat(ctor_types, Enumerable.Concat(types, builtin_type_env().bindings).ToList()).ToList())))(collect_ctor_bindings(m.type_defs, 0L, ((long)m.type_defs.Count), new List<TypeBinding>()));
    ...
    public static List<TypeBinding> ctor_bindings_for_typedef(ATypeDef td) => td switch { AVariantTypeDef(var name, var type_params, var ctors) => ((Func<CodexType, List<TypeBinding>>)((result_ty) => collect_variant_ctor_bindings(ctors, result_ty, 0L, ((long)ctors.Count), new List<TypeBinding>())))(new ConstructedTy(name, new List<CodexType>())), ARecordTypeDef(var name, var type_params, var fields) => ((Func<List<RecordField>, List<TypeBinding>>)((resolved_fields) => ((Func<CodexType, List<TypeBinding>>)((result_ty) => ((Func<CodexType, List<TypeBinding>>)((ctor_ty) => new List<TypeBinding> { new TypeBinding(name: name.value, bound_type: ctor_ty) }))(lowering_build_record_ctor_type(fields, result_ty, 0L, ((long)fields.Count)))))(new RecordTy(name, resolved_fields))))(lowering_build_record_fields(fields, 0L, ((long)fields.Count), new List<RecordField>())), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static CodexType lowering_build_ctor_type(List<ATypeExpr> fields, CodexType result, long i, long len) => ((i == len) ? result : ((Func<CodexType, CodexType>)((rest) => new FunTy(lowering_resolve_type_expr(fields[(int)i]), rest)))(lowering_build_ctor_type(fields, result, (i + 1L), len)));
    ...
    public static string mangle_name(string chapter_slug, string def_name) => (slugify(chapter_slug, 0L, "") + ("_" + def_name));
    ...
    public static string slugify(string s, long i, string acc)
    {
        while (true)
        {
            ...
            var _tco_0 = s;
            var _tco_1 = (i + 1L);
            var _tco_2 = (acc + ((char)(c - 26L)).ToString());
            s = _tco_0;
            i = _tco_1;
            acc = _tco_2;
            continue;
    ...
    public static AExpr rename_alambda(List<RenameEntry> rn, List<Name> @params, AExpr body) => ((Func<List<RenameEntry>, AExpr>)((rn2) => new ALambdaExpr(@params, rename_aexpr(rn2, body))))(remove_renames_for_names(rn, @params, 0L));
    ...
    public static List<RenameEntry> remove_renames_for_apat(List<RenameEntry> rn, APat p) => p switch { AVarPat(var n) => remove_rename(rn, n.value), ACtorPat(var n, var subs) => remove_renames_for_apats(rn, subs, 0L), ALitPat(var v) => rn, AWildPat { } => rn, _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static AChapter scope_achapter(AChapter ast, List<string> colliding, List<ChapterAssignment> assignments) => new AChapter(name: ast.name, defs: scope_adefs(ast.defs, colliding, assignments, "", new List<RenameEntry>(), 0L), type_defs: ast.type_defs, effect_defs: ast.effect_defs, citations: ast.citations, chapter_title: ast.chapter_title, prose: ast.prose, section_titles: ast.section_titles);
    ...
    public static Scope collect_pattern_names(Scope sc, APat pat) => pat switch { AVarPat(var name) => scope_add(sc, name.value), ACtorPat(var name, var subs) => collect_ctor_pat_names(sc, subs, 0L, ((long)subs.Count)), ALitPat(var val, var kind) => sc, AWildPat { } => sc, _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static long cc_cr() => (0L - 1L);
    ...
    public static LexState make_lex_state(string src) => new LexState(source: src, offset: 0L, line: 1L, column: 1L);
    ...
    public static LexState advance_char(LexState st) => ((peek_code(st) == cc_newline()) ? new LexState(source: st.source, offset: (st.offset + 1L), line: (st.line + 1L), column: 1L) : new LexState(source: st.source, offset: (st.offset + 1L), line: st.line, column: (st.column + 1L)));
    ...
    public static string process_escapes(string s, long i, long len, string acc)
    {
        while (true)
        {
            ...
            var _tco_1 = (i + 2L);
            var _tco_2 = len;
            var _tco_3 = (acc + ((char)((long)s[(int)(i + 1L)])).ToString());
            s = _tco_0;
            i = _tco_1;
            len = _tco_2;
            acc = _tco_3;
    ...
    public static bool is_chapter_header(ParseState st) => (is_type_ident(current_kind(st)) ? ((current(st).text == "Chapter") ? is_colon(peek_kind(st, 1L)) : false) : false);

    public static bool is_section_header(ParseState st) => (is_type_ident(current_kind(st)) ? ((current(st).text == "Section") ? is_colon(peek_kind(st, 1L)) : false) : false);
    ...
    public static ScanDefResult try_scan_def(string cur_chap, ParseState st) => (is_colon(peek_kind(st, 1L)) ? ((Func<ParseTypeResult, ScanDefResult>)((ann_result) => unwrap_type_for_scan(cur_chap, ann_result)))(parse_type_annotation(st)) : scan_def_body_with_ann(cur_chap, new List<TypeAnn>(), st));
    ...
    public static ScanDefResult finish_def_scan(string cur_chap, List<TypeAnn> ann, Token name_tok, List<Token> @params, ParseState st) => ((is_equals(current_kind(st)) == false) ? new DefHeaderNone(st) : ((Func<ParseState, ScanDefResult>)((st2) => ((Func<ParseState, ScanDefResult>)((st3) => ((Func<long, ScanDefResult>)((body_pos) => ((Func<ParseState, ScanDefResult>)((st4) => new DefHeaderOk(new DefHeader(name: name_tok, @params: @params, ann: ann, body_pos: body_pos, chapter_slug: cur_chap), st4)))(skip_body_tokens(st3, name_tok.column))))(st3.pos)))(skip_newlines(st2))))(advance(st)));
    ...
    public static ParseState make_parse_state(List<Token> toks) => new ParseState(tokens: toks, pos: 0L);
    ...
    public static ParseState advance(ParseState st) => ((st.pos >= (((long)st.tokens.Count) - 1L)) ? st : new ParseState(tokens: st.tokens, pos: (st.pos + 1L)));
    ...
    public static long operator_precedence(TokenKind k) => k switch { PlusPlus { } => 5L, ColonColon { } => 5L, Plus { } => 6L, Minus { } => 6L, Star { } => 7L, Slash { } => 7L, Caret { } => 8L, DoubleEquals { } => 4L, NotEquals { } => 4L, LessThan { } => 4L, GreaterThan { } => 4L, LessOrEqual { } => 4L, GreaterOrEqual { } => 4L, TripleEquals { } => 4L, Ampersand { } => 3L, Pipe { } => 2L, _ => (0L - 1L), };
    ...
    public static bool is_do_bind(ParseState st) => (is_ident(current_kind(st)) ? is_left_arrow(peek_kind(st, 1L)) : false);
    ...
    public static CodexType resolve_applied_type(List<TypeBinding> tdm, ATypeExpr ctor, List<ATypeExpr> args) => ctor switch { ANamedType(var name) => ((name.value == "List") ? ((((long)args.Count) == 1L) ? new ListTy(type_checker_resolve_type_expr(tdm, args[(int)0L])) : new ListTy(new ErrorTy())) : new ConstructedTy(name, resolve_type_expr_list(tdm, args, 0L, ((long)args.Count), new List<CodexType>()))), _ => type_checker_resolve_type_expr(tdm, ctor), };
    ...
    public static LetBindResult register_one_type_def(UnificationState st, TypeEnv env, List<TypeBinding> tdm, ATypeDef td) => td switch { AVariantTypeDef(var name, var type_params, var ctors) => ((Func<CodexType, LetBindResult>)((result_ty) => register_variant_ctors(st, env, tdm, ctors, result_ty, 0L, ((long)ctors.Count))))(lookup_type_def(tdm, name.value)), ARecordTypeDef(var name, var type_params, var fields) => ((Func<List<RecordField>, LetBindResult>)((resolved_fields) => ((Func<CodexType, LetBindResult>)((result_ty) => ((Func<CodexType, LetBindResult>)((ctor_ty) => new LetBindResult(state: st, env: env_bind(env, name.value, ctor_ty))))(type_checker_build_record_ctor_type(tdm, fields, result_ty, 0L, ((long)fields.Count)))))(new RecordTy(name, resolved_fields))))(type_checker_build_record_fields(tdm, fields, 0L, ((long)fields.Count), new List<RecordField>())), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static CodexType type_checker_build_ctor_type(List<TypeBinding> tdm, List<ATypeExpr> fields, CodexType result, long i, long len) => ((i == len) ? result : ((Func<CodexType, CodexType>)((rest) => new FunTy(type_checker_resolve_type_expr(tdm, fields[(int)i]), rest)))(type_checker_build_ctor_type(tdm, fields, result, (i + 1L), len)));

    public static CodexType type_checker_build_record_ctor_type(List<TypeBinding> tdm, List<ARecordFieldDef> fields, CodexType result, long i, long len) => ((i == len) ? result : ((Func<ARecordFieldDef, CodexType>)((f) => ((Func<CodexType, CodexType>)((rest) => new FunTy(type_checker_resolve_type_expr(tdm, f.type_expr), rest)))(type_checker_build_record_ctor_type(tdm, fields, result, (i + 1L), len))))(fields[(int)i]));
    ...
    public static CheckResult infer_do(UnificationState st, TypeEnv env, List<ADoStmt> stmts) => infer_do_loop(st, env, stmts, 0L, ((long)stmts.Count), new NothingTy());
    ...
    public static TypeEnv builtin_type_env() => ((Func<TypeEnv, TypeEnv>)((e) => ((Func<TypeEnv, TypeEnv>)((e2) => ((Func<TypeEnv, TypeEnv>)((e3) => ((Func<TypeEnv, TypeEnv>)((e4) => ((Func<TypeEnv, TypeEnv>)((e5) => ((Func<TypeEnv, TypeEnv>)((e5b) => ((Func<TypeEnv, TypeEnv>)((e6) => ((Func<TypeEnv, TypeEnv>)((e7) => ((Func<TypeEnv, TypeEnv>)((e8) => ((Func<TypeEnv, TypeEnv>)((e9) => ((Func<TypeEnv, TypeEnv>)((e10) => ((Func<TypeEnv, TypeEnv>)((e10b) => ((Func<TypeEnv, TypeEnv>)((e11) => ((Func<TypeEnv, TypeEnv>)((e12) => ((Func<TypeEnv, TypeEnv>)((e13) => ((Func<TypeEnv, TypeEnv>)((e14) => ((Func<TypeEnv, TypeEnv>)((e15) => ((Func<TypeEnv, TypeEnv>)((e16) => ((Func<TypeEnv, TypeEnv>)((e16b) => ((Func<TypeEnv, TypeEnv>)((e16c) => ((Func<TypeEnv, TypeEnv>)((e16d) => ((Func<TypeEnv, TypeEnv>)((e17) => ((Func<TypeEnv, TypeEnv>)((e18) => ((Func<TypeEnv, TypeEnv>)((e19) => ((Func<TypeEnv, TypeEnv>)((e20) => ((Func<TypeEnv, TypeEnv>)((e21) => ((Func<TypeEnv, TypeEnv>)((e22) => ((Func<TypeEnv, TypeEnv>)((e23) => ((Func<TypeEnv, TypeEnv>)((e24) => ((Func<TypeEnv, TypeEnv>)((e25) => ((Func<TypeEnv, TypeEnv>)((e26) => ((Func<TypeEnv, TypeEnv>)((e27) => ((Func<TypeEnv, TypeEnv>)((e28) => ((Func<TypeEnv, TypeEnv>)((e29) => ((Func<TypeEnv, TypeEnv>)((e30) => ((Func<TypeEnv, TypeEnv>)((e31) => ((Func<TypeEnv, TypeEnv>)((e32) => ((Func<TypeEnv, TypeEnv>)((e33) => ((Func<TypeEnv, TypeEnv>)((e34) => ((Func<TypeEnv, TypeEnv>)((e35) => ((Func<TypeEnv, TypeEnv>)((e36) => e36))(env_bind(e35, "text-concat-list", new FunTy(new ListTy(new TextTy()), new TextTy())))))(env_bind(e34, "race", new ForAllTy(0L, new FunTy(new ListTy(new FunTy(new NothingTy(), new TypeVar(0L))), new TypeVar(0L)))))))(env_bind(e33, "par", new ForAllTy(0L, new ForAllTy(1L, new FunTy(new FunTy(new TypeVar(0L), new TypeVar(1L)), new FunTy(new ListTy(new TypeVar(0L)), new ListTy(new TypeVar(1L))))))))))(env_bind(e32, "await", new ForAllTy(0L, new FunTy(new ConstructedTy(new Name(value: "Task"), new List<CodexType> { new TypeVar(0L) }), new TypeVar(0L)))))))(env_bind(e31, "fork", new ForAllTy(0L, new FunTy(new FunTy(new NothingTy(), new TypeVar(0L)), new ConstructedTy(new Name(value: "Task"), new List<CodexType> { new TypeVar(0L) })))))))(env_bind(e30, "current-dir", new TextTy()))))(env_bind(e29, "get-env", new FunTy(new TextTy(), new TextTy())))))(env_bind(e28, "get-args", new ListTy(new TextTy())))))(env_bind(e27, "text-starts-with", new FunTy(new TextTy(), new FunTy(new TextTy(), new BooleanTy()))))))(env_bind(e26, "text-contains", new FunTy(new TextTy(), new FunTy(new TextTy(), new BooleanTy()))))))(env_bind(e25, "text-split", new FunTy(new TextTy(), new FunTy(new TextTy(), new ListTy(new TextTy())))))))(env_bind(e24, "list-files", new FunTy(new TextTy(), new FunTy(new TextTy(), new ListTy(new TextTy())))))))(env_bind(e23, "file-exists", new FunTy(new TextTy(), new BooleanTy())))))(env_bind(e22, "write-file", new FunTy(new TextTy(), new FunTy(new TextTy(), new NothingTy()))))))(env_bind(e21, "read-file", new FunTy(new TextTy(), new TextTy())))))(env_bind(e20, "read-line", new TextTy()))))(env_bind(e19, "fold", new ForAllTy(0L, new ForAllTy(1L, new FunTy(new FunTy(new TypeVar(1L), new FunTy(new TypeVar(0L), new TypeVar(1L))), new FunTy(new TypeVar(1L), new FunTy(new ListTy(new TypeVar(0L)), new TypeVar(1L))))))))))(env_bind(e18, "filter", new ForAllTy(0L, new FunTy(new FunTy(new TypeVar(0L), new BooleanTy()), new FunTy(new ListTy(new TypeVar(0L)), new ListTy(new TypeVar(0L)))))))))(env_bind(e17, "map", new ForAllTy(0L, new ForAllTy(1L, new FunTy(new FunTy(new TypeVar(0L), new TypeVar(1L)), new FunTy(new ListTy(new TypeVar(0L)), new ListTy(new TypeVar(1L))))))))))(env_bind(e16d, "list-at", new ForAllTy(0L, new FunTy(new ListTy(new TypeVar(0L)), new FunTy(new IntegerTy(), new TypeVar(0L))))))))(env_bind(e16c, "list-snoc", new ForAllTy(0L, new FunTy(new ListTy(new TypeVar(0L)), new FunTy(new TypeVar(0L), new ListTy(new TypeVar(0L)))))))))(env_bind(e16b, "text-compare", new FunTy(new TextTy(), new FunTy(new TextTy(), new IntegerTy()))))))(env_bind(e16, "list-insert-at", new ForAllTy(0L, new FunTy(new ListTy(new TypeVar(0L)), new FunTy(new IntegerTy(), new FunTy(new TypeVar(0L), new ListTy(new TypeVar(0L))))))))))(env_bind(e15, "list-length", new ForAllTy(0L, new FunTy(new ListTy(new TypeVar(0L)), new IntegerTy()))))))(env_bind(e14, "print-line", new FunTy(new TextTy(), new NothingTy())))))(env_bind(e13, "show", new ForAllTy(0L, new FunTy(new TypeVar(0L), new TextTy()))))))(env_bind(e12, "text-to-integer", new FunTy(new TextTy(), new IntegerTy())))))(env_bind(e11, "text-replace", new FunTy(new TextTy(), new FunTy(new TextTy(), new FunTy(new TextTy(), new TextTy())))))))(env_bind(e10b, "code-to-char", new FunTy(new IntegerTy(), new CharTy())))))(env_bind(e10, "char-code-at", new FunTy(new TextTy(), new FunTy(new IntegerTy(), new IntegerTy()))))))(env_bind(e9, "char-code", new FunTy(new CharTy(), new IntegerTy())))))(env_bind(e8, "is-whitespace", new FunTy(new CharTy(), new BooleanTy())))))(env_bind(e7, "is-digit", new FunTy(new CharTy(), new BooleanTy())))))(env_bind(e6, "is-letter", new FunTy(new CharTy(), new BooleanTy())))))(env_bind(e5b, "substring", new FunTy(new TextTy(), new FunTy(new IntegerTy(), new FunTy(new IntegerTy(), new TextTy())))))))(env_bind(e5, "char-to-text", new FunTy(new CharTy(), new TextTy())))))(env_bind(e4, "char-at", new FunTy(new TextTy(), new FunTy(new IntegerTy(), new CharTy()))))))(env_bind(e3, "integer-to-text", new FunTy(new IntegerTy(), new TextTy())))))(env_bind(e2, "text-length", new FunTy(new TextTy(), new IntegerTy())))))(env_bind(e, "negate", new FunTy(new IntegerTy(), new IntegerTy())))))(empty_type_env());

    public static UnificationState empty_unification_state() => new UnificationState(substitutions: new List<SubstEntry>(), next_id: 2L, errors: new List<Diagnostic>());

    public static CodexType fresh_var(UnificationState st) => new TypeVar(st.next_id);

    public static UnificationState advance_id(UnificationState st) => new UnificationState(substitutions: st.substitutions, next_id: (st.next_id + 1L), errors: st.errors);
    ...
    public static CodexType deep_resolve(UnificationState st, CodexType ty) => ((Func<CodexType, CodexType>)((resolved) => resolved switch { FunTy(var param, var ret) => new FunTy(deep_resolve(st, param), deep_resolve(st, ret)), ListTy(var elem) => new ListTy(deep_resolve(st, elem)), ConstructedTy(var name, var args) => new ConstructedTy(name, deep_resolve_list(st, args, 0L, ((long)args.Count), new List<CodexType>())), ForAllTy(var id, var body) => new ForAllTy(id, deep_resolve(st, body)), SumTy(var name, var ctors) => resolved, RecordTy(var name, var fields) => resolved, _ => resolved, }))(resolve(st, ty));
    ...
    public static LetBindResult register_def_headers(UnificationState st, TypeEnv env, List<TypeBinding> tdm, List<DefHeader> headers, long i, long len)
    {
        while (true)
        {
            ...
            var ty = ((((long)declared.Count) == 0L) ? ((Func<FreshResult, LetBindResult>)((fr) => ((Func<TypeEnv, LetBindResult>)((env2) => new LetBindResult(state: fr.state, env: env2)))(env_bind(env, hdr.name.text, fr.var_type))))(fresh_and_advance(st)) : ((Func<object, LetBindResult>)((resolved) => ((Func<ParamResult, LetBindResult>)((pr) => new LetBindResult(state: pr.state, env: env_bind(env, hdr.name.text, pr.parameterized))))(parameterize_type(st, resolved))))(lowering_resolve_type_expr(tdm)(declared[(int)0L])));
            var _tco_0 = ty.state;
            var _tco_1 = ty.env;
            var _tco_2 = tdm;
            var _tco_3 = headers;
    ...
    public static object emit_defs_streaming(List<Token> tokens, List<DefHeader> headers, List<TypeBinding> all_types, UnificationState ust, List<string> ctor_names, long i, long len)
    {
        while (true)
        {
            ...
            {
            return ((Func<object>)(() => { ((Func<object>)(() => { Console.WriteLine(_Cce.ToUnicode(text)); return null; }))(); emit_defs_streaming(tokens, headers, all_types, ust, ctor_names, (i + 1L), len);  return null; }))();
            }
            }
            }
        }
