...
public static class Codex_Codex_Codex
{
    ...
    public static string severity_label(DiagnosticSeverity s) => s switch { Error { } => "\u000D\u0015\u0015\u0010\u0015", Warning { } => "\u001B\u000F\u0015\u0012\u0011\u0012\u001D", Info { } => "\u0011\u0012\u001C\u0010", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string diagnostic_display(Diagnostic d) => (severity_label(d.severity) + ("\u0002" + (d.code + ("\u0045\u0002" + d.message))));
    ...
    public static string csharp_emitter_emit_type_def(ATypeDef td) => td switch { ARecordTypeDef(var name, var tparams, var fields) => ((Func<string, string>)((gen) => ("\u001F\u0019\u0020\u0017\u0011\u0018\u0002\u0013\u000D\u000F\u0017\u000D\u0016\u0002\u0015\u000D\u0018\u0010\u0015\u0016\u0002" + (sanitize(name.value) + (gen + ("\u004A" + (csharp_emitter_emit_record_field_defs(fields, tparams, 0L) + "\u004B\u0046\u0001")))))))(emit_tparameter_suffix(tparams)), AVariantTypeDef(var name, var tparams, var ctors) => ((Func<string, string>)((gen) => ("\u001F\u0019\u0020\u0017\u0011\u0018\u0002\u000F\u0020\u0013\u000E\u0015\u000F\u0018\u000E\u0002\u0015\u000D\u0018\u0010\u0015\u0016\u0002" + (sanitize(name.value) + (gen + ("\u0046\u0001" + (csharp_emitter_emit_variant_ctors(ctors, name, tparams, 0L) + "\u0001")))))))(emit_tparameter_suffix(tparams)), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string csharp_emitter_emit_record_field_defs(List<ARecordFieldDef> fields, List<Name> tparams, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<ARecordFieldDef, string>)((f) => (emit_type_expr_tp(f.type_expr, tparams) + ("\u0002" + (sanitize(f.name.value) + (((i < (((long)fields.Count) - 1L)) ? "\u0042\u0002" : "") + csharp_emitter_emit_record_field_defs(fields, tparams, (i + 1L))))))))(fields[(int)i]));
    ...
    public static string csharp_emitter_emit_ctor_fields(List<ATypeExpr> fields, List<Name> tparams, long i) => ((i == ((long)fields.Count)) ? "" : (emit_type_expr_tp(fields[(int)i], tparams) + ("\u0002\u0036\u0011\u000D\u0017\u0016" + (_Cce.FromUnicode(i.ToString()) + (((i < (((long)fields.Count) - 1L)) ? "\u0042\u0002" : "") + csharp_emitter_emit_ctor_fields(fields, tparams, (i + 1L)))))));

    public static string csharp_emitter_emit_type_expr(ATypeExpr te) => emit_type_expr_tp(te, new List<Name>());

    public static string emit_type_expr_tp(ATypeExpr te, List<Name> tparams) => te switch { ANamedType(var name) => ((Func<long, string>)((idx) => ((idx >= 0L) ? ("\u0028" + _Cce.FromUnicode(idx.ToString())) : when_type_name(name.value))))(find_tparam_index(tparams, name.value, 0L)), AFunType(var p, var r) => ("\u0036\u0019\u0012\u0018\u004F" + (emit_type_expr_tp(p, tparams) + ("\u0042\u0002" + (emit_type_expr_tp(r, tparams) + "\u0050")))), AAppType(var @base, var args) => (emit_type_expr_tp(@base, tparams) + ("\u004F" + (emit_type_expr_list_tp(args, tparams, 0L) + "\u0050"))), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string emit_type_expr_list(List<ATypeExpr> args, long i) => ((i == ((long)args.Count)) ? "" : (csharp_emitter_emit_type_expr(args[(int)i]) + (((i < (((long)args.Count) - 1L)) ? "\u0042\u0002" : "") + emit_type_expr_list(args, (i + 1L)))));
    ...
    public static string extract_ctor_type_args(CodexType ty) => ty switch { ConstructedTy(var name, var args) => ((((long)args.Count) == 0L) ? "" : ("\u004F" + (emit_cs_type_args(args, 0L) + "\u0050"))), _ => "", };
    ...
    public static string emit_tco_def(IRDef d, List<ArityEntry> arities) => ((Func<CodexType, string>)((ret) => ((Func<string, string>)((gen) => ("\u0002\u0002\u0002\u0002\u001F\u0019\u0020\u0017\u0011\u0018\u0002\u0013\u000E\u000F\u000E\u0011\u0018\u0002" + (cs_type(ret) + ("\u0002" + (sanitize(d.name) + (gen + ("\u004A" + (csharp_emitter_emit_def_params(d.@params, 0L) + ("\u004B\u0001\u0002\u0002\u0002\u0002\u005A\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u001B\u0014\u0011\u0017\u000D\u0002\u004A\u000E\u0015\u0019\u000D\u004B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001" + (emit_tco_body(d.body, d.name, d.@params, arities) + "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001\u0002\u0002\u0002\u0002\u005B\u0001")))))))))))(generic_suffix(d.type_val))))(get_return_type(d.type_val, ((long)d.@params.Count)));
    ...
    public static string emit_tco_apply(IRExpr e, string func_name, List<IRParam> @params, List<ArityEntry> arities) => (csharp_emitter_is_self_call(e, func_name) ? emit_tco_jump(e, @params, arities) : ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002" + (csharp_emitter_emit_expr(e, arities) + "\u0046\u0001")));

    public static string emit_tco_if(IRExpr cond, IRExpr t, IRExpr el, string func_name, List<IRParam> @params, List<ArityEntry> arities) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0011\u001C\u0002\u004A" + (csharp_emitter_emit_expr(cond, arities) + ("\u004B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001" + (emit_tco_body(t, func_name, @params, arities) + ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u000D\u0017\u0013\u000D\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001" + (emit_tco_body(el, func_name, @params, arities) + "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001"))))));

    public static string emit_tco_let(string name, CodexType ty, IRExpr val, IRExpr body, string func_name, List<IRParam> @params, List<ArityEntry> arities) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0021\u000F\u0015\u0002" + (sanitize(name) + ("\u0002\u004D\u0002" + (csharp_emitter_emit_expr(val, arities) + ("\u0046\u0001" + emit_tco_body(body, func_name, @params, arities))))));

    public static string emit_tco_match(IRExpr scrut, List<IRBranch> branches, string func_name, List<IRParam> @params, List<ArityEntry> arities) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0021\u000F\u0015\u0002\u0055\u000E\u0018\u0010\u0055\u0013\u0002\u004D\u0002" + (csharp_emitter_emit_expr(scrut, arities) + ("\u0046\u0001" + emit_tco_match_branches(branches, func_name, @params, arities, 0L, true))));
    ...
    public static string emit_tco_match_branch(IRBranch b, string func_name, List<IRParam> @params, List<ArityEntry> arities, long idx, bool is_first) => b.pattern switch { IrWildPat { } => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001" + (emit_tco_body(b.body, func_name, @params, arities) + "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001")), IrVarPat(var name, var ty) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0021\u000F\u0015\u0002" + (sanitize(name) + ("\u0002\u004D\u0002\u0055\u000E\u0018\u0010\u0055\u0013\u0046\u0001" + (emit_tco_body(b.body, func_name, @params, arities) + "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001")))), IrCtorPat(var name, var subs, var ty) => ((Func<string, string>)((keyword) => ((Func<string, string>)((match_var) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002" + (keyword + ("\u0002\u004A\u0055\u000E\u0018\u0010\u0055\u0013\u0002\u0011\u0013\u0002" + (sanitize(name) + ("\u0002" + (match_var + ("\u004B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001" + (emit_tco_ctor_bindings(subs, match_var, 0L) + (emit_tco_body(b.body, func_name, @params, arities) + "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001")))))))))))(("\u0055\u000E\u0018\u0010\u0055\u001A" + _Cce.FromUnicode(idx.ToString())))))((is_first ? "\u0011\u001C" : "\u000D\u0017\u0013\u000D\u0002\u0011\u001C")), IrLitPat(var text, var ty) => ((Func<string, string>)((keyword) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002" + (keyword + ("\u0002\u004A\u0010\u0020\u0023\u000D\u0018\u000E\u0041\u0027\u0025\u0019\u000F\u0017\u0013\u004A\u0055\u000E\u0018\u0010\u0055\u0013\u0042\u0002" + (text + ("\u004B\u004B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001" + (emit_tco_body(b.body, func_name, @params, arities) + "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001"))))))))((is_first ? "\u0011\u001C" : "\u000D\u0017\u0013\u000D\u0002\u0011\u001C")), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string emit_tco_ctor_binding(IRPat sub, string match_var, long i) => sub switch { IrVarPat(var name, var ty) => ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0021\u000F\u0015\u0002" + (sanitize(name) + ("\u0002\u004D\u0002" + (match_var + ("\u0041\u0036\u0011\u000D\u0017\u0016" + (_Cce.FromUnicode(i.ToString()) + "\u0046\u0001")))))), _ => "", };
    ...
    public static string emit_tco_temps(List<IRExpr> args, List<ArityEntry> arities, long i) => ((i == ((long)args.Count)) ? "" : ("\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0021\u000F\u0015\u0002\u0055\u000E\u0018\u0010\u0055" + (_Cce.FromUnicode(i.ToString()) + ("\u0002\u004D\u0002" + (csharp_emitter_emit_expr(args[(int)i], arities) + ("\u0046\u0001" + emit_tco_temps(args, arities, (i + 1L))))))));
    ...
    public static string csharp_emitter_emit_def(IRDef d, List<ArityEntry> arities) => (csharp_emitter_should_tco(d) ? emit_tco_def(d, arities) : ((Func<CodexType, string>)((ret) => ((Func<string, string>)((gen) => ("\u0002\u0002\u0002\u0002\u001F\u0019\u0020\u0017\u0011\u0018\u0002\u0013\u000E\u000F\u000E\u0011\u0018\u0002" + (cs_type(ret) + ("\u0002" + (sanitize(d.name) + (gen + ("\u004A" + (csharp_emitter_emit_def_params(d.@params, 0L) + ("\u004B\u0002\u004D\u0050\u0002" + (csharp_emitter_emit_expr(d.body, arities) + "\u0046\u0001")))))))))))(generic_suffix(d.type_val))))(get_return_type(d.type_val, ((long)d.@params.Count))));
    ...
    public static string csharp_emitter_emit_def_params(List<IRParam> @params, long i) => ((i == ((long)@params.Count)) ? "" : ((Func<IRParam, string>)((p) => (cs_type(p.type_val) + ("\u0002" + (sanitize(p.name) + (((i < (((long)@params.Count) - 1L)) ? "\u0042\u0002" : "") + csharp_emitter_emit_def_params(@params, (i + 1L))))))))(@params[(int)i]));
    ...
    public static string csharp_emitter_emit_apply_args(List<IRExpr> args, List<ArityEntry> arities, long i) => ((i == ((long)args.Count)) ? "" : ((i == (((long)args.Count) - 1L)) ? csharp_emitter_emit_expr(args[(int)i], arities) : (csharp_emitter_emit_expr(args[(int)i], arities) + ("\u0042\u0002" + csharp_emitter_emit_apply_args(args, arities, (i + 1L))))));
    ...
    public static string emit_builtin_is_letter(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("\u004A" + (a0 + ("\u0002\u0050\u004D\u0002\u0004\u0006\u0031\u0002\u0054\u0054\u0002" + (a0 + "\u0002\u004F\u004D\u0002\u0009\u0007\u0031\u004B"))))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_is_digit(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ("\u004A" + (a0 + ("\u0002\u0050\u004D\u0002\u0006\u0031\u0002\u0054\u0054\u0002" + (a0 + "\u0002\u004F\u004D\u0002\u0004\u0005\u0031\u004B"))))))(csharp_emitter_emit_expr(args[(int)0L], arities));
    ...
    public static string emit_builtin_char_code_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("\u004A\u004A\u0017\u0010\u0012\u001D\u004B" + (a0 + ("\u0058\u004A\u0011\u0012\u000E\u004B" + (a1 + "\u0059\u004B"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_char_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("\u004A\u004A\u0017\u0010\u0012\u001D\u004B" + (a0 + ("\u0058\u004A\u0011\u0012\u000E\u004B" + (a1 + "\u0059\u004B"))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_substring(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ((Func<string, string>)((a2) => (a0 + ("\u0041\u002D\u0019\u0020\u0013\u000E\u0015\u0011\u0012\u001D\u004A\u004A\u0011\u0012\u000E\u004B" + (a1 + ("\u0042\u0002\u004A\u0011\u0012\u000E\u004B" + (a2 + "\u004B")))))))(csharp_emitter_emit_expr(args[(int)2L], arities))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_list_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => (a0 + ("\u0058\u004A\u0011\u0012\u000E\u004B" + (a1 + "\u0059")))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_list_insert_at(List<IRExpr> args, List<ArityEntry> arities) => ((Func<CodexType, string>)((elem_ty) => ((Func<string, string>)((ty) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ((Func<string, string>)((a2) => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F\u0031\u0011\u0013\u000E\u004F" + (ty + ("\u0050\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002\u0021\u000F\u0015\u0002\u0055\u0017\u0002\u004D\u0002\u0012\u000D\u001B\u0002\u0031\u0011\u0013\u000E\u004F" + (ty + ("\u0050\u004A" + (a0 + ("\u004B\u0046\u0002\u0055\u0017\u0041\u002B\u0012\u0013\u000D\u0015\u000E\u004A\u004A\u0011\u0012\u000E\u004B" + (a1 + ("\u0042\u0002" + (a2 + "\u004B\u0046\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002\u0055\u0017\u0046\u0002\u005B\u004B\u004B\u004A\u004B"))))))))))))(csharp_emitter_emit_expr(args[(int)2L], arities))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities))))(cs_type(elem_ty))))(ir_expr_type(args[(int)0L]) switch { ListTy(var et) => et, _ => new ErrorTy(), });

    public static string emit_builtin_list_snoc(List<IRExpr> args, List<ArityEntry> arities) => ((Func<CodexType, string>)((elem_ty) => ((Func<string, string>)((ty) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F\u0031\u0011\u0013\u000E\u004F" + (ty + ("\u0050\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002\u0021\u000F\u0015\u0002\u0055\u0017\u0002\u004D\u0002" + (a0 + ("\u0046\u0002\u0055\u0017\u0041\u0029\u0016\u0016\u004A" + (a1 + "\u004B\u0046\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002\u0055\u0017\u0046\u0002\u005B\u004B\u004B\u004A\u004B"))))))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities))))(cs_type(elem_ty))))(ir_expr_type(args[(int)0L]) switch { ListTy(var et) => et, _ => new ErrorTy(), });
    ...
    public static string emit_builtin_text_contains(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => (a0 + ("\u0041\u0032\u0010\u0012\u000E\u000F\u0011\u0012\u0013\u004A" + (a1 + "\u004B")))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));

    public static string emit_builtin_text_starts_with(List<IRExpr> args, List<ArityEntry> arities) => ((Func<string, string>)((a0) => ((Func<string, string>)((a1) => (a0 + ("\u0041\u002D\u000E\u000F\u0015\u000E\u0013\u0035\u0011\u000E\u0014\u004A" + (a1 + "\u004B")))))(csharp_emitter_emit_expr(args[(int)1L], arities))))(csharp_emitter_emit_expr(args[(int)0L], arities));
    ...
    public static string csharp_emitter_emit_apply(IRExpr e, List<ArityEntry> arities) => ((Func<ApplyChain, string>)((chain) => ((Func<IRExpr, string>)((root) => ((Func<List<IRExpr>, string>)((args) => root switch { IrName(var n, var ty) => (is_builtin_name(n) ? csharp_emitter_emit_builtin(n, args, arities) : (((((long)n.Length) > 0L) && is_upper_letter(((long)n[(int)0L]))) ? ((Func<CodexType, string>)((result_ty) => ((Func<string, string>)((ctor_type_args) => ("\u0012\u000D\u001B\u0002" + (sanitize(n) + (ctor_type_args + ("\u004A" + (csharp_emitter_emit_apply_args(args, arities, 0L) + "\u004B")))))))(extract_ctor_type_args(result_ty))))(ir_expr_type(e)) : ((Func<long, string>)((ar) => (((ar > 1L) && (((long)args.Count) == ar)) ? (sanitize(n) + ("\u004A" + (csharp_emitter_emit_apply_args(args, arities, 0L) + "\u004B"))) : (((ar > 1L) && (((long)args.Count) < ar)) ? ((Func<long, string>)((remaining) => (emit_partial_wrappers(0L, remaining) + (sanitize(n) + ("\u004A" + (csharp_emitter_emit_apply_args(args, arities, 0L) + ("\u0042\u0002" + (emit_partial_params(0L, remaining) + "\u004B"))))))))((ar - ((long)args.Count))) : emit_expr_curried(e, arities)))))(lookup_arity(arities, n)))), _ => emit_expr_curried(e, arities), }))(chain.args)))(chain.root)))(collect_apply_chain(e, new List<IRExpr>()));

    public static string emit_expr_curried(IRExpr e, List<ArityEntry> arities) => e switch { IrApply(var f, var a, var ty) => (csharp_emitter_emit_expr(f, arities) + ("\u004A" + (csharp_emitter_emit_expr(a, arities) + "\u004B"))), _ => csharp_emitter_emit_expr(e, arities), };

    public static string csharp_emitter_emit_expr(IRExpr e, List<ArityEntry> arities) => e switch { IrIntLit(var n) => (_Cce.FromUnicode(n.ToString()) + "\u0031"), IrNumLit(var n) => _Cce.FromUnicode(n.ToString()), IrTextLit(var s) => ("\u0048" + (csharp_emitter_escape_text(s) + "\u0048")), IrBoolLit(var b) => (b ? "\u000E\u0015\u0019\u000D" : "\u001C\u000F\u0017\u0013\u000D"), IrCharLit(var n) => _Cce.FromUnicode(n.ToString()), IrName(var n, var ty) => ((n == "\u0015\u000D\u000F\u0016\u0049\u0017\u0011\u0012\u000D") ? "\u0055\u0032\u0018\u000D\u0041\u0036\u0015\u0010\u001A\u0033\u0012\u0011\u0018\u0010\u0016\u000D\u004A\u0032\u0010\u0012\u0013\u0010\u0017\u000D\u0041\u002F\u000D\u000F\u0016\u0031\u0011\u0012\u000D\u004A\u004B\u0002\u0044\u0044\u0002\u0048\u0048\u004B" : ((n == "\u001D\u000D\u000E\u0049\u000F\u0015\u001D\u0013") ? "\u0027\u0012\u0021\u0011\u0015\u0010\u0012\u001A\u000D\u0012\u000E\u0041\u0037\u000D\u000E\u0032\u0010\u001A\u001A\u000F\u0012\u0016\u0031\u0011\u0012\u000D\u0029\u0015\u001D\u0013\u004A\u004B\u0041\u002D\u000D\u0017\u000D\u0018\u000E\u004A\u0055\u0032\u0018\u000D\u0041\u0036\u0015\u0010\u001A\u0033\u0012\u0011\u0018\u0010\u0016\u000D\u004B\u0041\u0028\u0010\u0031\u0011\u0013\u000E\u004A\u004B" : ((n == "\u0018\u0019\u0015\u0015\u000D\u0012\u000E\u0049\u0016\u0011\u0015") ? "\u0055\u0032\u0018\u000D\u0041\u0036\u0015\u0010\u001A\u0033\u0012\u0011\u0018\u0010\u0016\u000D\u004A\u0030\u0011\u0015\u000D\u0018\u000E\u0010\u0015\u001E\u0041\u0037\u000D\u000E\u0032\u0019\u0015\u0015\u000D\u0012\u000E\u0030\u0011\u0015\u000D\u0018\u000E\u0010\u0015\u001E\u004A\u004B\u004B" : (((((long)n.Length) > 0L) && is_upper_letter(((long)n[(int)0L]))) ? ("\u0012\u000D\u001B\u0002" + (sanitize(n) + "\u004A\u004B")) : ((lookup_arity(arities, n) == 0L) ? (sanitize(n) + "\u004A\u004B") : ((Func<long, string>)((ar) => ((ar >= 2L) ? (emit_partial_wrappers(0L, ar) + (sanitize(n) + ("\u004A" + (emit_partial_params(0L, ar) + "\u004B")))) : sanitize(n))))(lookup_arity(arities, n))))))), IrBinary(var op, var l, var r, var ty) => csharp_emitter_emit_binary(op, l, r, ty, arities), IrNegate(var operand) => ("\u004A\u0049" + (csharp_emitter_emit_expr(operand, arities) + "\u004B")), IrIf(var c, var t, var el, var ty) => ("\u004A" + (csharp_emitter_emit_expr(c, arities) + ("\u0002\u0044\u0002" + (csharp_emitter_emit_expr(t, arities) + ("\u0002\u0045\u0002" + (csharp_emitter_emit_expr(el, arities) + "\u004B")))))), IrLet(var name, var ty, var val, var body) => csharp_emitter_emit_let(name, ty, val, body, arities), IrApply(var f, var a, var ty) => csharp_emitter_emit_apply(e, arities), IrLambda(var @params, var body, var ty) => csharp_emitter_emit_lambda(@params, body, arities), IrList(var elems, var ty) => csharp_emitter_emit_list(elems, ty, arities), IrMatch(var scrut, var branches, var ty) => csharp_emitter_emit_match(scrut, branches, ty, arities), IrDo(var stmts, var ty) => csharp_emitter_emit_do(stmts, ty, arities), IrHandle(var eff, var body, var clauses, var ty) => csharp_emitter_emit_handle(eff, body, clauses, ty, arities), IrRecord(var name, var fields, var ty) => csharp_emitter_emit_record(name, fields, arities), IrFieldAccess(var rec, var field, var ty) => (csharp_emitter_emit_expr(rec, arities) + ("\u0041" + sanitize(field))), IrFork(var body, var ty) => ("\u0028\u000F\u0013\u0022\u0041\u002F\u0019\u0012\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u004A" + (csharp_emitter_emit_expr(body, arities) + "\u004B\u004A\u0012\u0019\u0017\u0017\u004B\u004B")), IrAwait(var task, var ty) => ("\u004A" + (csharp_emitter_emit_expr(task, arities) + "\u004B\u0041\u002F\u000D\u0013\u0019\u0017\u000E")), IrError(var msg, var ty) => ("\u0051\u004E\u0002\u000D\u0015\u0015\u0010\u0015\u0045\u0002" + (msg + "\u0002\u004E\u0051\u0002\u0016\u000D\u001C\u000F\u0019\u0017\u000E")), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string csharp_emitter_escape_text(string s) => string.Concat(escape_text_loop(s, 0L, ((long)s.Length), new List<string>()));

    public static string emit_bin_op(IRBinaryOp op) => op switch { IrAddInt { } => "\u004C", IrSubInt { } => "\u0049", IrMulInt { } => "\u004E", IrDivInt { } => "\u0051", IrPowInt { } => "\u005E", IrAddNum { } => "\u004C", IrSubNum { } => "\u0049", IrMulNum { } => "\u004E", IrDivNum { } => "\u0051", IrEq { } => "\u004D\u004D", IrNotEq { } => "\u0043\u004D", IrLt { } => "\u004F", IrGt { } => "\u0050", IrLtEq { } => "\u004F\u004D", IrGtEq { } => "\u0050\u004D", IrAnd { } => "\u0054\u0054", IrOr { } => "\u0057\u0057", IrAppendText { } => "\u004C", IrAppendList { } => "\u004C", IrConsList { } => "\u004C", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string csharp_emitter_emit_binary(IRBinaryOp op, IRExpr l, IRExpr r, CodexType ty, List<ArityEntry> arities) => op switch { IrAppendList { } => ("\u0027\u0012\u0019\u001A\u000D\u0015\u000F\u0020\u0017\u000D\u0041\u0032\u0010\u0012\u0018\u000F\u000E\u004A" + (csharp_emitter_emit_expr(l, arities) + ("\u0042\u0002" + (csharp_emitter_emit_expr(r, arities) + "\u004B\u0041\u0028\u0010\u0031\u0011\u0013\u000E\u004A\u004B")))), IrConsList { } => ("\u0012\u000D\u001B\u0002\u0031\u0011\u0013\u000E\u004F" + (cs_type(ir_expr_type(l)) + ("\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_expr(l, arities) + ("\u0002\u005B\u0041\u0032\u0010\u0012\u0018\u000F\u000E\u004A" + (csharp_emitter_emit_expr(r, arities) + "\u004B\u0041\u0028\u0010\u0031\u0011\u0013\u000E\u004A\u004B")))))), _ => ("\u004A" + (csharp_emitter_emit_expr(l, arities) + ("\u0002" + (emit_bin_op(op) + ("\u0002" + (csharp_emitter_emit_expr(r, arities) + "\u004B")))))), };

    public static string csharp_emitter_emit_let(string name, CodexType ty, IRExpr val, IRExpr body, List<ArityEntry> arities) => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F" + (cs_type(ty) + ("\u0042\u0002" + (cs_type(ir_expr_type(body)) + ("\u0050\u004B\u004A\u004A" + (sanitize(name) + ("\u004B\u0002\u004D\u0050\u0002" + (csharp_emitter_emit_expr(body, arities) + ("\u004B\u004B\u004A" + (csharp_emitter_emit_expr(val, arities) + "\u004B"))))))))));

    public static string csharp_emitter_emit_lambda(List<IRParam> @params, IRExpr body, List<ArityEntry> arities) => ((((long)@params.Count) == 0L) ? ("\u004A\u004A\u004B\u0002\u004D\u0050\u0002" + (csharp_emitter_emit_expr(body, arities) + "\u004B")) : ((((long)@params.Count) == 1L) ? ((Func<IRParam, string>)((p) => ("\u004A\u004A" + (cs_type(p.type_val) + ("\u0002" + (sanitize(p.name) + ("\u004B\u0002\u004D\u0050\u0002" + (csharp_emitter_emit_expr(body, arities) + "\u004B"))))))))(@params[(int)0L]) : ("\u004A\u004A\u004B\u0002\u004D\u0050\u0002" + (csharp_emitter_emit_expr(body, arities) + "\u004B"))));

    public static string csharp_emitter_emit_list(List<IRExpr> elems, CodexType ty, List<ArityEntry> arities) => ((((long)elems.Count) == 0L) ? ("\u0012\u000D\u001B\u0002\u0031\u0011\u0013\u000E\u004F" + (cs_type(ty) + "\u0050\u004A\u004B")) : ("\u0012\u000D\u001B\u0002\u0031\u0011\u0013\u000E\u004F" + (cs_type(ty) + ("\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_list_elems(elems, 0L, arities) + "\u0002\u005B")))));

    public static string csharp_emitter_emit_list_elems(List<IRExpr> elems, long i, List<ArityEntry> arities) => ((i == ((long)elems.Count)) ? "" : ((i == (((long)elems.Count) - 1L)) ? csharp_emitter_emit_expr(elems[(int)i], arities) : (csharp_emitter_emit_expr(elems[(int)i], arities) + ("\u0042\u0002" + csharp_emitter_emit_list_elems(elems, (i + 1L), arities)))));

    public static string csharp_emitter_emit_match(IRExpr scrut, List<IRBranch> branches, CodexType ty, List<ArityEntry> arities) => ((Func<string, string>)((arms) => ((Func<bool, string>)((needs_wild) => (csharp_emitter_emit_expr(scrut, arities) + ("\u0002\u0013\u001B\u0011\u000E\u0018\u0014\u0002\u005A\u0002" + (arms + ((needs_wild ? "\u0055\u0002\u004D\u0050\u0002\u000E\u0014\u0015\u0010\u001B\u0002\u0012\u000D\u001B\u0002\u002B\u0012\u0021\u000F\u0017\u0011\u0016\u002A\u001F\u000D\u0015\u000F\u000E\u0011\u0010\u0012\u0027\u0024\u0018\u000D\u001F\u000E\u0011\u0010\u0012\u004A\u0048\u002C\u0010\u0012\u0049\u000D\u0024\u0014\u000F\u0019\u0013\u000E\u0011\u0021\u000D\u0002\u001A\u000F\u000E\u0018\u0014\u0048\u004B\u0042\u0002" : "") + "\u005B"))))))((has_any_catch_all(branches, 0L) ? false : true))))(emit_match_arms(branches, 0L, arities));

    public static string emit_match_arms(List<IRBranch> branches, long i, List<ArityEntry> arities) => ((i == ((long)branches.Count)) ? "" : ((Func<IRBranch, string>)((arm) => ((Func<string, string>)((this_arm) => (is_catch_all(arm.pattern) ? this_arm : (this_arm + emit_match_arms(branches, (i + 1L), arities)))))((csharp_emitter_emit_pattern(arm.pattern) + ("\u0002\u004D\u0050\u0002" + (csharp_emitter_emit_expr(arm.body, arities) + "\u0042\u0002"))))))(branches[(int)i]));
    ...
    public static string csharp_emitter_emit_pattern(IRPat p) => p switch { IrVarPat(var name, var ty) => (cs_type(ty) + ("\u0002" + sanitize(name))), IrLitPat(var text, var ty) => text, IrCtorPat(var name, var subs, var ty) => ((((long)subs.Count) == 0L) ? (sanitize(name) + "\u0002\u005A\u0002\u005B") : (sanitize(name) + ("\u004A" + (csharp_emitter_emit_sub_patterns(subs, 0L) + "\u004B")))), IrWildPat { } => "\u0055", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string csharp_emitter_emit_sub_patterns(List<IRPat> subs, long i) => ((i == ((long)subs.Count)) ? "" : ((Func<IRPat, string>)((sub) => (emit_sub_pattern(sub) + (((i < (((long)subs.Count) - 1L)) ? "\u0042\u0002" : "") + csharp_emitter_emit_sub_patterns(subs, (i + 1L))))))(subs[(int)i]));

    public static string emit_sub_pattern(IRPat p) => p switch { IrVarPat(var name, var ty) => ("\u0021\u000F\u0015\u0002" + sanitize(name)), IrCtorPat(var name, var subs, var ty) => csharp_emitter_emit_pattern(p), IrWildPat { } => "\u0055", IrLitPat(var text, var ty) => text, _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string csharp_emitter_emit_do(List<IRDoStmt> stmts, CodexType ty, List<ArityEntry> arities) => ((Func<string, string>)((ret_type) => ((Func<long, string>)((len) => ty switch { VoidTy { } => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F\u0010\u0020\u0023\u000D\u0018\u000E\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_do_stmts(stmts, 0L, len, false, arities) + "\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002\u0012\u0019\u0017\u0017\u0046\u0002\u005B\u004B\u004B\u004A\u004B")), NothingTy { } => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F\u0010\u0020\u0023\u000D\u0018\u000E\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_do_stmts(stmts, 0L, len, false, arities) + "\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002\u0012\u0019\u0017\u0017\u0046\u0002\u005B\u004B\u004B\u004A\u004B")), ErrorTy { } => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F\u0010\u0020\u0023\u000D\u0018\u000E\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_do_stmts(stmts, 0L, len, false, arities) + "\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002\u0012\u0019\u0017\u0017\u0046\u0002\u005B\u004B\u004B\u004A\u004B")), _ => ((len == 0L) ? ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F" + (ret_type + "\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0002\u0012\u0019\u0017\u0017\u0046\u0002\u005B\u004B\u004B\u004A\u004B")) : ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F" + (ret_type + ("\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_do_stmts(stmts, 0L, len, true, arities) + "\u0002\u005B\u004B\u004B\u004A\u004B"))))), }))(((long)stmts.Count))))(cs_type(ty));
    ...
    public static string csharp_emitter_emit_do_stmt(IRDoStmt s, bool use_return, List<ArityEntry> arities) => s switch { IrDoBind(var name, var ty, var val) => ("\u0021\u000F\u0015\u0002" + (sanitize(name) + ("\u0002\u004D\u0002" + (csharp_emitter_emit_expr(val, arities) + "\u0046")))), IrDoExec(var e) => (use_return ? ("\u0015\u000D\u000E\u0019\u0015\u0012\u0002" + (csharp_emitter_emit_expr(e, arities) + "\u0046")) : (csharp_emitter_emit_expr(e, arities) + "\u0046")), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string emit_record_fields(List<IRFieldVal> fields, long i, List<ArityEntry> arities) => ((i == ((long)fields.Count)) ? "" : ((Func<IRFieldVal, string>)((f) => (sanitize(f.name) + ("\u0045\u0002" + (csharp_emitter_emit_expr(f.value, arities) + (((i < (((long)fields.Count) - 1L)) ? "\u0042\u0002" : "") + emit_record_fields(fields, (i + 1L), arities)))))))(fields[(int)i]));

    public static string csharp_emitter_emit_handle(string eff, IRExpr body, List<IRHandleClause> clauses, CodexType ty, List<ArityEntry> arities) => ((Func<string, string>)((ret_type) => ("\u004A\u004A\u0036\u0019\u0012\u0018\u004F" + (ret_type + ("\u0050\u004B\u004A\u004A\u004B\u0002\u004D\u0050\u0002\u005A\u0002" + (csharp_emitter_emit_handle_clauses(clauses, ret_type, arities) + ("\u0015\u000D\u000E\u0019\u0015\u0012\u0002" + (csharp_emitter_emit_expr(body, arities) + "\u0046\u0002\u005B\u004B\u004B\u004A\u004B"))))))))(cs_type(ty));
    ...
    public static string codex_emitter_emit_type_def(ATypeDef td) => td switch { ARecordTypeDef(var name, var tparams, var fields) => (name.value + ("\u0002\u004D\u0002\u0015\u000D\u0018\u0010\u0015\u0016\u0002\u005A" + (codex_emitter_emit_record_field_defs(fields, 0L) + "\u0001\u005B\u0001"))), AVariantTypeDef(var name, var tparams, var ctors) => (name.value + ("\u0002\u004D\u0001" + codex_emitter_emit_variant_ctors(ctors, 0L))), _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string codex_emitter_emit_record_field_defs(List<ARecordFieldDef> fields, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<ARecordFieldDef, string>)((f) => ((Func<string, string>)((comma) => (comma + ("\u0001\u0002" + (f.name.value + ("\u0002\u0045\u0002" + (codex_emitter_emit_type_expr(f.type_expr) + codex_emitter_emit_record_field_defs(fields, (i + 1L)))))))))(((i > 0L) ? "\u0042" : ""))))(fields[(int)i]));

    public static string codex_emitter_emit_variant_ctors(List<AVariantCtorDef> ctors, long i) => ((i == ((long)ctors.Count)) ? "" : ((Func<AVariantCtorDef, string>)((c) => ("\u0002\u0057\u0002" + (c.name.value + (codex_emitter_emit_ctor_fields(c.fields, 0L) + ("\u0001" + codex_emitter_emit_variant_ctors(ctors, (i + 1L))))))))(ctors[(int)i]));

    public static string codex_emitter_emit_ctor_fields(List<ATypeExpr> fields, long i) => ((i == ((long)fields.Count)) ? "" : ("\u0002\u004A" + (codex_emitter_emit_type_expr(fields[(int)i]) + ("\u004B" + codex_emitter_emit_ctor_fields(fields, (i + 1L))))));

    public static string codex_emitter_emit_type_expr(ATypeExpr te) => te switch { ANamedType(var name) => name.value, AFunType(var p, var r) => ("\u004A" + (codex_emitter_emit_type_expr(p) + ("\u0002\u0049\u0050\u0002" + (codex_emitter_emit_type_expr(r) + "\u004B")))), AAppType(var @base, var args) => (codex_emitter_emit_type_expr(@base) + ("\u0002" + emit_type_expr_args(args, 0L))), AEffectType(var effs, var ret) => ("\u0058" + (emit_effect_names(effs, 0L) + ("\u0059\u0002" + codex_emitter_emit_type_expr(ret)))), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string emit_type_expr_wrapped(ATypeExpr te) => te switch { AFunType(var p, var r) => ("\u004A" + (codex_emitter_emit_type_expr(te) + "\u004B")), AAppType(var @base, var args) => ("\u004A" + (codex_emitter_emit_type_expr(te) + "\u004B")), _ => codex_emitter_emit_type_expr(te), };
    ...
    public static string wrap_fun_param(CodexType ty) => ty switch { FunTy(var p, var r) => ("\u004A" + (emit_type(ty) + "\u004B")), _ => emit_type(ty), };

    public static string wrap_complex(CodexType ty) => ty switch { FunTy(var p, var r) => ("\u004A" + (emit_type(ty) + "\u004B")), ListTy(var elem) => ("\u004A" + (emit_type(ty) + "\u004B")), _ => emit_type(ty), };
    ...
    public static string codex_emitter_emit_def(IRDef d, List<string> ctor_names) => (skip_def(d, ctor_names) ? "" : ((Func<string, string>)((sig) => (sig + ("\u0002\u004D\u0001\u0002" + (codex_emitter_emit_expr(d.body, ctor_names, 1L) + "\u0001")))))((d.name + ("\u0002\u0045\u0002" + (emit_type(d.type_val) + ("\u0001" + (d.name + codex_emitter_emit_def_params(d.@params, 0L))))))));
    ...
    public static string codex_emitter_emit_def_params(List<IRParam> @params, long i) => ((i == ((long)@params.Count)) ? "" : ((Func<IRParam, string>)((p) => ("\u0002\u004A" + (p.name + ("\u004B" + codex_emitter_emit_def_params(@params, (i + 1L)))))))(@params[(int)i]));

    public static string codex_emitter_emit_expr(IRExpr e, List<string> ctors, long indent) => e switch { IrIntLit(var n) => _Cce.FromUnicode(n.ToString()), IrNumLit(var n) => _Cce.FromUnicode(n.ToString()), IrTextLit(var s) => ("\u0048" + (codex_emitter_escape_text(s) + "\u0048")), IrBoolLit(var b) => (b ? "\u0028\u0015\u0019\u000D" : "\u0036\u000F\u0017\u0013\u000D"), IrCharLit(var n) => ("\u0047" + (escape_char(n) + "\u0047")), IrName(var n, var ty) => n, IrBinary(var op, var l, var r, var ty) => codex_emitter_emit_binary(op, l, r, ctors, indent), IrNegate(var operand) => ("\u0003\u0002\u0049\u0002" + codex_emitter_emit_expr(operand, ctors, indent)), IrIf(var c, var t, var el, var ty) => codex_emitter_emit_if(c, t, el, ctors, indent, 0L), IrLet(var name, var ty, var val, var body) => codex_emitter_emit_let(name, val, body, ctors, indent), IrApply(var f, var a, var ty) => codex_emitter_emit_apply(e, ctors, indent), IrLambda(var @params, var body, var ty) => codex_emitter_emit_lambda(@params, body, ctors, indent), IrList(var elems, var ty) => codex_emitter_emit_list(elems, ctors, indent), IrMatch(var scrut, var branches, var ty) => codex_emitter_emit_match(scrut, branches, ctors, indent), IrDo(var stmts, var ty) => codex_emitter_emit_do(stmts, ctors, indent), IrRecord(var name, var fields, var ty) => codex_emitter_emit_record(name, fields, ctors, indent), IrFieldAccess(var rec, var field, var ty) => codex_emitter_emit_field_access(rec, field, ctors, indent), IrFork(var body, var ty) => ("\u001C\u0010\u0015\u0022\u0002\u004A" + (codex_emitter_emit_expr(body, ctors, indent) + "\u004B")), IrAwait(var task, var ty) => ("\u000F\u001B\u000F\u0011\u000E\u0002\u004A" + (codex_emitter_emit_expr(task, ctors, indent) + "\u004B")), IrHandle(var eff, var body, var clauses, var ty) => codex_emitter_emit_handle(eff, body, clauses, ctors, indent), IrError(var msg, var ty) => "\u0003", _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string bin_op_text(IRBinaryOp op) => op switch { IrAddInt { } => "\u004C", IrSubInt { } => "\u0049", IrMulInt { } => "\u004E", IrDivInt { } => "\u0051", IrPowInt { } => "\u005E", IrAddNum { } => "\u004C", IrSubNum { } => "\u0049", IrMulNum { } => "\u004E", IrDivNum { } => "\u0051", IrEq { } => "\u004D\u004D", IrNotEq { } => "\u0051\u004D", IrLt { } => "\u004F", IrGt { } => "\u0050", IrLtEq { } => "\u004F\u004D", IrGtEq { } => "\u0050\u004D", IrAnd { } => "\u0054", IrOr { } => "\u0057", IrAppendText { } => "\u004C\u004C", IrAppendList { } => "\u004C\u004C", IrConsList { } => "\u0045\u0045", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string codex_emitter_emit_if(IRExpr c, IRExpr t, IRExpr el, List<string> ctors, long indent, long else_offset) => ("\u0011\u001C\u0002" + (codex_emitter_emit_expr(c, ctors, indent) + ("\u0002\u000E\u0014\u000D\u0012\u0002" + (codex_emitter_emit_expr(t, ctors, indent) + ("\u0001" + (make_indent(indent) + (pad_spaces(else_offset) + ("\u000D\u0017\u0013\u000D\u0002" + emit_else(el, ctors, indent, else_offset)))))))));
    ...
    public static string wrap_arg(IRExpr e, List<string> ctors, long indent, bool is_ctor) => (needs_parens(e, is_ctor) ? ("\u004A" + (codex_emitter_emit_expr(e, ctors, indent) + "\u004B")) : codex_emitter_emit_expr(e, ctors, indent));

    public static bool is_ctor_name(IRExpr e, List<string> ctors) => e switch { IrName(var n, var ty) => ctors.Contains(n), _ => false, };
    ...
    public static string codex_emitter_emit_lambda(List<IRParam> @params, IRExpr body, List<string> ctors, long indent) => ("\u0056" + (emit_lambda_params(@params, 0L) + ("\u0002\u0049\u0050\u0002" + codex_emitter_emit_expr(body, ctors, indent))));
    ...
    public static string codex_emitter_emit_list(List<IRExpr> elems, List<string> ctors, long indent) => ("\u0058" + (codex_emitter_emit_list_elems(elems, ctors, indent, 0L) + "\u0059"));

    public static string codex_emitter_emit_list_elems(List<IRExpr> elems, List<string> ctors, long indent, long i) => ((i == ((long)elems.Count)) ? "" : ((Func<string, string>)((sep) => (sep + (codex_emitter_emit_expr(elems[(int)i], ctors, indent) + codex_emitter_emit_list_elems(elems, ctors, indent, (i + 1L))))))(((i > 0L) ? "\u0042\u0002" : "")));
    ...
    public static string emit_branches(List<IRBranch> branches, List<string> ctors, long indent, long i) => ((i == ((long)branches.Count)) ? "" : ((Func<IRBranch, string>)((b) => ("\u0001" + (make_indent((indent + 1L)) + ("\u0011\u001C\u0002" + (codex_emitter_emit_pattern(b.pattern) + ("\u0002\u0049\u0050\u0002" + (codex_emitter_emit_expr(b.body, ctors, (indent + 1L)) + emit_branches(branches, ctors, indent, (i + 1L))))))))))(branches[(int)i]));

    public static string codex_emitter_emit_pattern(IRPat p) => p switch { IrVarPat(var name, var ty) => name, IrLitPat(var text, var ty) => text, IrCtorPat(var name, var subs, var ty) => (name + codex_emitter_emit_sub_patterns(subs, 0L)), IrWildPat { } => "\u0055", _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string codex_emitter_emit_sub_patterns(List<IRPat> subs, long i) => ((i == ((long)subs.Count)) ? "" : ("\u0002\u004A" + (codex_emitter_emit_pattern(subs[(int)i]) + ("\u004B" + codex_emitter_emit_sub_patterns(subs, (i + 1L))))));

    public static string codex_emitter_emit_do(List<IRDoStmt> stmts, List<string> ctors, long indent) => ("\u0016\u0010" + codex_emitter_emit_do_stmts(stmts, ctors, indent, 0L));
    ...
    public static string codex_emitter_emit_do_stmt(IRDoStmt s, List<string> ctors, long indent) => s switch { IrDoBind(var name, var ty, var val) => (name + ("\u0002\u004F\u0049\u0002" + codex_emitter_emit_expr(val, ctors, indent))), IrDoExec(var e) => codex_emitter_emit_expr(e, ctors, indent), _ => throw new InvalidOperationException("Non-exhaustive match"), };

    public static string codex_emitter_emit_record(string name, List<IRFieldVal> fields, List<string> ctors, long indent) => ((((long)fields.Count) <= 1L) ? (name + ("\u0002\u005A" + (emit_record_fields_inline(fields, ctors, indent, 0L) + "\u0002\u005B"))) : (name + ("\u0002\u005A\u0001" + (emit_record_fields_multi(fields, ctors, indent, 0L) + (make_indent(indent) + "\u005B")))));

    public static string emit_record_fields_inline(List<IRFieldVal> fields, List<string> ctors, long indent, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<IRFieldVal, string>)((f) => ((Func<string, string>)((sep) => (sep + ("\u0002" + (f.name + ("\u0002\u004D\u0002" + (codex_emitter_emit_expr(f.value, ctors, indent) + emit_record_fields_inline(fields, ctors, indent, (i + 1L)))))))))(((i > 0L) ? "\u0042" : ""))))(fields[(int)i]));

    public static string emit_record_fields_multi(List<IRFieldVal> fields, List<string> ctors, long indent, long i) => ((i == ((long)fields.Count)) ? "" : ((Func<IRFieldVal, string>)((f) => ((Func<string, string>)((comma) => (make_indent((indent + 1L)) + (f.name + ("\u0002\u004D\u0002" + (codex_emitter_emit_expr(f.value, ctors, (indent + 1L)) + (comma + ("\u0001" + emit_record_fields_multi(fields, ctors, indent, (i + 1L))))))))))(((i < (((long)fields.Count) - 1L)) ? "\u0042" : ""))))(fields[(int)i]));

    public static string codex_emitter_emit_field_access(IRExpr rec, string field, List<string> ctors, long indent) => rec switch { IrName(var n, var ty) => (n + ("\u0041" + field)), IrFieldAccess(var r, var f, var ty) => (codex_emitter_emit_field_access(r, f, ctors, indent) + ("\u0041" + field)), _ => ("\u004A" + (codex_emitter_emit_expr(rec, ctors, indent) + ("\u004B\u0041" + field))), };
    ...
    public static string codex_emitter_escape_text(string s) => string.Concat(escape_text_collect(s, 0L, ((long)s.Length), new List<string>()));
    ...
    public static string codex_emitter_emit_full_chapter(IRChapter m, List<ATypeDef> type_defs) => ((Func<List<string>, string>)((ctor_names) => ((Func<string, string>)((header) => (header + (codex_emitter_emit_type_defs(type_defs, 0L) + codex_emitter_emit_all_defs(m.defs, ctor_names, 0L)))))(((m.chapter_title == "") ? "" : ("\u0032\u0014\u000F\u001F\u000E\u000D\u0015\u0045\u0002" + (m.chapter_title + ("\u0001\u0001" + ((m.prose == "") ? "" : ("\u0002" + (m.prose + "\u0001\u0001"))))))))))(codex_emitter_collect_ctor_names(type_defs, 0L));
    ...
    public static string t_nl_after_brace() => "\u005A\u0001\u0010\u0022";

    public static string t_nl_after_close_brace() => "\u005B\u0001\u0010\u0022";

    public static string t_nl_after_paren() => "\u004B\u0001\u0010\u0022";

    public static string t_nl_after_comma() => "\u0042\u0001\u0010\u0022";

    public static string t_nl_after_semicolon() => "\u0046\u0001\u0010\u0022";

    public static string t_nl_after_backslash() => "\u0056\u0001\u0010\u0022";

    public static string t_nl_after_quote() => "\u0048\u0001\u0010\u0022";

    public static string t_dq_single() => "\u0048";

    public static string t_dq_two() => "\u0048\u0048";

    public static string t_dq_three() => "\u0048\u0048\u0048";

    public static string t_dq_in_text() => "\u0013\u000F\u001E\u0002\u0048\u0014\u000D\u0017\u0017\u0010\u0048\u0002\u001B\u0010\u0015\u0017\u0016";

    public static string t_dq_at_start() => "\u0048\u0014\u000D\u0017\u0017\u0010";

    public static string t_dq_at_end() => "\u0014\u000D\u0017\u0017\u0010\u0048";

    public static string t_bs_single() => "\u0056";

    public static string t_bs_two() => "\u0056\u0056";

    public static string t_bs_in_text() => "\u000F\u0056\u0020\u0056\u0018";

    public static string t_mix_bs_nl() => "\u0056\u0001";

    public static string t_mix_nl_bs() => "\u0001\u0056";

    public static string t_mix_dq_nl() => "\u0048\u0001";

    public static string t_mix_nl_dq() => "\u0001\u0048";

    public static string t_mix_all() => "\u0056\u0048\u0001";

    public static string t_mix_all_rev() => "\u0001\u0048\u0056";

    public static string t_mix_dq_nl_dq() => "\u0048\u0001\u0048";

    public static string t_mix_repeat() => "\u0056\u0048\u0001\u0056\u0048\u0001";

    public static string t_real_braces() => "\u004B\u0001\u0002\u0002\u0002\u0002\u005A\u0001";

    public static string t_real_while() => "\u004B\u0001\u0002\u0002\u0002\u0002\u005A\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u001B\u0014\u0011\u0017\u000D\u0002\u004A\u000E\u0015\u0019\u000D\u004B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001";

    public static string t_real_closing() => "\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001\u0002\u0002\u0002\u0002\u005B\u0001";

    public static string t_real_using() => "\u0019\u0013\u0011\u0012\u001D\u0002\u002D\u001E\u0013\u000E\u000D\u001A\u0046\u0001\u0019\u0013\u0011\u0012\u001D\u0002\u002D\u001E\u0013\u000E\u000D\u001A\u0041\u002B\u002A\u0046\u0001";

    public static string t_real_multiline() => "\u0002\u0002\u0002\u0002\u001F\u0019\u0020\u0017\u0011\u0018\u0002\u0013\u000E\u000F\u000E\u0011\u0018\u0001\u0002\u0002\u0002\u0002\u005A\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u001B\u0014\u0011\u0017\u000D\u0002\u004A\u000E\u0015\u0019\u000D\u004B\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005A\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0015\u000D\u000E\u0019\u0015\u0012\u0001\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u0002\u005B\u0001\u0002\u0002\u0002\u0002\u005B\u0001";

    public static string t_fuzz_a() => "\u000F\u0020\u0018\u0016\u000D\u001C\u0001\u001D\u0014\u0011\u0023\u0022\u0017";

    public static string t_fuzz_b() => "\u0004\u0005\u0006\u0007\u0008\u0009\u0001\u000A\u000B\u000C\u0003\u0004\u0005";

    public static string t_fuzz_c() => "\u004C\u0049\u004D\u004E\u0051\u004F\u0050\u0001\u0058\u0059\u005A\u005B\u004A\u004B";

    public static string t_fuzz_d() => "\u000F\u0020\u0018\u0001\u0016\u000D\u001C\u0001\u001D\u0014\u0011\u0001\u0023\u0022\u0017\u0001\u001A\u0012\u0010";

    public static string t_fuzz_e() => "\u000F\u000F\u000F\u0001\u0041\u0001\u0042\u0001\u0043\u0001\u0044\u0001\u000F\u000F\u000F";

    public static string t_fuzz_f() => "\u0029\u003A\u0032\u0030\u0027\u0036\u0037\u002E\u002B\u003D\u0001\u003C\u0031\u0034\u002C\u002A\u0039\u003F\u002F\u002D\u0028";

    public static string t_fuzz_g() => "\u000E\u0014\u000D\u0002\u0025\u0019\u0011\u0018\u0022\u0002\u0020\u0015\u0010\u001B\u0012\u0001\u001C\u0010\u0024\u0002\u0023\u0019\u001A\u001F\u0013\u0002\u0010\u0021\u000D\u0015\u0001\u000E\u0014\u000D\u0002\u0017\u000F\u0026\u001E\u0002\u0016\u0010\u001D";

    public static string t_fuzz_h() => "\u0003\u0004\u0005\u0006\u0007\u0008\u0009\u000A\u000B\u000C\u0001\u0003\u0004\u0005\u0006\u0007\u0008\u0009\u000A\u000B\u000C\u0001\u0003\u0004\u0005\u0006\u0007\u0008\u0009\u000A\u000B\u000C";

    public static string t_fuzz_i() => "\u004A\u005A\u0058\u004F\u0001\u0050\u0059\u005B\u004B";

    public static string t_fuzz_j() => "\u004C\u004C\u004D\u004D\u0049\u0049\u004E\u004E\u0001\u0051\u0051\u0052\u0052\u0053\u0053\u0054\u0054";
    ...
    public static IRExpr lower_literal(string text, LiteralKind kind) => kind switch { IntLit { } => new IrIntLit(long.Parse(_Cce.ToUnicode(text))), NumLit { } => new IrIntLit(long.Parse(_Cce.ToUnicode(text))), TextLit { } => new IrTextLit(text), CharLit { } => new IrCharLit(long.Parse(_Cce.ToUnicode(text))), BoolLit { } => new IrBoolLit((text == "\u0028\u0015\u0019\u000D")), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static CodexType lowering_resolve_type_expr(ATypeExpr texpr) => texpr switch { ANamedType(var name) => ((name.value == "\u002B\u0012\u000E\u000D\u001D\u000D\u0015") ? new IntegerTy() : ((name.value == "\u002C\u0019\u001A\u0020\u000D\u0015") ? new NumberTy() : ((name.value == "\u0028\u000D\u0024\u000E") ? new TextTy() : ((name.value == "\u003A\u0010\u0010\u0017\u000D\u000F\u0012") ? new BooleanTy() : ((name.value == "\u002C\u0010\u000E\u0014\u0011\u0012\u001D") ? new NothingTy() : new ConstructedTy(name, new List<CodexType>())))))), AFunType(var param, var ret) => new FunTy(lowering_resolve_type_expr(param), lowering_resolve_type_expr(ret)), AAppType(var ctor, var args) => ctor switch { ANamedType(var cname) => ((cname.value == "\u0031\u0011\u0013\u000E") ? ((((long)args.Count) == 1L) ? new ListTy(lowering_resolve_type_expr(args[(int)0L])) : new ListTy(new ErrorTy())) : new ConstructedTy(cname, new List<CodexType>())), _ => new ErrorTy(), }, _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static string mangle_name(string chapter_slug, string def_name) => (slugify(chapter_slug, 0L, "") + ("\u0055" + def_name));
    ...
    public static bool slug_matches_cite(string slug, string cite_name) => (strip_hyphens(slugify(slug, 0L, ""), 0L, "") == strip_hyphens(slugify(cite_name, 0L, ""), 0L, ""));
    ...
    public static CollectResult collect_top_level_names(List<ADef> defs, long i, long len, List<string> acc, List<Diagnostic> errs)
    {
        while (true)
        {
            ...
            var _tco_2 = len;
            var _tco_3 = acc;
            var _tco_4 = Enumerable.Concat(errs, new List<Diagnostic> { make_error("\u0032\u0030\u003E\u0006\u0003\u0003\u0004", ("\u0030\u0019\u001F\u0017\u0011\u0018\u000F\u000E\u000D\u0002\u0016\u000D\u001C\u0011\u0012\u0011\u000E\u0011\u0010\u0012\u0045\u0002" + name)) }).ToList();
            defs = _tco_0;
            i = _tco_1;
            len = _tco_2;
            acc = _tco_3;
    ...
    public static List<Diagnostic> resolve_expr(Scope sc, AExpr expr)
    {
        while (true)
        {
            ...
            {
            return new List<Diagnostic> { make_error("\u0032\u0030\u003E\u0006\u0003\u0003\u0005", ("\u0033\u0012\u0016\u000D\u001C\u0011\u0012\u000D\u0016\u0002\u0012\u000F\u001A\u000D\u0045\u0002" + name.value)) };
            }
            }
    ...
    public static UnifyResult unify_resolved(UnificationState st, CodexType a, CodexType b) => (types_equal(a, b) ? new UnifyResult(success: true, state: st) : a switch { TypeVar(var id_a) => (occurs_in(st, id_a, b) ? new UnifyResult(success: false, state: add_unify_error(st, "\u0032\u0030\u003E\u0005\u0003\u0004\u0003", "\u002B\u0012\u001C\u0011\u0012\u0011\u000E\u000D\u0002\u000E\u001E\u001F\u000D")) : new UnifyResult(success: true, state: add_subst(st, id_a, b))), _ => unify_rhs(st, a, b), });
    ...
    public static UnifyResult unify_rhs(UnificationState st, CodexType a, CodexType b) => b switch { TypeVar(var id_b) => (occurs_in(st, id_b, a) ? new UnifyResult(success: false, state: add_unify_error(st, "\u0032\u0030\u003E\u0005\u0003\u0004\u0003", "\u002B\u0012\u001C\u0011\u0012\u0011\u000E\u000D\u0002\u000E\u001E\u001F\u000D")) : new UnifyResult(success: true, state: add_subst(st, id_b, a))), _ => unify_structural(st, a, b), };
    ...
    public static UnifyResult unify_mismatch(UnificationState st, CodexType a, CodexType b) => new UnifyResult(success: false, state: add_unify_error(st, "\u0032\u0030\u003E\u0005\u0003\u0003\u0004", ("\u0028\u001E\u001F\u000D\u0002\u001A\u0011\u0013\u001A\u000F\u000E\u0018\u0014\u0045\u0002" + (type_tag(a) + ("\u0002\u0021\u0013\u0002" + type_tag(b))))));

    public static string type_tag(CodexType ty) => ty switch { IntegerTy { } => "\u002B\u0012\u000E\u000D\u001D\u000D\u0015", NumberTy { } => "\u002C\u0019\u001A\u0020\u000D\u0015", TextTy { } => "\u0028\u000D\u0024\u000E", BooleanTy { } => "\u003A\u0010\u0010\u0017\u000D\u000F\u0012", CharTy { } => "\u0032\u0014\u000F\u0015", VoidTy { } => "\u003B\u0010\u0011\u0016", NothingTy { } => "\u002C\u0010\u000E\u0014\u0011\u0012\u001D", ErrorTy { } => "\u0027\u0015\u0015\u0010\u0015", FunTy(var p, var r) => "\u0036\u0019\u0012", ListTy(var e) => "\u0031\u0011\u0013\u000E", TypeVar(var id) => ("\u0028" + _Cce.FromUnicode(id.ToString())), ForAllTy(var id, var body) => "\u0036\u0010\u0015\u0029\u0017\u0017", SumTy(var name, var ctors) => ("\u002D\u0019\u001A\u0045" + name.value), RecordTy(var name, var fields) => ("\u002F\u000D\u0018\u0045" + name.value), ConstructedTy(var name, var args) => ("\u0032\u0010\u0012\u0045" + name.value), _ => throw new InvalidOperationException("Non-exhaustive match"), };
    ...
    public static object emit_defs_streaming(List<Token> tokens, List<DefHeader> headers, List<TypeBinding> all_types, UnificationState ust, List<string> ctor_names, long i, long len)
    {
        while (true)
        {
            ...
            {
            return ((Func<object>)(() => { Console.WriteLine(_Cce.ToUnicode(("\u0032\u002A\u0034\u0039\u002B\u0031\u0027\u0049\u0027\u002F\u002F\u002A\u002F\u0045\u0002\u0016\u000D\u001C\u0002\u0047" + (ir_def.name + ("\u0047\u0002\u0014\u000F\u0013\u0002\u000D\u0015\u0015\u0010\u0015\u0002\u0020\u0010\u0016\u001E\u0045\u0002" + error_message(ir_def.body)))))); return null; }))();
            }
            else
            {
    ...
    public static object main() => ((Func<object>)(() => { var path = _Cce.FromUnicode(Console.ReadLine() ?? ""); var source = _Cce.FromUnicode(File.ReadAllText(_Cce.ToUnicode(path))); ((Func<string, object>)((clean) => compile_streaming_v2(clean, "\u0039\u0015\u0010\u001D\u0015\u000F\u001A")))(normalize_whitespace(source));  return null; }))();
