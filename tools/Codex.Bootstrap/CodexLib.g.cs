                    ...
                    if (((i + 1L) < len))
                    {
                        ...
                        else
                        {
                            if ((nc == cc_lower_t()))
                            {
                                ...
                                var _tco_1 = (i + 2L);
                                var _tco_2 = len;
                                var _tco_3 = string.Concat(acc, ((char)68L).ToString());
                                s = _tco_0;
                                i = _tco_1;
                                len = _tco_2;
                                acc = _tco_3;
