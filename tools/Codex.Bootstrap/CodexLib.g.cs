...
public static class Codex_Codex_Codex
{
    ...
    {
        return ((Func<List<IRDef>, string>)((real_defs) => codex_emit_def_list(real_defs, ctor_names, 0L)))(codex_filter_defs(defs, ctor_names, 0L, ((long)defs.Count), new List<IRDef>()));
    }
