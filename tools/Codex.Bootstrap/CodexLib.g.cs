...
public sealed record IrRegion(IRExpr Field0, CodexType Field1, bool Field2) : IRExpr;
...
public static class Codex_Codex_Codex
{
    ...
    {
        return (skip_def(d, ctor_names) ? "" : string.Concat(d.name, "\u0002E\u0002", emit_type(d.type_val), "\u0001", d.name, codex_emitter_emit_def_params(d.@params, 0L), "\u0002M\u0001\u0002\u0002", codex_emitter_emit_expr(d.body, ctor_names, 1L), "\u0001"));
    }

    public static bool skip_def(IRDef d, List<string> ctor_names)
    {
        return (ctor_names.Contains(d.name) ? true : ((((long)d.name.Length) == 0L) ? true : ((Func<long, bool>)((first) => ((Func<long, bool>)((code_a) => ((Func<long, bool>)((code_z) => (((first < code_a) || (first > code_z)) ? true : (is_error_body(d.body) ? true : false))))(((long)"&"[(int)0L]))))(((long)"\u000F"[(int)0L]))))(((long)d.name[(int)0L]))));
    }
    ...
    {
        return ((Func<IRDoStmt, string>)((_scrutinee36_) => (_scrutinee36_ is IrDoBind _mIrDoBind36_ ? ((Func<IRExpr, string>)((val) => ((Func<CodexType, string>)((ty) => ((Func<string, string>)((name) => string.Concat(name, "\u0002OI\u0002", codex_emitter_emit_expr(val, ctors, indent))))((string)_mIrDoBind36_.Field0)))((CodexType)_mIrDoBind36_.Field1)))((IRExpr)_mIrDoBind36_.Field2) : (_scrutinee36_ is IrDoExec _mIrDoExec36_ ? ((Func<IRExpr, string>)((e) => codex_emitter_emit_expr(e, ctors, indent)))((IRExpr)_mIrDoExec36_.Field0) : throw new InvalidOperationException("Non-exhaustive match")))))(s);
    }
    ...
    {
        return ((Func<IRExpr, EmitResult>)((_scrutinee41_) => (_scrutinee41_ is IrIntLit _mIrIntLit41_ ? ((Func<long, EmitResult>)((value) => emit_int_lit(st, value)))((long)_mIrIntLit41_.Field0) : (_scrutinee41_ is IrBoolLit _mIrBoolLit41_ ? ((Func<bool, EmitResult>)((value) => emit_int_lit(st, (value ? 1L : 0L))))((bool)_mIrBoolLit41_.Field0) : (_scrutinee41_ is IrName _mIrName41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<string, EmitResult>)((name) => emit_name(st, name, ty)))((string)_mIrName41_.Field0)))((CodexType)_mIrName41_.Field1) : (_scrutinee41_ is IrLet _mIrLet41_ ? ((Func<IRExpr, EmitResult>)((body) => ((Func<IRExpr, EmitResult>)((value) => ((Func<CodexType, EmitResult>)((ty) => ((Func<string, EmitResult>)((name) => x86_64_emit_let(st, name, value, body)))((string)_mIrLet41_.Field0)))((CodexType)_mIrLet41_.Field1)))((IRExpr)_mIrLet41_.Field2)))((IRExpr)_mIrLet41_.Field3) : (_scrutinee41_ is IrBinary _mIrBinary41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<IRExpr, EmitResult>)((right) => ((Func<IRExpr, EmitResult>)((left) => ((Func<IRBinaryOp, EmitResult>)((op) => x86_64_emit_binary(st, op, left, right)))((IRBinaryOp)_mIrBinary41_.Field0)))((IRExpr)_mIrBinary41_.Field1)))((IRExpr)_mIrBinary41_.Field2)))((CodexType)_mIrBinary41_.Field3) : (_scrutinee41_ is IrIf _mIrIf41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<IRExpr, EmitResult>)((else_e) => ((Func<IRExpr, EmitResult>)((then_e) => ((Func<IRExpr, EmitResult>)((cond) => x86_64_emit_if(st, cond, then_e, else_e)))((IRExpr)_mIrIf41_.Field0)))((IRExpr)_mIrIf41_.Field1)))((IRExpr)_mIrIf41_.Field2)))((CodexType)_mIrIf41_.Field3) : (_scrutinee41_ is IrApply _mIrApply41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<IRExpr, EmitResult>)((arg) => ((Func<IRExpr, EmitResult>)((func) => x86_64_emit_apply(st, func, arg, ty)))((IRExpr)_mIrApply41_.Field0)))((IRExpr)_mIrApply41_.Field1)))((CodexType)_mIrApply41_.Field2) : (_scrutinee41_ is IrRecord _mIrRecord41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<List<IRFieldVal>, EmitResult>)((fields) => ((Func<string, EmitResult>)((rname) => x86_64_emit_record(st, fields, ty)))((string)_mIrRecord41_.Field0)))((List<IRFieldVal>)_mIrRecord41_.Field1)))((CodexType)_mIrRecord41_.Field2) : (_scrutinee41_ is IrFieldAccess _mIrFieldAccess41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<string, EmitResult>)((field) => ((Func<IRExpr, EmitResult>)((rec) => x86_64_emit_field_access(st, rec, field)))((IRExpr)_mIrFieldAccess41_.Field0)))((string)_mIrFieldAccess41_.Field1)))((CodexType)_mIrFieldAccess41_.Field2) : (_scrutinee41_ is IrMatch _mIrMatch41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<List<IRBranch>, EmitResult>)((branches) => ((Func<IRExpr, EmitResult>)((scrut) => x86_64_emit_match(st, scrut, branches)))((IRExpr)_mIrMatch41_.Field0)))((List<IRBranch>)_mIrMatch41_.Field1)))((CodexType)_mIrMatch41_.Field2) : (_scrutinee41_ is IrList _mIrList41_ ? ((Func<CodexType, EmitResult>)((ty) => ((Func<List<IRExpr>, EmitResult>)((elems) => x86_64_emit_list(st, elems)))((List<IRExpr>)_mIrList41_.Field0)))((CodexType)_mIrList41_.Field1) : ((Func<IRExpr, EmitResult>)((_) => new EmitResult(st, reg_rax())))(_scrutinee41_))))))))))))))(expr);
    }
    ...
    {
        return ((Func<CodexType, EmitResult>)((_scrutinee42_) => (_scrutinee42_ is SumTy _mSumTy42_ ? ((Func<List<SumCtor>, EmitResult>)((ctors) => ((Func<Name, EmitResult>)((sname) => ((Func<long, EmitResult>)((tag) => ((tag >= 0L) ? emit_nullary_ctor(st, tag) : emit_name_as_call(st, name))))(find_ctor_tag(ctors, name, 0L))))((Name)_mSumTy42_.Field0)))((List<SumCtor>)_mSumTy42_.Field1) : (_scrutinee42_ is FunTy _mFunTy42_ ? ((Func<CodexType, EmitResult>)((rt) => ((Func<CodexType, EmitResult>)((pt) => emit_partial_application(st, name, new List<IRExpr>())))((CodexType)_mFunTy42_.Field0)))((CodexType)_mFunTy42_.Field1) : ((Func<CodexType, EmitResult>)((_) => emit_name_as_call(st, name)))(_scrutinee42_)))))(ty);
    }
    ...
    {
        return ((Func<EmitResult, EmitResult>)((rd) => ((Func<IRBinaryOp, EmitResult>)((_scrutinee43_) => (_scrutinee43_ is IrAddInt _mIrAddInt43_ ? new EmitResult(st_append_text(rd.state, Enumerable.Concat(mov_rr(rd.reg, l_reg), add_rr(rd.reg, r_reg)).ToList()), rd.reg) : (_scrutinee43_ is IrSubInt _mIrSubInt43_ ? new EmitResult(st_append_text(rd.state, Enumerable.Concat(mov_rr(rd.reg, l_reg), sub_rr(rd.reg, r_reg)).ToList()), rd.reg) : (_scrutinee43_ is IrMulInt _mIrMulInt43_ ? new EmitResult(st_append_text(rd.state, Enumerable.Concat(mov_rr(rd.reg, l_reg), imul_rr(rd.reg, r_reg)).ToList()), rd.reg) : (_scrutinee43_ is IrDivInt _mIrDivInt43_ ? new EmitResult(st_append_text(rd.state, Enumerable.Concat(mov_rr(reg_rax(), l_reg), Enumerable.Concat(cqo(), Enumerable.Concat(idiv_r(r_reg), mov_rr(rd.reg, reg_rax())).ToList()).ToList()).ToList()), rd.reg) : (_scrutinee43_ is IrEq _mIrEq43_ ? emit_comparison(st, cc_e(), l_reg, r_reg) : (_scrutinee43_ is IrNotEq _mIrNotEq43_ ? emit_comparison(st, cc_ne(), l_reg, r_reg) : (_scrutinee43_ is IrLt _mIrLt43_ ? emit_comparison(st, cc_l(), l_reg, r_reg) : (_scrutinee43_ is IrGt _mIrGt43_ ? emit_comparison(st, cc_g(), l_reg, r_reg) : (_scrutinee43_ is IrLtEq _mIrLtEq43_ ? emit_comparison(st, cc_le(), l_reg, r_reg) : (_scrutinee43_ is IrGtEq _mIrGtEq43_ ? emit_comparison(st, cc_ge(), l_reg, r_reg) : (_scrutinee43_ is IrAnd _mIrAnd43_ ? new EmitResult(st_append_text(rd.state, Enumerable.Concat(mov_rr(rd.reg, l_reg), and_rr(rd.reg, r_reg)).ToList()), rd.reg) : (_scrutinee43_ is IrOr _mIrOr43_ ? new EmitResult(st_append_text(rd.state, Enumerable.Concat(mov_rr(rd.reg, l_reg), add_rr(rd.reg, r_reg)).ToList()), rd.reg) : ((Func<IRBinaryOp, EmitResult>)((_) => new EmitResult(st, reg_rax())))(_scrutinee43_)))))))))))))))(op)))(alloc_temp(st));
    }
    ...
    {
        return ((Func<EvalFieldsResult, EmitResult>)((evaled) => ((Func<long, EmitResult>)((field_count) => ((Func<long, EmitResult>)((total_size) => ((Func<EmitResult, EmitResult>)((ptr_loc) => ((Func<EmitResult, EmitResult>)((ptr_tmp) => ((Func<CodegenState, EmitResult>)((st1) => ((Func<CodegenState, EmitResult>)((st2) => ((Func<CodegenState, EmitResult>)((st3) => ((Func<CodegenState, EmitResult>)((st4) => load_local(st4, ptr_loc.reg)))((ty is RecordTy _mRecordTy45_ ? ((Func<List<RecordField>, CodegenState>)((type_fields) => ((Func<Name, CodegenState>)((rname) => emit_store_record_fields_by_type(st3, type_fields, evaled.field_locals, ptr_loc.reg, 0L)))((Name)_mRecordTy45_.Field0)))((List<RecordField>)_mRecordTy45_.Field1) : ((Func<CodexType, CodegenState>)((_) => emit_store_record_fields_by_list(st3, evaled.field_locals, ptr_loc.reg, 0L)))(ty)))))(st_append_text(st2, add_ri(reg_r10(), total_size)))))(store_local(st1, ptr_loc.reg, ptr_tmp.reg))))(st_append_text(ptr_tmp.state, mov_rr(ptr_tmp.reg, reg_r10())))))(alloc_temp(ptr_loc.state))))(alloc_local(evaled.state))))((field_count * 8L))))(((long)fields.Count))))(emit_eval_record_fields(st, fields, 0L, new List<FieldLocal>()));
    }

    public static EmitResult x86_64_emit_field_access(CodegenState st, IRExpr rec_expr, string field_name)
    {
        return ((Func<CodexType, EmitResult>)((rec_ty) => ((Func<long, EmitResult>)((field_idx) => ((Func<EmitResult, EmitResult>)((rec_result) => ((Func<EmitResult, EmitResult>)((rd) => new EmitResult(st_append_text(rd.state, mov_load(rd.reg, rec_result.reg, (field_idx * 8L))), rd.reg)))(alloc_temp(rec_result.state))))(x86_64_emit_expr(st, rec_expr))))((rec_ty is RecordTy _mRecordTy46_ ? ((Func<List<RecordField>, long>)((rfields) => ((Func<Name, long>)((rname) => find_record_field_index(rfields, field_name, 0L)))((Name)_mRecordTy46_.Field0)))((List<RecordField>)_mRecordTy46_.Field1) : ((Func<CodexType, long>)((_) => 0L))(rec_ty)))))(ir_expr_type(rec_expr));
    }
    ...
    {
        return ((Func<IRPat, EmitPatternResult>)((_scrutinee47_) => (_scrutinee47_ is IrWildPat _mIrWildPat47_ ? new EmitPatternResult(st, (0L - 1L)) : (_scrutinee47_ is IrVarPat _mIrVarPat47_ ? ((Func<CodexType, EmitPatternResult>)((ty) => ((Func<string, EmitPatternResult>)((name) => ((Func<EmitResult, EmitPatternResult>)((var_loc) => ((Func<EmitResult, EmitPatternResult>)((loaded) => ((Func<CodegenState, EmitPatternResult>)((st1) => new EmitPatternResult(add_local(st1, name, var_loc.reg), (0L - 1L))))(store_local(loaded.state, var_loc.reg, loaded.reg))))(load_local(var_loc.state, scrut_loc))))(alloc_local(st))))((string)_mIrVarPat47_.Field0)))((CodexType)_mIrVarPat47_.Field1) : (_scrutinee47_ is IrCtorPat _mIrCtorPat47_ ? ((Func<CodexType, EmitPatternResult>)((ty) => ((Func<List<IRPat>, EmitPatternResult>)((sub_pats) => ((Func<string, EmitPatternResult>)((name) => ((Func<EmitResult, EmitPatternResult>)((scrut_load) => ((Func<EmitResult, EmitPatternResult>)((tag_reg) => ((Func<CodegenState, EmitPatternResult>)((st1) => ((Func<long, EmitPatternResult>)((expected_tag) => ((Func<CodegenState, EmitPatternResult>)((st2) => ((Func<long, EmitPatternResult>)((jcc_pos) => ((Func<CodegenState, EmitPatternResult>)((st3) => ((Func<CodegenState, EmitPatternResult>)((st4) => new EmitPatternResult(st4, jcc_pos)))(bind_ctor_fields(st3, scrut_loc, sub_pats, 0L))))(st_append_text(st2, jcc(cc_ne(), 0L)))))(((long)st2.text.Count))))(st_append_text(st1, cmp_ri(tag_reg.reg, expected_tag)))))((ty is SumTy _mSumTy48_ ? ((Func<List<SumCtor>, long>)((ctors) => ((Func<Name, long>)((sname) => find_ctor_tag(ctors, name, 0L)))((Name)_mSumTy48_.Field0)))((List<SumCtor>)_mSumTy48_.Field1) : ((Func<CodexType, long>)((_) => 0L))(ty)))))(st_append_text(tag_reg.state, mov_load(tag_reg.reg, scrut_load.reg, 0L)))))(alloc_temp(scrut_load.state))))(load_local(st, scrut_loc))))((string)_mIrCtorPat47_.Field0)))((List<IRPat>)_mIrCtorPat47_.Field1)))((CodexType)_mIrCtorPat47_.Field2) : (_scrutinee47_ is IrLitPat _mIrLitPat47_ ? ((Func<CodexType, EmitPatternResult>)((ty) => ((Func<string, EmitPatternResult>)((value) => new EmitPatternResult(st, (0L - 1L))))((string)_mIrLitPat47_.Field0)))((CodexType)_mIrLitPat47_.Field1) : throw new InvalidOperationException("Non-exhaustive match")))))))(pat);
    }
    ...
    {
        return ((Func<AExpr, IRExpr>)((_scrutinee49_) => (_scrutinee49_ is ALitExpr _mALitExpr49_ ? ((Func<LiteralKind, IRExpr>)((kind) => ((Func<string, IRExpr>)((text) => lower_literal(text, kind)))((string)_mALitExpr49_.Field0)))((LiteralKind)_mALitExpr49_.Field1) : (_scrutinee49_ is ANameExpr _mANameExpr49_ ? ((Func<Name, IRExpr>)((name) => lower_name(name.value, ty, ctx)))((Name)_mANameExpr49_.Field0) : (_scrutinee49_ is AApplyExpr _mAApplyExpr49_ ? ((Func<AExpr, IRExpr>)((a) => ((Func<AExpr, IRExpr>)((f) => lower_apply(f, a, ty, ctx)))((AExpr)_mAApplyExpr49_.Field0)))((AExpr)_mAApplyExpr49_.Field1) : (_scrutinee49_ is ABinaryExpr _mABinaryExpr49_ ? ((Func<AExpr, IRExpr>)((r) => ((Func<BinaryOp, IRExpr>)((op) => ((Func<AExpr, IRExpr>)((l) => ((Func<IRExpr, IRExpr>)((left_ir) => ((Func<CodexType, IRExpr>)((left_ty) => ((Func<IRExpr, IRExpr>)((right_ir) => new IrBinary(lower_bin_op(op, left_ty), left_ir, right_ir, binary_result_type(op, left_ty, ty))))(lower_expr(r, ty, ctx))))(ir_expr_type(left_ir))))(lower_expr(l, ty, ctx))))((AExpr)_mABinaryExpr49_.Field0)))((BinaryOp)_mABinaryExpr49_.Field1)))((AExpr)_mABinaryExpr49_.Field2) : (_scrutinee49_ is AUnaryExpr _mAUnaryExpr49_ ? ((Func<AExpr, IRExpr>)((operand) => new IrNegate(lower_expr(operand, new IntegerTy(), ctx))))((AExpr)_mAUnaryExpr49_.Field0) : (_scrutinee49_ is AIfExpr _mAIfExpr49_ ? ((Func<AExpr, IRExpr>)((e2) => ((Func<AExpr, IRExpr>)((t) => ((Func<AExpr, IRExpr>)((c) => ((Func<CodexType, IRExpr>)((resolved) => ((Func<IRExpr, IRExpr>)((then_ir) => ((Func<CodexType, IRExpr>)((then_ty) => ((Func<CodexType, IRExpr>)((result_ty) => ((Func<IRExpr, IRExpr>)((else_ir) => new IrIf(lower_expr(c, new BooleanTy(), ctx), then_ir, else_ir, result_ty)))(lower_expr(e2, result_ty, ctx))))((resolved is ErrorTy _mErrorTy50_ ? then_ty : ((Func<CodexType, CodexType>)((_) => resolved))(resolved)))))(ir_expr_type(then_ir))))(lower_expr(t, resolved, ctx))))(deep_resolve(ctx.ust, ty))))((AExpr)_mAIfExpr49_.Field0)))((AExpr)_mAIfExpr49_.Field1)))((AExpr)_mAIfExpr49_.Field2) : (_scrutinee49_ is ALetExpr _mALetExpr49_ ? ((Func<AExpr, IRExpr>)((body) => ((Func<List<ALetBind>, IRExpr>)((binds) => lower_let(binds, body, ty, ctx)))((List<ALetBind>)_mALetExpr49_.Field0)))((AExpr)_mALetExpr49_.Field1) : (_scrutinee49_ is ALambdaExpr _mALambdaExpr49_ ? ((Func<AExpr, IRExpr>)((body) => ((Func<List<Name>, IRExpr>)((@params) => lower_lambda(@params, body, ty, ctx)))((List<Name>)_mALambdaExpr49_.Field0)))((AExpr)_mALambdaExpr49_.Field1) : (_scrutinee49_ is AMatchExpr _mAMatchExpr49_ ? ((Func<List<AMatchArm>, IRExpr>)((arms) => ((Func<AExpr, IRExpr>)((scrut) => lower_match(scrut, arms, ty, ctx)))((AExpr)_mAMatchExpr49_.Field0)))((List<AMatchArm>)_mAMatchExpr49_.Field1) : (_scrutinee49_ is AListExpr _mAListExpr49_ ? ((Func<List<AExpr>, IRExpr>)((elems) => lower_list(elems, ty, ctx)))((List<AExpr>)_mAListExpr49_.Field0) : (_scrutinee49_ is ARecordExpr _mARecordExpr49_ ? ((Func<List<AFieldExpr>, IRExpr>)((fields) => ((Func<Name, IRExpr>)((name) => lower_record(name, fields, ty, ctx)))((Name)_mARecordExpr49_.Field0)))((List<AFieldExpr>)_mARecordExpr49_.Field1) : (_scrutinee49_ is AFieldAccess _mAFieldAccess49_ ? ((Func<Name, IRExpr>)((field) => ((Func<AExpr, IRExpr>)((rec) => ((Func<IRExpr, IRExpr>)((rec_ir) => ((Func<CodexType, IRExpr>)((rec_ty) => ((Func<CodexType, IRExpr>)((field_ty) => ((Func<CodexType, IRExpr>)((actual_field_ty) => new IrFieldAccess(rec_ir, field.value, actual_field_ty)))((field_ty is ErrorTy _mErrorTy51_ ? ty : ((Func<CodexType, CodexType>)((_) => field_ty))(field_ty)))))(((Func<CodexType, CodexType>)((_scrutinee52_) => (_scrutinee52_ is RecordTy _mRecordTy52_ ? ((Func<List<RecordField>, CodexType>)((rfields) => ((Func<Name, CodexType>)((rname) => lookup_record_field(rfields, field.value)))((Name)_mRecordTy52_.Field0)))((List<RecordField>)_mRecordTy52_.Field1) : (_scrutinee52_ is ConstructedTy _mConstructedTy52_ ? ((Func<List<CodexType>, CodexType>)((cargs) => ((Func<Name, CodexType>)((cname) => ((Func<CodexType, CodexType>)((ctor_raw) => ((Func<CodexType, CodexType>)((resolved_record) => (resolved_record is RecordTy _mRecordTy53_ ? ((Func<List<RecordField>, CodexType>)((rf) => ((Func<Name, CodexType>)((rn) => lookup_record_field(rf, field.value)))((Name)_mRecordTy53_.Field0)))((List<RecordField>)_mRecordTy53_.Field1) : ((Func<CodexType, CodexType>)((_) => ty))(resolved_record))))((ctor_raw is ErrorTy _mErrorTy54_ ? new ErrorTy() : ((Func<CodexType, CodexType>)((_) => strip_fun_args_lower(deep_resolve(ctx.ust, ctor_raw))))(ctor_raw)))))(lookup_type(ctx.types, cname.value))))((Name)_mConstructedTy52_.Field0)))((List<CodexType>)_mConstructedTy52_.Field1) : ((Func<CodexType, CodexType>)((_) => ty))(_scrutinee52_)))))(rec_ty))))(deep_resolve(ctx.ust, ir_expr_type(rec_ir)))))(lower_expr(rec, new ErrorTy(), ctx))))((AExpr)_mAFieldAccess49_.Field0)))((Name)_mAFieldAccess49_.Field1) : (_scrutinee49_ is ADoExpr _mADoExpr49_ ? ((Func<List<ADoStmt>, IRExpr>)((stmts) => lower_do(stmts, ty, ctx)))((List<ADoStmt>)_mADoExpr49_.Field0) : (_scrutinee49_ is AHandleExpr _mAHandleExpr49_ ? ((Func<List<AHandleClause>, IRExpr>)((clauses) => ((Func<AExpr, IRExpr>)((body) => ((Func<Name, IRExpr>)((eff) => lower_handle(eff, body, clauses, ty, ctx)))((Name)_mAHandleExpr49_.Field0)))((AExpr)_mAHandleExpr49_.Field1)))((List<AHandleClause>)_mAHandleExpr49_.Field2) : (_scrutinee49_ is AErrorExpr _mAErrorExpr49_ ? ((Func<string, IRExpr>)((msg) => new IrError(msg, ty)))((string)_mAErrorExpr49_.Field0) : throw new InvalidOperationException("Non-exhaustive match"))))))))))))))))))(e);
    }

    public static IRExpr lower_name(string name, CodexType ty, LowerCtx ctx)
    {
        return ((Func<CodexType, IRExpr>)((raw) => (raw is ErrorTy _mErrorTy55_ ? new IrName(name, ty) : ((Func<CodexType, IRExpr>)((_) => ((Func<CodexType, IRExpr>)((resolved) => ((Func<CodexType, IRExpr>)((stripped) => new IrName(name, stripped)))(strip_forall_ty(resolved))))(deep_resolve(ctx.ust, raw))))(raw))))(lookup_type(ctx.types, name));
    }

    public static IRExpr lower_literal(string text, LiteralKind kind)
    {
        return ((Func<LiteralKind, IRExpr>)((_scrutinee56_) => (_scrutinee56_ is IntLit _mIntLit56_ ? new IrIntLit(long.Parse(_Cce.ToUnicode(text))) : (_scrutinee56_ is NumLit _mNumLit56_ ? new IrIntLit(long.Parse(_Cce.ToUnicode(text))) : (_scrutinee56_ is TextLit _mTextLit56_ ? new IrTextLit(text) : (_scrutinee56_ is CharLit _mCharLit56_ ? new IrCharLit(long.Parse(_Cce.ToUnicode(text))) : (_scrutinee56_ is BoolLit _mBoolLit56_ ? new IrBoolLit((text == "(\u0015\u0019\u000D")) : throw new InvalidOperationException("Non-exhaustive match"))))))))(kind);
    }

    public static IRExpr lower_apply(AExpr f, AExpr a, CodexType ty, LowerCtx ctx)
    {
        return ((Func<IRExpr, IRExpr>)((func_ir) => ((Func<CodexType, IRExpr>)((func_ty) => ((Func<CodexType, IRExpr>)((arg_ty) => ((Func<CodexType, IRExpr>)((ret_ty) => ((Func<IRExpr, IRExpr>)((arg_ir) => ((Func<CodexType, IRExpr>)((resolved_ret) => ((Func<CodexType, IRExpr>)((actual_ret) => lower_apply_dispatch(func_ir, arg_ir, actual_ret)))((resolved_ret is ErrorTy _mErrorTy57_ ? ty : ((Func<CodexType, CodexType>)((_) => resolved_ret))(resolved_ret)))))(subst_type_vars_from_arg(arg_ty, ir_expr_type(arg_ir), ret_ty))))(lower_expr(a, arg_ty, ctx))))(peel_fun_return(func_ty))))(peel_fun_param(func_ty))))(deep_resolve(ctx.ust, ir_expr_type(func_ir)))))(lower_expr(f, new ErrorTy(), ctx));
    }

    public static IRExpr lower_apply_dispatch(IRExpr func_ir, IRExpr arg_ir, CodexType ret_ty)
    {
        return (func_ir is IrName _mIrName58_ ? ((Func<CodexType, IRExpr>)((fty) => ((Func<string, IRExpr>)((n) => ((n == "\u001C\u0010\u0015\"") ? new IrFork(arg_ir, ret_ty) : ((n == "\u000F\u001B\u000F\u0011\u000E") ? new IrAwait(arg_ir, ret_ty) : new IrApply(func_ir, arg_ir, ret_ty)))))((string)_mIrName58_.Field0)))((CodexType)_mIrName58_.Field1) : ((Func<IRExpr, IRExpr>)((_) => new IrApply(func_ir, arg_ir, ret_ty)))(func_ir));
    }
    ...
    {
        return ((Func<IRExpr, IRExpr>)((scrut_ir) => ((Func<CodexType, IRExpr>)((scrut_ty) => ((Func<List<IRBranch>, IRExpr>)((branches) => ((Func<CodexType, IRExpr>)((result_ty) => new IrMatch(scrut_ir, branches, result_ty)))((ty is ErrorTy _mErrorTy59_ ? infer_match_type(branches, 0L, ((long)branches.Count)) : ((Func<CodexType, CodexType>)((_) => ty))(ty)))))(lower_match_arms_loop(arms, ty, scrut_ty, ctx, 0L, ((long)arms.Count)))))(ir_expr_type(scrut_ir))))(lower_expr(scrut, new ErrorTy(), ctx));
    }
    ...
    {
        return ((Func<APat, LowerCtx>)((_scrutinee60_) => (_scrutinee60_ is AVarPat _mAVarPat60_ ? ((Func<Name, LowerCtx>)((name) => new LowerCtx(Enumerable.Concat(new List<TypeBinding>() { new TypeBinding(name.value, ty) }, ctx.types).ToList(), ctx.ust)))((Name)_mAVarPat60_.Field0) : (_scrutinee60_ is ACtorPat _mACtorPat60_ ? ((Func<List<APat>, LowerCtx>)((sub_pats) => ((Func<Name, LowerCtx>)((ctor_name) => ((Func<CodexType, LowerCtx>)((ctor_raw) => ((Func<CodexType, LowerCtx>)((ctor_ty) => ((Func<CodexType, LowerCtx>)((ctor_stripped) => bind_ctor_pattern_fields(ctx, sub_pats, ctor_stripped, 0L, ((long)sub_pats.Count))))(strip_forall_ty(ctor_ty))))(deep_resolve(ctx.ust, ctor_raw))))(lookup_type(ctx.types, ctor_name.value))))((Name)_mACtorPat60_.Field0)))((List<APat>)_mACtorPat60_.Field1) : (_scrutinee60_ is AWildPat _mAWildPat60_ ? ctx : (_scrutinee60_ is ALitPat _mALitPat60_ ? ((Func<LiteralKind, LowerCtx>)((kind) => ((Func<string, LowerCtx>)((text) => ctx))((string)_mALitPat60_.Field0)))((LiteralKind)_mALitPat60_.Field1) : throw new InvalidOperationException("Non-exhaustive match")))))))(pat);
    }
    ...
    {
        return ((Func<APat, IRPat>)((_scrutinee61_) => (_scrutinee61_ is AVarPat _mAVarPat61_ ? ((Func<Name, IRPat>)((name) => new IrVarPat(name.value, new ErrorTy())))((Name)_mAVarPat61_.Field0) : (_scrutinee61_ is ALitPat _mALitPat61_ ? ((Func<LiteralKind, IRPat>)((kind) => ((Func<string, IRPat>)((text) => new IrLitPat(text, new ErrorTy())))((string)_mALitPat61_.Field0)))((LiteralKind)_mALitPat61_.Field1) : (_scrutinee61_ is ACtorPat _mACtorPat61_ ? ((Func<List<APat>, IRPat>)((subs) => ((Func<Name, IRPat>)((name) => new IrCtorPat(name.value, map_list(new Func<APat, IRPat>(lower_pattern), subs), new ErrorTy())))((Name)_mACtorPat61_.Field0)))((List<APat>)_mACtorPat61_.Field1) : (_scrutinee61_ is AWildPat _mAWildPat61_ ? new IrWildPat() : throw new InvalidOperationException("Non-exhaustive match")))))))(p);
    }

    public static IRExpr lower_list(List<AExpr> elems, CodexType ty, LowerCtx ctx)
    {
        return ((Func<CodexType, IRExpr>)((resolved) => ((Func<CodexType, IRExpr>)((elem_ty) => new IrList(lower_list_elems_loop(elems, elem_ty, ctx, 0L, ((long)elems.Count)), elem_ty)))((resolved is ListTy _mListTy62_ ? ((Func<CodexType, CodexType>)((e) => e))((CodexType)_mListTy62_.Field0) : ((Func<CodexType, CodexType>)((_) => ((((long)elems.Count) == 0L) ? new ErrorTy() : ir_expr_type(lower_expr(elems[(int)0L], new ErrorTy(), ctx)))))(resolved)))))(deep_resolve(ctx.ust, ty));
    }
    ...
    {
        return ((Func<CodexType, IRExpr>)((ctor_raw) => ((Func<CodexType, IRExpr>)((record_ty) => ((Func<CodexType, IRExpr>)((actual_ty) => new IrRecord(name.value, lower_record_fields_typed(fields, actual_ty, ctx, 0L, ((long)fields.Count)), actual_ty)))((record_ty is ErrorTy _mErrorTy63_ ? ty : ((Func<CodexType, CodexType>)((_) => record_ty))(record_ty)))))((ctor_raw is ErrorTy _mErrorTy64_ ? ty : ((Func<CodexType, CodexType>)((_) => strip_fun_args_lower(deep_resolve(ctx.ust, ctor_raw))))(ctor_raw)))))(lookup_type(ctx.types, name.value));
    }
    ...
    public static List<IRFieldVal> lower_record_fields_acc(List<AFieldExpr> fields, CodexType record_ty, LowerCtx ctx, long i, long len, List<IRFieldVal> acc)
    {
        while (true)
        {
            ...
            {
                var f = fields[(int)i];
                var field_expected = (record_ty is RecordTy _mRecordTy65_ ? ((Func<List<RecordField>, CodexType>)((rfields) => ((Func<Name, CodexType>)((rname) => lookup_record_field(rfields, f.name.value)))((Name)_mRecordTy65_.Field0)))((List<RecordField>)_mRecordTy65_.Field1) : ((Func<CodexType, CodexType>)((_) => new ErrorTy()))(record_ty));
                var _tco_0 = fields;
    ...
    {
        return ((Func<CodexType, CodexType>)((_scrutinee66_) => (_scrutinee66_ is TypeVar _mTypeVar66_ ? ((Func<long, CodexType>)((id) => subst_type_var_in_target(target, id, arg_ty)))((long)_mTypeVar66_.Field0) : (_scrutinee66_ is ListTy _mListTy66_ ? ((Func<CodexType, CodexType>)((pe) => subst_from_list(pe, arg_ty, target)))((CodexType)_mListTy66_.Field0) : (_scrutinee66_ is FunTy _mFunTy66_ ? ((Func<CodexType, CodexType>)((pr) => ((Func<CodexType, CodexType>)((pp) => subst_from_fun(pp, pr, arg_ty, target)))((CodexType)_mFunTy66_.Field0)))((CodexType)_mFunTy66_.Field1) : ((Func<CodexType, CodexType>)((_) => target))(_scrutinee66_))))))(param_ty);
    }

    public static CodexType subst_from_list(CodexType pe, CodexType arg_ty, CodexType target)
    {
        return (arg_ty is ListTy _mListTy67_ ? ((Func<CodexType, CodexType>)((ae) => subst_type_vars_from_arg(pe, ae, target)))((CodexType)_mListTy67_.Field0) : ((Func<CodexType, CodexType>)((_) => target))(arg_ty));
    }

    public static CodexType subst_from_fun(CodexType pp, CodexType pr, CodexType arg_ty, CodexType target)
    {
        return (arg_ty is FunTy _mFunTy68_ ? ((Func<CodexType, CodexType>)((ar) => ((Func<CodexType, CodexType>)((ap) => ((Func<CodexType, CodexType>)((t2) => subst_type_vars_from_arg(pr, ar, t2)))(subst_type_vars_from_arg(pp, ap, target))))((CodexType)_mFunTy68_.Field0)))((CodexType)_mFunTy68_.Field1) : ((Func<CodexType, CodexType>)((_) => target))(arg_ty));
    }

    public static CodexType subst_type_var_in_target(CodexType ty, long var_id, CodexType replacement)
    {
        return ((Func<CodexType, CodexType>)((_scrutinee69_) => (_scrutinee69_ is TypeVar _mTypeVar69_ ? ((Func<long, CodexType>)((id) => ((id == var_id) ? replacement : ty)))((long)_mTypeVar69_.Field0) : (_scrutinee69_ is FunTy _mFunTy69_ ? ((Func<CodexType, CodexType>)((r) => ((Func<CodexType, CodexType>)((p) => new FunTy(subst_type_var_in_target(p, var_id, replacement), subst_type_var_in_target(r, var_id, replacement))))((CodexType)_mFunTy69_.Field0)))((CodexType)_mFunTy69_.Field1) : (_scrutinee69_ is ListTy _mListTy69_ ? ((Func<CodexType, CodexType>)((elem) => new ListTy(subst_type_var_in_target(elem, var_id, replacement))))((CodexType)_mListTy69_.Field0) : (_scrutinee69_ is ForAllTy _mForAllTy69_ ? ((Func<CodexType, CodexType>)((body) => ((Func<long, CodexType>)((fid) => ((fid == var_id) ? ty : new ForAllTy(fid, subst_type_var_in_target(body, var_id, replacement)))))((long)_mForAllTy69_.Field0)))((CodexType)_mForAllTy69_.Field1) : ((Func<CodexType, CodexType>)((_) => ty))(_scrutinee69_)))))))(ty);
    }
    ...
    {
        return (ty is TextTy _mTextTy70_ ? true : ((Func<CodexType, bool>)((_) => false))(ty));
    }
    ...
    {
        return ((Func<ATypeDef, List<TypeBinding>>)((_scrutinee71_) => (_scrutinee71_ is AVariantTypeDef _mAVariantTypeDef71_ ? ((Func<List<AVariantCtorDef>, List<TypeBinding>>)((ctors) => ((Func<List<Name>, List<TypeBinding>>)((type_params) => ((Func<Name, List<TypeBinding>>)((name) => ((Func<CodexType, List<TypeBinding>>)((result_ty) => collect_variant_ctor_bindings(ctors, result_ty, 0L, ((long)ctors.Count), new List<TypeBinding>())))(new ConstructedTy(name, new List<CodexType>()))))((Name)_mAVariantTypeDef71_.Field0)))((List<Name>)_mAVariantTypeDef71_.Field1)))((List<AVariantCtorDef>)_mAVariantTypeDef71_.Field2) : (_scrutinee71_ is ARecordTypeDef _mARecordTypeDef71_ ? ((Func<List<ARecordFieldDef>, List<TypeBinding>>)((fields) => ((Func<List<Name>, List<TypeBinding>>)((type_params) => ((Func<Name, List<TypeBinding>>)((name) => ((Func<List<RecordField>, List<TypeBinding>>)((resolved_fields) => ((Func<CodexType, List<TypeBinding>>)((result_ty) => ((Func<CodexType, List<TypeBinding>>)((ctor_ty) => new List<TypeBinding>() { new TypeBinding(name.value, ctor_ty) }))(lowering_types_build_record_ctor_type(fields, result_ty, 0L, ((long)fields.Count)))))(new RecordTy(name, resolved_fields))))(lowering_types_build_record_fields(fields, 0L, ((long)fields.Count), new List<RecordField>()))))((Name)_mARecordTypeDef71_.Field0)))((List<Name>)_mARecordTypeDef71_.Field1)))((List<ARecordFieldDef>)_mARecordTypeDef71_.Field2) : throw new InvalidOperationException("Non-exhaustive match")))))(td);
    }
    ...
    {
        return ((Func<ATypeExpr, CodexType>)((_scrutinee72_) => (_scrutinee72_ is ANamedType _mANamedType72_ ? ((Func<Name, CodexType>)((name) => ((name.value == "+\u0012\u000E\u000D\u001D\u000D\u0015") ? new IntegerTy() : ((name.value == ",\u0019\u001A \u000D\u0015") ? new NumberTy() : ((name.value == "(\u000D$\u000E") ? new TextTy() : ((name.value == ":\u0010\u0010\u0017\u000D\u000F\u0012") ? new BooleanTy() : ((name.value == ",\u0010\u000E\u0014\u0011\u0012\u001D") ? new NothingTy() : new ConstructedTy(name, new List<CodexType>()))))))))((Name)_mANamedType72_.Field0) : (_scrutinee72_ is AFunType _mAFunType72_ ? ((Func<ATypeExpr, CodexType>)((ret) => ((Func<ATypeExpr, CodexType>)((param) => new FunTy(lowering_types_resolve_type_expr(param), lowering_types_resolve_type_expr(ret))))((ATypeExpr)_mAFunType72_.Field0)))((ATypeExpr)_mAFunType72_.Field1) : (_scrutinee72_ is AAppType _mAAppType72_ ? ((Func<List<ATypeExpr>, CodexType>)((args) => ((Func<ATypeExpr, CodexType>)((ctor) => (ctor is ANamedType _mANamedType73_ ? ((Func<Name, CodexType>)((cname) => ((cname.value == "1\u0011\u0013\u000E") ? ((((long)args.Count) == 1L) ? new ListTy(lowering_types_resolve_type_expr(args[(int)0L])) : new ListTy(new ErrorTy())) : new ConstructedTy(cname, new List<CodexType>()))))((Name)_mANamedType73_.Field0) : ((Func<ATypeExpr, CodexType>)((_) => new ErrorTy()))(ctor))))((ATypeExpr)_mAAppType72_.Field0)))((List<ATypeExpr>)_mAAppType72_.Field1) : throw new InvalidOperationException("Non-exhaustive match"))))))(texpr);
    }

    public static IRBinaryOp lower_bin_op(BinaryOp op, CodexType ty)
    {
        return ((Func<BinaryOp, IRBinaryOp>)((_scrutinee74_) => (_scrutinee74_ is OpAdd _mOpAdd74_ ? new IrAddInt() : (_scrutinee74_ is OpSub _mOpSub74_ ? new IrSubInt() : (_scrutinee74_ is OpMul _mOpMul74_ ? new IrMulInt() : (_scrutinee74_ is OpDiv _mOpDiv74_ ? new IrDivInt() : (_scrutinee74_ is OpPow _mOpPow74_ ? new IrPowInt() : (_scrutinee74_ is OpEq _mOpEq74_ ? new IrEq() : (_scrutinee74_ is OpNotEq _mOpNotEq74_ ? new IrNotEq() : (_scrutinee74_ is OpLt _mOpLt74_ ? new IrLt() : (_scrutinee74_ is OpGt _mOpGt74_ ? new IrGt() : (_scrutinee74_ is OpLtEq _mOpLtEq74_ ? new IrLtEq() : (_scrutinee74_ is OpGtEq _mOpGtEq74_ ? new IrGtEq() : (_scrutinee74_ is OpDefEq _mOpDefEq74_ ? new IrEq() : (_scrutinee74_ is OpAppend _mOpAppend74_ ? (is_text_type(ty) ? new IrAppendText() : new IrAppendList()) : (_scrutinee74_ is OpCons _mOpCons74_ ? new IrConsList() : (_scrutinee74_ is OpAnd _mOpAnd74_ ? new IrAnd() : (_scrutinee74_ is OpOr _mOpOr74_ ? new IrOr() : throw new InvalidOperationException("Non-exhaustive match")))))))))))))))))))(op);
    }

    public static CodexType binary_result_type(BinaryOp op, CodexType left_ty, CodexType expected_ty)
    {
        return ((Func<BinaryOp, CodexType>)((_scrutinee75_) => (_scrutinee75_ is OpEq _mOpEq75_ ? new BooleanTy() : (_scrutinee75_ is OpNotEq _mOpNotEq75_ ? new BooleanTy() : (_scrutinee75_ is OpLt _mOpLt75_ ? new BooleanTy() : (_scrutinee75_ is OpGt _mOpGt75_ ? new BooleanTy() : (_scrutinee75_ is OpLtEq _mOpLtEq75_ ? new BooleanTy() : (_scrutinee75_ is OpGtEq _mOpGtEq75_ ? new BooleanTy() : (_scrutinee75_ is OpDefEq _mOpDefEq75_ ? new BooleanTy() : (_scrutinee75_ is OpAnd _mOpAnd75_ ? new BooleanTy() : (_scrutinee75_ is OpOr _mOpOr75_ ? new BooleanTy() : (_scrutinee75_ is OpAppend _mOpAppend75_ ? (is_text_type(left_ty) ? new TextTy() : (is_text_type(expected_ty) ? new TextTy() : left_ty)) : ((Func<BinaryOp, CodexType>)((_) => left_ty))(_scrutinee75_)))))))))))))(op);
    }
    ...
    {
        return ((Func<APat, Scope>)((_scrutinee76_) => (_scrutinee76_ is AVarPat _mAVarPat76_ ? ((Func<Name, Scope>)((name) => scope_add(sc, name.value)))((Name)_mAVarPat76_.Field0) : (_scrutinee76_ is ACtorPat _mACtorPat76_ ? ((Func<List<APat>, Scope>)((subs) => ((Func<Name, Scope>)((name) => collect_ctor_pat_names(sc, subs, 0L, ((long)subs.Count))))((Name)_mACtorPat76_.Field0)))((List<APat>)_mACtorPat76_.Field1) : (_scrutinee76_ is ALitPat _mALitPat76_ ? ((Func<LiteralKind, Scope>)((kind) => ((Func<string, Scope>)((val) => sc))((string)_mALitPat76_.Field0)))((LiteralKind)_mALitPat76_.Field1) : (_scrutinee76_ is AWildPat _mAWildPat76_ ? sc : throw new InvalidOperationException("Non-exhaustive match")))))))(pat);
    }
    ...
    {
        return (r is TypeOk _mTypeOk77_ ? ((Func<ParseState, ParseTypeResult>)((st) => ((Func<TypeExpr, ParseTypeResult>)((t) => f(t)(st)))((TypeExpr)_mTypeOk77_.Field0)))((ParseState)_mTypeOk77_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (r is PatOk _mPatOk78_ ? ((Func<ParseState, ParsePatResult>)((st) => ((Func<Pat, ParsePatResult>)((p) => f(p)(st)))((Pat)_mPatOk78_.Field0)))((ParseState)_mPatOk78_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (r is TypeOk _mTypeOk79_ ? ((Func<ParseState, ParseDefResult>)((st) => ((Func<TypeExpr, ParseDefResult>)((ann_type) => ((Func<Token, ParseDefResult>)((name_tok) => ((Func<List<TypeAnn>, ParseDefResult>)((ann) => ((Func<ParseState, ParseDefResult>)((st2) => parse_def_body_with_ann(ann, st2)))(skip_newlines(st))))(new List<TypeAnn>() { new TypeAnn(name_tok, ann_type) })))(new Token(new Identifier(), "", 0L, 0L, 0L))))((TypeExpr)_mTypeOk79_.Field0)))((ParseState)_mTypeOk79_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (r is ExprOk _mExprOk80_ ? ((Func<ParseState, ParseDefResult>)((st) => ((Func<Expr, ParseDefResult>)((b) => new DefOk(new Def(name_tok, @params, ann, b), st)))((Expr)_mExprOk80_.Field0)))((ParseState)_mExprOk80_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (r is TypeOk _mTypeOk81_ ? ((Func<ParseState, ParseTypeDefResult>)((st) => ((Func<TypeExpr, ParseTypeDefResult>)((ft) => ((Func<RecordFieldDef, ParseTypeDefResult>)((field) => ((Func<ParseState, ParseTypeDefResult>)((st2) => (is_comma(current_kind(st2)) ? parse_record_fields_loop(name_tok, tparams, ((Func<List<RecordFieldDef>>)(() => { var _l = acc; _l.Add(field); return _l; }))(), skip_newlines(advance(st2))) : parse_record_fields_loop(name_tok, tparams, ((Func<List<RecordFieldDef>>)(() => { var _l = acc; _l.Add(field); return _l; }))(), st2))))(skip_newlines(st))))(new RecordFieldDef(field_name, ft))))((TypeExpr)_mTypeOk81_.Field0)))((ParseState)_mTypeOk81_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (r is TypeOk _mTypeOk82_ ? ((Func<ParseState, ParseTypeDefResult>)((st) => ((Func<TypeExpr, ParseTypeDefResult>)((ty) => ((Func<ParseState, ParseTypeDefResult>)((st2) => parse_ctor_fields(ctor_name, Enumerable.Concat(fields, new List<TypeExpr>() { ty }).ToList(), st2, name_tok, tparams, acc)))(expect(new RightParen(), st))))((TypeExpr)_mTypeOk82_.Field0)))((ParseState)_mTypeOk82_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return ((Func<ParseTypeDefResult, Document>)((td_result) => ((Func<ParseTypeDefResult, Document>)((_scrutinee83_) => (_scrutinee83_ is TypeDefOk _mTypeDefOk83_ ? ((Func<ParseState, Document>)((st2) => ((Func<TypeDef, Document>)((td) => parse_top_level(defs, Enumerable.Concat(type_defs, new List<TypeDef>() { td }).ToList(), effect_defs, imports, skip_newlines(st2))))((TypeDef)_mTypeDefOk83_.Field0)))((ParseState)_mTypeDefOk83_.Field1) : (_scrutinee83_ is TypeDefNone _mTypeDefNone83_ ? ((Func<ParseState, Document>)((st2) => try_top_level_def(defs, type_defs, effect_defs, imports, st)))((ParseState)_mTypeDefNone83_.Field0) : throw new InvalidOperationException("Non-exhaustive match")))))(td_result)))(parse_type_def(st));
    }
    ...
    {
        return ((Func<ParseDefResult, Document>)((def_result) => ((Func<ParseDefResult, Document>)((_scrutinee84_) => (_scrutinee84_ is DefOk _mDefOk84_ ? ((Func<ParseState, Document>)((st2) => ((Func<Def, Document>)((d) => parse_top_level(Enumerable.Concat(defs, new List<Def>() { d }).ToList(), type_defs, effect_defs, imports, skip_newlines(st2))))((Def)_mDefOk84_.Field0)))((ParseState)_mDefOk84_.Field1) : (_scrutinee84_ is DefNone _mDefNone84_ ? ((Func<ParseState, Document>)((st2) => parse_top_level(defs, type_defs, effect_defs, imports, skip_newlines(advance(st2)))))((ParseState)_mDefNone84_.Field0) : throw new InvalidOperationException("Non-exhaustive match")))))(def_result)))(parse_definition(st));
    }
    ...
    {
        return ((Func<ParseTypeDefResult, ScanResult>)((td_result) => ((Func<ParseTypeDefResult, ScanResult>)((_scrutinee85_) => (_scrutinee85_ is TypeDefOk _mTypeDefOk85_ ? ((Func<ParseState, ScanResult>)((st2) => ((Func<TypeDef, ScanResult>)((td) => scan_top_level(headers, Enumerable.Concat(type_defs, new List<TypeDef>() { td }).ToList(), effect_defs, imports, skip_newlines(st2))))((TypeDef)_mTypeDefOk85_.Field0)))((ParseState)_mTypeDefOk85_.Field1) : (_scrutinee85_ is TypeDefNone _mTypeDefNone85_ ? ((Func<ParseState, ScanResult>)((st2) => try_scan_def_header(headers, type_defs, effect_defs, imports, st)))((ParseState)_mTypeDefNone85_.Field0) : throw new InvalidOperationException("Non-exhaustive match")))))(td_result)))(parse_type_def(st));
    }
    ...
    {
        return ((Func<ScanDefResult, ScanResult>)((hdr_result) => ((Func<ScanDefResult, ScanResult>)((_scrutinee86_) => (_scrutinee86_ is DefHeaderOk _mDefHeaderOk86_ ? ((Func<ParseState, ScanResult>)((st2) => ((Func<DefHeader, ScanResult>)((hdr) => scan_top_level(Enumerable.Concat(headers, new List<DefHeader>() { hdr }).ToList(), type_defs, effect_defs, imports, skip_newlines(st2))))((DefHeader)_mDefHeaderOk86_.Field0)))((ParseState)_mDefHeaderOk86_.Field1) : (_scrutinee86_ is DefHeaderNone _mDefHeaderNone86_ ? ((Func<ParseState, ScanResult>)((st2) => scan_top_level(headers, type_defs, effect_defs, imports, skip_newlines(advance(st2)))))((ParseState)_mDefHeaderNone86_.Field0) : throw new InvalidOperationException("Non-exhaustive match")))))(hdr_result)))(scan_definition(st));
    }
    ...
    {
        return (r is TypeOk _mTypeOk87_ ? ((Func<ParseState, ScanDefResult>)((st) => ((Func<TypeExpr, ScanDefResult>)((ann_type) => ((Func<Token, ScanDefResult>)((name_tok) => ((Func<List<TypeAnn>, ScanDefResult>)((ann) => ((Func<ParseState, ScanDefResult>)((st2) => scan_def_body_with_ann(ann, st2)))(skip_newlines(st))))(new List<TypeAnn>() { new TypeAnn(name_tok, ann_type) })))(new Token(new Identifier(), "", 0L, 0L, 0L))))((TypeExpr)_mTypeOk87_.Field0)))((ParseState)_mTypeOk87_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (current_kind(st) is EndOfFile _mEndOfFile88_ ? true : ((Func<TokenKind, bool>)((_) => false))(current_kind(st)));
    }
    ...
    {
        return (k is Identifier _mIdentifier89_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_type_ident(TokenKind k)
    {
        return (k is TypeIdentifier _mTypeIdentifier90_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_arrow(TokenKind k)
    {
        return (k is Arrow _mArrow91_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_equals(TokenKind k)
    {
        return (k is Equals_ _mEquals_92_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_colon(TokenKind k)
    {
        return (k is Colon _mColon93_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_comma(TokenKind k)
    {
        return (k is Comma _mComma94_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_pipe(TokenKind k)
    {
        return (k is Pipe _mPipe95_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_dot(TokenKind k)
    {
        return (k is Dot _mDot96_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_left_paren(TokenKind k)
    {
        return (k is LeftParen _mLeftParen97_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_left_brace(TokenKind k)
    {
        return (k is LeftBrace _mLeftBrace98_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_left_bracket(TokenKind k)
    {
        return (k is LeftBracket _mLeftBracket99_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_right_brace(TokenKind k)
    {
        return (k is RightBrace _mRightBrace100_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_right_bracket(TokenKind k)
    {
        return (k is RightBracket _mRightBracket101_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_right_paren(TokenKind k)
    {
        return (k is RightParen _mRightParen102_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_if_keyword(TokenKind k)
    {
        return (k is IfKeyword _mIfKeyword103_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_let_keyword(TokenKind k)
    {
        return (k is LetKeyword _mLetKeyword104_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_when_keyword(TokenKind k)
    {
        return (k is WhenKeyword _mWhenKeyword105_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_do_keyword(TokenKind k)
    {
        return (k is DoKeyword _mDoKeyword106_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_with_keyword(TokenKind k)
    {
        return (k is WithKeyword _mWithKeyword107_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_effect_keyword(TokenKind k)
    {
        return (k is EffectKeyword _mEffectKeyword108_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_import_keyword(TokenKind k)
    {
        return (k is ImportKeyword _mImportKeyword109_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_where_keyword(TokenKind k)
    {
        return (k is WhereKeyword _mWhereKeyword110_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_in_keyword(TokenKind k)
    {
        return (k is InKeyword _mInKeyword111_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_minus(TokenKind k)
    {
        return (k is Minus _mMinus112_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_dedent(TokenKind k)
    {
        return (k is Dedent _mDedent113_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_left_arrow(TokenKind k)
    {
        return (k is LeftArrow _mLeftArrow114_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_record_keyword(TokenKind k)
    {
        return (k is RecordKeyword _mRecordKeyword115_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_underscore(TokenKind k)
    {
        return (k is Underscore _mUnderscore116_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_backslash(TokenKind k)
    {
        return (k is Backslash _mBackslash117_ ? true : ((Func<TokenKind, bool>)((_) => false))(k));
    }

    public static bool is_literal(TokenKind k)
    {
        return ((Func<TokenKind, bool>)((_scrutinee118_) => (_scrutinee118_ is IntegerLiteral _mIntegerLiteral118_ ? true : (_scrutinee118_ is NumberLiteral _mNumberLiteral118_ ? true : (_scrutinee118_ is TextLiteral _mTextLiteral118_ ? true : (_scrutinee118_ is CharLiteral _mCharLiteral118_ ? true : (_scrutinee118_ is TrueKeyword _mTrueKeyword118_ ? true : (_scrutinee118_ is FalseKeyword _mFalseKeyword118_ ? true : ((Func<TokenKind, bool>)((_) => false))(_scrutinee118_)))))))))(k);
    }

    public static bool is_app_start(TokenKind k)
    {
        return ((Func<TokenKind, bool>)((_scrutinee119_) => (_scrutinee119_ is Identifier _mIdentifier119_ ? true : (_scrutinee119_ is TypeIdentifier _mTypeIdentifier119_ ? true : (_scrutinee119_ is IntegerLiteral _mIntegerLiteral119_ ? true : (_scrutinee119_ is NumberLiteral _mNumberLiteral119_ ? true : (_scrutinee119_ is TextLiteral _mTextLiteral119_ ? true : (_scrutinee119_ is CharLiteral _mCharLiteral119_ ? true : (_scrutinee119_ is TrueKeyword _mTrueKeyword119_ ? true : (_scrutinee119_ is FalseKeyword _mFalseKeyword119_ ? true : (_scrutinee119_ is LeftParen _mLeftParen119_ ? true : (_scrutinee119_ is LeftBracket _mLeftBracket119_ ? true : ((Func<TokenKind, bool>)((_) => false))(_scrutinee119_)))))))))))))(k);
    }

    public static bool is_compound(Expr e)
    {
        return ((Func<Expr, bool>)((_scrutinee120_) => (_scrutinee120_ is MatchExpr _mMatchExpr120_ ? ((Func<List<MatchArm>, bool>)((arms) => ((Func<Expr, bool>)((s) => true))((Expr)_mMatchExpr120_.Field0)))((List<MatchArm>)_mMatchExpr120_.Field1) : (_scrutinee120_ is IfExpr _mIfExpr120_ ? ((Func<Expr, bool>)((el) => ((Func<Expr, bool>)((t) => ((Func<Expr, bool>)((c) => true))((Expr)_mIfExpr120_.Field0)))((Expr)_mIfExpr120_.Field1)))((Expr)_mIfExpr120_.Field2) : (_scrutinee120_ is LetExpr _mLetExpr120_ ? ((Func<Expr, bool>)((body) => ((Func<List<LetBind>, bool>)((binds) => true))((List<LetBind>)_mLetExpr120_.Field0)))((Expr)_mLetExpr120_.Field1) : (_scrutinee120_ is DoExpr _mDoExpr120_ ? ((Func<List<DoStmt>, bool>)((stmts) => true))((List<DoStmt>)_mDoExpr120_.Field0) : ((Func<Expr, bool>)((_) => false))(_scrutinee120_)))))))(e);
    }

    public static bool is_type_arg_start(TokenKind k)
    {
        return ((Func<TokenKind, bool>)((_scrutinee121_) => (_scrutinee121_ is TypeIdentifier _mTypeIdentifier121_ ? true : (_scrutinee121_ is Identifier _mIdentifier121_ ? true : (_scrutinee121_ is LeftParen _mLeftParen121_ ? true : ((Func<TokenKind, bool>)((_) => false))(_scrutinee121_))))))(k);
    }

    public static long operator_precedence(TokenKind k)
    {
        return ((Func<TokenKind, long>)((_scrutinee122_) => (_scrutinee122_ is PlusPlus _mPlusPlus122_ ? 5L : (_scrutinee122_ is ColonColon _mColonColon122_ ? 5L : (_scrutinee122_ is Plus _mPlus122_ ? 6L : (_scrutinee122_ is Minus _mMinus122_ ? 6L : (_scrutinee122_ is Star _mStar122_ ? 7L : (_scrutinee122_ is Slash _mSlash122_ ? 7L : (_scrutinee122_ is Caret _mCaret122_ ? 8L : (_scrutinee122_ is DoubleEquals _mDoubleEquals122_ ? 4L : (_scrutinee122_ is NotEquals _mNotEquals122_ ? 4L : (_scrutinee122_ is LessThan _mLessThan122_ ? 4L : (_scrutinee122_ is GreaterThan _mGreaterThan122_ ? 4L : (_scrutinee122_ is LessOrEqual _mLessOrEqual122_ ? 4L : (_scrutinee122_ is GreaterOrEqual _mGreaterOrEqual122_ ? 4L : (_scrutinee122_ is TripleEquals _mTripleEquals122_ ? 4L : (_scrutinee122_ is Ampersand _mAmpersand122_ ? 3L : (_scrutinee122_ is Pipe _mPipe122_ ? 2L : ((Func<TokenKind, long>)((_) => (0L - 1L)))(_scrutinee122_)))))))))))))))))))(k);
    }

    public static bool is_right_assoc(TokenKind k)
    {
        return ((Func<TokenKind, bool>)((_scrutinee123_) => (_scrutinee123_ is PlusPlus _mPlusPlus123_ ? true : (_scrutinee123_ is ColonColon _mColonColon123_ ? true : (_scrutinee123_ is Caret _mCaret123_ ? true : (_scrutinee123_ is Arrow _mArrow123_ ? true : ((Func<TokenKind, bool>)((_) => false))(_scrutinee123_)))))))(k);
    }
    ...
    {
        return (r is ExprOk _mExprOk124_ ? ((Func<ParseState, ParseExprResult>)((st) => ((Func<Expr, ParseExprResult>)((e) => f(e)(st)))((Expr)_mExprOk124_.Field0)))((ParseState)_mExprOk124_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (r is PatOk _mPatOk125_ ? ((Func<ParseState, ParseExprResult>)((st) => ((Func<Pat, ParseExprResult>)((p) => f(p)(st)))((Pat)_mPatOk125_.Field0)))((ParseState)_mPatOk125_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
    ...
    {
        return (ctor is ANamedType _mANamedType127_ ? ((Func<Name, CodexType>)((name) => ((name.value == "1\u0011\u0013\u000E") ? ((((long)args.Count) == 1L) ? new ListTy(type_checker_resolve_type_expr(tdm, args[(int)0L])) : new ListTy(new ErrorTy())) : new ConstructedTy(name, resolve_type_expr_list(tdm, args, 0L, ((long)args.Count), new List<CodexType>())))))((Name)_mANamedType127_.Field0) : ((Func<ATypeExpr, CodexType>)((_) => type_checker_resolve_type_expr(tdm, ctor)))(ctor));
    }
    ...
    {
        return ((Func<CodexType, WalkResult>)((_scrutinee128_) => (_scrutinee128_ is ConstructedTy _mConstructedTy128_ ? ((Func<List<CodexType>, WalkResult>)((args) => ((Func<Name, WalkResult>)((name) => (((((long)args.Count) == 0L) && is_value_name(name.value)) ? ((Func<long, WalkResult>)((looked) => ((looked >= 0L) ? new WalkResult(new TypeVar(looked), entries, st) : ((Func<FreshResult, WalkResult>)((fr) => (fr.var_type is TypeVar _mTypeVar129_ ? ((Func<long, WalkResult>)((new_id) => ((Func<ParamEntry, WalkResult>)((new_entry) => new WalkResult(fr.var_type, Enumerable.Concat(entries, new List<ParamEntry>() { new_entry }).ToList(), fr.state)))(new ParamEntry(name.value, new_id))))((long)_mTypeVar129_.Field0) : ((Func<CodexType, WalkResult>)((_) => new WalkResult(ty, entries, fr.state)))(fr.var_type))))(fresh_and_advance(st)))))(find_param_entry(entries, name.value, 0L, ((long)entries.Count))) : ((Func<WalkListResult, WalkResult>)((args_r) => new WalkResult(new ConstructedTy(name, args_r.walked_list), args_r.entries, args_r.state)))(parameterize_walk_list(st, entries, args, 0L, ((long)args.Count), new List<CodexType>())))))((Name)_mConstructedTy128_.Field0)))((List<CodexType>)_mConstructedTy128_.Field1) : (_scrutinee128_ is FunTy _mFunTy128_ ? ((Func<CodexType, WalkResult>)((ret) => ((Func<CodexType, WalkResult>)((param) => ((Func<WalkResult, WalkResult>)((pr) => ((Func<WalkResult, WalkResult>)((rr) => new WalkResult(new FunTy(pr.walked, rr.walked), rr.entries, rr.state)))(parameterize_walk(pr.state, pr.entries, ret))))(parameterize_walk(st, entries, param))))((CodexType)_mFunTy128_.Field0)))((CodexType)_mFunTy128_.Field1) : (_scrutinee128_ is ListTy _mListTy128_ ? ((Func<CodexType, WalkResult>)((elem) => ((Func<WalkResult, WalkResult>)((er) => new WalkResult(new ListTy(er.walked), er.entries, er.state)))(parameterize_walk(st, entries, elem))))((CodexType)_mListTy128_.Field0) : (_scrutinee128_ is ForAllTy _mForAllTy128_ ? ((Func<CodexType, WalkResult>)((body) => ((Func<long, WalkResult>)((id) => ((Func<WalkResult, WalkResult>)((br) => new WalkResult(new ForAllTy(id, br.walked), br.entries, br.state)))(parameterize_walk(st, entries, body))))((long)_mForAllTy128_.Field0)))((CodexType)_mForAllTy128_.Field1) : ((Func<CodexType, WalkResult>)((_) => new WalkResult(ty, entries, st)))(_scrutinee128_)))))))(ty);
    }
    ...
    public static List<TypeBinding> build_type_def_map(List<ATypeDef> tdefs, long i, long len, List<TypeBinding> acc)
    {
        while (true)
        {
            ...
            {
                var td = tdefs[(int)i];
                var entry = ((Func<ATypeDef, TypeBinding>)((_scrutinee130_) => (_scrutinee130_ is AVariantTypeDef _mAVariantTypeDef130_ ? ((Func<List<AVariantCtorDef>, TypeBinding>)((ctors) => ((Func<List<Name>, TypeBinding>)((type_params) => ((Func<Name, TypeBinding>)((name) => ((Func<List<SumCtor>, TypeBinding>)((sum_ctors) => new TypeBinding(name.value, new SumTy(name, sum_ctors))))(build_sum_ctors(tdefs, ctors, 0L, ((long)ctors.Count), new List<SumCtor>(), acc))))((Name)_mAVariantTypeDef130_.Field0)))((List<Name>)_mAVariantTypeDef130_.Field1)))((List<AVariantCtorDef>)_mAVariantTypeDef130_.Field2) : (_scrutinee130_ is ARecordTypeDef _mARecordTypeDef130_ ? ((Func<List<ARecordFieldDef>, TypeBinding>)((fields) => ((Func<List<Name>, TypeBinding>)((type_params) => ((Func<Name, TypeBinding>)((name) => ((Func<List<RecordField>, TypeBinding>)((rec_fields) => new TypeBinding(name.value, new RecordTy(name, rec_fields))))(build_record_fields_for_map(tdefs, fields, 0L, ((long)fields.Count), new List<RecordField>(), acc))))((Name)_mARecordTypeDef130_.Field0)))((List<Name>)_mARecordTypeDef130_.Field1)))((List<ARecordFieldDef>)_mARecordTypeDef130_.Field2) : throw new InvalidOperationException("Non-exhaustive match")))))(td);
                var _tco_0 = tdefs;
                var _tco_1 = (i + 1L);
                var _tco_2 = len;
    ...
    {
        return ((Func<ATypeDef, LetBindResult>)((_scrutinee131_) => (_scrutinee131_ is AVariantTypeDef _mAVariantTypeDef131_ ? ((Func<List<AVariantCtorDef>, LetBindResult>)((ctors) => ((Func<List<Name>, LetBindResult>)((type_params) => ((Func<Name, LetBindResult>)((name) => ((Func<CodexType, LetBindResult>)((result_ty) => register_variant_ctors(st, env, tdm, ctors, result_ty, 0L, ((long)ctors.Count))))(lookup_type_def(tdm, name.value))))((Name)_mAVariantTypeDef131_.Field0)))((List<Name>)_mAVariantTypeDef131_.Field1)))((List<AVariantCtorDef>)_mAVariantTypeDef131_.Field2) : (_scrutinee131_ is ARecordTypeDef _mARecordTypeDef131_ ? ((Func<List<ARecordFieldDef>, LetBindResult>)((fields) => ((Func<List<Name>, LetBindResult>)((type_params) => ((Func<Name, LetBindResult>)((name) => ((Func<List<RecordField>, LetBindResult>)((resolved_fields) => ((Func<CodexType, LetBindResult>)((result_ty) => ((Func<CodexType, LetBindResult>)((ctor_ty) => new LetBindResult(st, env_bind(env, name.value, ctor_ty))))(type_checker_build_record_ctor_type(tdm, fields, result_ty, 0L, ((long)fields.Count)))))(new RecordTy(name, resolved_fields))))(type_checker_build_record_fields(tdm, fields, 0L, ((long)fields.Count), new List<RecordField>()))))((Name)_mARecordTypeDef131_.Field0)))((List<Name>)_mARecordTypeDef131_.Field1)))((List<ARecordFieldDef>)_mARecordTypeDef131_.Field2) : throw new InvalidOperationException("Non-exhaustive match")))))(td);
    }
    ...
    {
        return ((Func<LiteralKind, CheckResult>)((_scrutinee132_) => (_scrutinee132_ is IntLit _mIntLit132_ ? new CheckResult(new IntegerTy(), st) : (_scrutinee132_ is NumLit _mNumLit132_ ? new CheckResult(new NumberTy(), st) : (_scrutinee132_ is TextLit _mTextLit132_ ? new CheckResult(new TextTy(), st) : (_scrutinee132_ is CharLit _mCharLit132_ ? new CheckResult(new CharTy(), st) : (_scrutinee132_ is BoolLit _mBoolLit132_ ? new CheckResult(new BooleanTy(), st) : throw new InvalidOperationException("Non-exhaustive match"))))))))(kind);
    }
    ...
    {
        return ((Func<CodexType, CodexType>)((_scrutinee133_) => (_scrutinee133_ is TypeVar _mTypeVar133_ ? ((Func<long, CodexType>)((id) => ((id == var_id) ? replacement : ty)))((long)_mTypeVar133_.Field0) : (_scrutinee133_ is FunTy _mFunTy133_ ? ((Func<CodexType, CodexType>)((ret) => ((Func<CodexType, CodexType>)((param) => new FunTy(subst_type_var(param, var_id, replacement), subst_type_var(ret, var_id, replacement))))((CodexType)_mFunTy133_.Field0)))((CodexType)_mFunTy133_.Field1) : (_scrutinee133_ is ListTy _mListTy133_ ? ((Func<CodexType, CodexType>)((elem) => new ListTy(subst_type_var(elem, var_id, replacement))))((CodexType)_mListTy133_.Field0) : (_scrutinee133_ is ForAllTy _mForAllTy133_ ? ((Func<CodexType, CodexType>)((body) => ((Func<long, CodexType>)((inner_id) => ((inner_id == var_id) ? ty : new ForAllTy(inner_id, subst_type_var(body, var_id, replacement)))))((long)_mForAllTy133_.Field0)))((CodexType)_mForAllTy133_.Field1) : (_scrutinee133_ is ConstructedTy _mConstructedTy133_ ? ((Func<List<CodexType>, CodexType>)((args) => ((Func<Name, CodexType>)((name) => new ConstructedTy(name, map_subst_type_var(args, var_id, replacement, 0L, ((long)args.Count), new List<CodexType>()))))((Name)_mConstructedTy133_.Field0)))((List<CodexType>)_mConstructedTy133_.Field1) : (_scrutinee133_ is SumTy _mSumTy133_ ? ((Func<List<SumCtor>, CodexType>)((ctors) => ((Func<Name, CodexType>)((name) => ty))((Name)_mSumTy133_.Field0)))((List<SumCtor>)_mSumTy133_.Field1) : (_scrutinee133_ is RecordTy _mRecordTy133_ ? ((Func<List<RecordField>, CodexType>)((fields) => ((Func<Name, CodexType>)((name) => ty))((Name)_mRecordTy133_.Field0)))((List<RecordField>)_mRecordTy133_.Field1) : ((Func<CodexType, CodexType>)((_) => ty))(_scrutinee133_))))))))))(ty);
    }
    ...
    {
        return ((Func<BinaryOp, CheckResult>)((_scrutinee134_) => (_scrutinee134_ is OpAdd _mOpAdd134_ ? infer_arithmetic(st, lt, rt) : (_scrutinee134_ is OpSub _mOpSub134_ ? infer_arithmetic(st, lt, rt) : (_scrutinee134_ is OpMul _mOpMul134_ ? infer_arithmetic(st, lt, rt) : (_scrutinee134_ is OpDiv _mOpDiv134_ ? infer_arithmetic(st, lt, rt) : (_scrutinee134_ is OpPow _mOpPow134_ ? infer_arithmetic(st, lt, rt) : (_scrutinee134_ is OpEq _mOpEq134_ ? infer_comparison(st, lt, rt) : (_scrutinee134_ is OpNotEq _mOpNotEq134_ ? infer_comparison(st, lt, rt) : (_scrutinee134_ is OpLt _mOpLt134_ ? infer_comparison(st, lt, rt) : (_scrutinee134_ is OpGt _mOpGt134_ ? infer_comparison(st, lt, rt) : (_scrutinee134_ is OpLtEq _mOpLtEq134_ ? infer_comparison(st, lt, rt) : (_scrutinee134_ is OpGtEq _mOpGtEq134_ ? infer_comparison(st, lt, rt) : (_scrutinee134_ is OpAnd _mOpAnd134_ ? infer_logical(st, lt, rt) : (_scrutinee134_ is OpOr _mOpOr134_ ? infer_logical(st, lt, rt) : (_scrutinee134_ is OpAppend _mOpAppend134_ ? infer_append(st, lt, rt) : (_scrutinee134_ is OpCons _mOpCons134_ ? infer_cons(st, lt, rt) : (_scrutinee134_ is OpDefEq _mOpDefEq134_ ? infer_comparison(st, lt, rt) : throw new InvalidOperationException("Non-exhaustive match")))))))))))))))))))(op);
    }
    ...
    {
        return ((Func<CodexType, CheckResult>)((resolved) => (resolved is TextTy _mTextTy135_ ? ((Func<UnifyResult, CheckResult>)((r) => new CheckResult(new TextTy(), r.state)))(unify(st, rt, new TextTy())) : ((Func<CodexType, CheckResult>)((_) => ((Func<UnifyResult, CheckResult>)((r) => new CheckResult(lt, r.state)))(unify(st, lt, rt))))(resolved))))(resolve(st, lt));
    }
    ...
    {
        return ((Func<APat, PatBindResult>)((_scrutinee136_) => (_scrutinee136_ is AVarPat _mAVarPat136_ ? ((Func<Name, PatBindResult>)((name) => new PatBindResult(st, env_bind(env, name.value, ty))))((Name)_mAVarPat136_.Field0) : (_scrutinee136_ is AWildPat _mAWildPat136_ ? new PatBindResult(st, env) : (_scrutinee136_ is ALitPat _mALitPat136_ ? ((Func<LiteralKind, PatBindResult>)((kind) => ((Func<string, PatBindResult>)((val) => new PatBindResult(st, env)))((string)_mALitPat136_.Field0)))((LiteralKind)_mALitPat136_.Field1) : (_scrutinee136_ is ACtorPat _mACtorPat136_ ? ((Func<List<APat>, PatBindResult>)((sub_pats) => ((Func<Name, PatBindResult>)((ctor_name) => ((Func<FreshResult, PatBindResult>)((ctor_lookup) => bind_ctor_sub_patterns(ctor_lookup.state, env, sub_pats, ctor_lookup.var_type, 0L, ((long)sub_pats.Count))))(instantiate_type(st, env_lookup(env, ctor_name.value)))))((Name)_mACtorPat136_.Field0)))((List<APat>)_mACtorPat136_.Field1) : throw new InvalidOperationException("Non-exhaustive match")))))))(pat);
    }
    ...
    {
        return ((Func<AExpr, CheckResult>)((_scrutinee137_) => (_scrutinee137_ is ALitExpr _mALitExpr137_ ? ((Func<LiteralKind, CheckResult>)((kind) => ((Func<string, CheckResult>)((val) => infer_literal(st, kind)))((string)_mALitExpr137_.Field0)))((LiteralKind)_mALitExpr137_.Field1) : (_scrutinee137_ is ANameExpr _mANameExpr137_ ? ((Func<Name, CheckResult>)((name) => infer_name(st, env, name.value)))((Name)_mANameExpr137_.Field0) : (_scrutinee137_ is ABinaryExpr _mABinaryExpr137_ ? ((Func<AExpr, CheckResult>)((right) => ((Func<BinaryOp, CheckResult>)((op) => ((Func<AExpr, CheckResult>)((left) => infer_binary(st, env, left, op, right)))((AExpr)_mABinaryExpr137_.Field0)))((BinaryOp)_mABinaryExpr137_.Field1)))((AExpr)_mABinaryExpr137_.Field2) : (_scrutinee137_ is AUnaryExpr _mAUnaryExpr137_ ? ((Func<AExpr, CheckResult>)((operand) => ((Func<CheckResult, CheckResult>)((r) => ((Func<UnifyResult, CheckResult>)((u) => new CheckResult(new IntegerTy(), u.state)))(unify(r.state, r.inferred_type, new IntegerTy()))))(infer_expr(st, env, operand))))((AExpr)_mAUnaryExpr137_.Field0) : (_scrutinee137_ is AApplyExpr _mAApplyExpr137_ ? ((Func<AExpr, CheckResult>)((arg) => ((Func<AExpr, CheckResult>)((func) => infer_application(st, env, func, arg)))((AExpr)_mAApplyExpr137_.Field0)))((AExpr)_mAApplyExpr137_.Field1) : (_scrutinee137_ is AIfExpr _mAIfExpr137_ ? ((Func<AExpr, CheckResult>)((else_e) => ((Func<AExpr, CheckResult>)((then_e) => ((Func<AExpr, CheckResult>)((cond) => infer_if(st, env, cond, then_e, else_e)))((AExpr)_mAIfExpr137_.Field0)))((AExpr)_mAIfExpr137_.Field1)))((AExpr)_mAIfExpr137_.Field2) : (_scrutinee137_ is ALetExpr _mALetExpr137_ ? ((Func<AExpr, CheckResult>)((body) => ((Func<List<ALetBind>, CheckResult>)((bindings) => infer_let(st, env, bindings, body)))((List<ALetBind>)_mALetExpr137_.Field0)))((AExpr)_mALetExpr137_.Field1) : (_scrutinee137_ is ALambdaExpr _mALambdaExpr137_ ? ((Func<AExpr, CheckResult>)((body) => ((Func<List<Name>, CheckResult>)((@params) => infer_lambda(st, env, @params, body)))((List<Name>)_mALambdaExpr137_.Field0)))((AExpr)_mALambdaExpr137_.Field1) : (_scrutinee137_ is AMatchExpr _mAMatchExpr137_ ? ((Func<List<AMatchArm>, CheckResult>)((arms) => ((Func<AExpr, CheckResult>)((scrutinee) => infer_match(st, env, scrutinee, arms)))((AExpr)_mAMatchExpr137_.Field0)))((List<AMatchArm>)_mAMatchExpr137_.Field1) : (_scrutinee137_ is AListExpr _mAListExpr137_ ? ((Func<List<AExpr>, CheckResult>)((elems) => infer_list(st, env, elems)))((List<AExpr>)_mAListExpr137_.Field0) : (_scrutinee137_ is ADoExpr _mADoExpr137_ ? ((Func<List<ADoStmt>, CheckResult>)((stmts) => infer_do(st, env, stmts)))((List<ADoStmt>)_mADoExpr137_.Field0) : (_scrutinee137_ is AFieldAccess _mAFieldAccess137_ ? ((Func<Name, CheckResult>)((field) => ((Func<AExpr, CheckResult>)((obj) => ((Func<CheckResult, CheckResult>)((r) => ((Func<CodexType, CheckResult>)((resolved) => ((Func<CodexType, CheckResult>)((_scrutinee138_) => (_scrutinee138_ is RecordTy _mRecordTy138_ ? ((Func<List<RecordField>, CheckResult>)((rfields) => ((Func<Name, CheckResult>)((rname) => ((Func<CodexType, CheckResult>)((ftype) => new CheckResult(ftype, r.state)))(lookup_record_field(rfields, field.value))))((Name)_mRecordTy138_.Field0)))((List<RecordField>)_mRecordTy138_.Field1) : (_scrutinee138_ is ConstructedTy _mConstructedTy138_ ? ((Func<List<CodexType>, CheckResult>)((cargs) => ((Func<Name, CheckResult>)((cname) => ((Func<CodexType, CheckResult>)((record_type) => (record_type is RecordTy _mRecordTy139_ ? ((Func<List<RecordField>, CheckResult>)((rfields) => ((Func<Name, CheckResult>)((rname) => ((Func<CodexType, CheckResult>)((ftype) => new CheckResult(ftype, r.state)))(lookup_record_field(rfields, field.value))))((Name)_mRecordTy139_.Field0)))((List<RecordField>)_mRecordTy139_.Field1) : ((Func<CodexType, CheckResult>)((_) => ((Func<FreshResult, CheckResult>)((fr) => new CheckResult(fr.var_type, fr.state)))(fresh_and_advance(r.state))))(record_type))))(resolve_constructed_to_record(env, cname.value))))((Name)_mConstructedTy138_.Field0)))((List<CodexType>)_mConstructedTy138_.Field1) : ((Func<CodexType, CheckResult>)((_) => ((Func<FreshResult, CheckResult>)((fr) => new CheckResult(fr.var_type, fr.state)))(fresh_and_advance(r.state))))(_scrutinee138_)))))(resolved)))(deep_resolve(r.state, r.inferred_type))))(infer_expr(st, env, obj))))((AExpr)_mAFieldAccess137_.Field0)))((Name)_mAFieldAccess137_.Field1) : (_scrutinee137_ is ARecordExpr _mARecordExpr137_ ? ((Func<List<AFieldExpr>, CheckResult>)((fields) => ((Func<Name, CheckResult>)((name) => ((Func<UnificationState, CheckResult>)((st2) => ((Func<CodexType, CheckResult>)((ctor_type) => ((Func<CodexType, CheckResult>)((result_type) => new CheckResult(result_type, st2)))(strip_fun_args(ctor_type))))((env_has(env, name.value) ? env_lookup(env, name.value) : new ErrorTy()))))(infer_record_fields(st, env, fields, 0L, ((long)fields.Count)))))((Name)_mARecordExpr137_.Field0)))((List<AFieldExpr>)_mARecordExpr137_.Field1) : (_scrutinee137_ is AErrorExpr _mAErrorExpr137_ ? ((Func<string, CheckResult>)((msg) => new CheckResult(new ErrorTy(), st)))((string)_mAErrorExpr137_.Field0) : throw new InvalidOperationException("Non-exhaustive match")))))))))))))))))(expr);
    }
    ...
    {
        return (types_equal(a, b) ? new UnifyResult(true, st) : (a is TypeVar _mTypeVar140_ ? ((Func<long, UnifyResult>)((id_a) => (occurs_in(st, id_a, b) ? new UnifyResult(false, add_unify_error(st, "20>\u0005\u0003\u0004\u0003", "+\u0012\u001C\u0011\u0012\u0011\u000E\u000D\u0002\u000E\u001E\u001F\u000D")) : new UnifyResult(true, add_subst(st, id_a, b)))))((long)_mTypeVar140_.Field0) : ((Func<CodexType, UnifyResult>)((_) => unify_rhs(st, a, b)))(a)));
    }

    public static bool types_equal(CodexType a, CodexType b)
    {
        return ((Func<CodexType, bool>)((_scrutinee141_) => (_scrutinee141_ is TypeVar _mTypeVar141_ ? ((Func<long, bool>)((id_a) => (b is TypeVar _mTypeVar142_ ? ((Func<long, bool>)((id_b) => (id_a == id_b)))((long)_mTypeVar142_.Field0) : ((Func<CodexType, bool>)((_) => false))(b))))((long)_mTypeVar141_.Field0) : (_scrutinee141_ is IntegerTy _mIntegerTy141_ ? (b is IntegerTy _mIntegerTy143_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is NumberTy _mNumberTy141_ ? (b is NumberTy _mNumberTy144_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is TextTy _mTextTy141_ ? (b is TextTy _mTextTy145_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is BooleanTy _mBooleanTy141_ ? (b is BooleanTy _mBooleanTy146_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is CharTy _mCharTy141_ ? (b is CharTy _mCharTy147_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is NothingTy _mNothingTy141_ ? (b is NothingTy _mNothingTy148_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is VoidTy _mVoidTy141_ ? (b is VoidTy _mVoidTy149_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : (_scrutinee141_ is ErrorTy _mErrorTy141_ ? (b is ErrorTy _mErrorTy150_ ? true : ((Func<CodexType, bool>)((_) => false))(b)) : ((Func<CodexType, bool>)((_) => false))(_scrutinee141_))))))))))))(a);
    }

    public static UnifyResult unify_rhs(UnificationState st, CodexType a, CodexType b)
    {
        return (b is TypeVar _mTypeVar151_ ? ((Func<long, UnifyResult>)((id_b) => (occurs_in(st, id_b, a) ? new UnifyResult(false, add_unify_error(st, "20>\u0005\u0003\u0004\u0003", "+\u0012\u001C\u0011\u0012\u0011\u000E\u000D\u0002\u000E\u001E\u001F\u000D")) : new UnifyResult(true, add_subst(st, id_b, a)))))((long)_mTypeVar151_.Field0) : ((Func<CodexType, UnifyResult>)((_) => unify_structural(st, a, b)))(b));
    }

    public static UnifyResult unify_structural(UnificationState st, CodexType a, CodexType b)
    {
        return ((Func<CodexType, UnifyResult>)((_scrutinee152_) => (_scrutinee152_ is IntegerTy _mIntegerTy152_ ? ((Func<CodexType, UnifyResult>)((_scrutinee153_) => (_scrutinee153_ is IntegerTy _mIntegerTy153_ ? new UnifyResult(true, st) : (_scrutinee153_ is ErrorTy _mErrorTy153_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee153_)))))(b) : (_scrutinee152_ is NumberTy _mNumberTy152_ ? ((Func<CodexType, UnifyResult>)((_scrutinee154_) => (_scrutinee154_ is NumberTy _mNumberTy154_ ? new UnifyResult(true, st) : (_scrutinee154_ is ErrorTy _mErrorTy154_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee154_)))))(b) : (_scrutinee152_ is TextTy _mTextTy152_ ? ((Func<CodexType, UnifyResult>)((_scrutinee155_) => (_scrutinee155_ is TextTy _mTextTy155_ ? new UnifyResult(true, st) : (_scrutinee155_ is ErrorTy _mErrorTy155_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee155_)))))(b) : (_scrutinee152_ is BooleanTy _mBooleanTy152_ ? ((Func<CodexType, UnifyResult>)((_scrutinee156_) => (_scrutinee156_ is BooleanTy _mBooleanTy156_ ? new UnifyResult(true, st) : (_scrutinee156_ is ErrorTy _mErrorTy156_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee156_)))))(b) : (_scrutinee152_ is NothingTy _mNothingTy152_ ? ((Func<CodexType, UnifyResult>)((_scrutinee157_) => (_scrutinee157_ is NothingTy _mNothingTy157_ ? new UnifyResult(true, st) : (_scrutinee157_ is ErrorTy _mErrorTy157_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee157_)))))(b) : (_scrutinee152_ is VoidTy _mVoidTy152_ ? ((Func<CodexType, UnifyResult>)((_scrutinee158_) => (_scrutinee158_ is VoidTy _mVoidTy158_ ? new UnifyResult(true, st) : (_scrutinee158_ is ErrorTy _mErrorTy158_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee158_)))))(b) : (_scrutinee152_ is ErrorTy _mErrorTy152_ ? new UnifyResult(true, st) : (_scrutinee152_ is FunTy _mFunTy152_ ? ((Func<CodexType, UnifyResult>)((ra) => ((Func<CodexType, UnifyResult>)((pa) => ((Func<CodexType, UnifyResult>)((_scrutinee159_) => (_scrutinee159_ is FunTy _mFunTy159_ ? ((Func<CodexType, UnifyResult>)((rb) => ((Func<CodexType, UnifyResult>)((pb) => unify_fun(st, pa, ra, pb, rb)))((CodexType)_mFunTy159_.Field0)))((CodexType)_mFunTy159_.Field1) : (_scrutinee159_ is ErrorTy _mErrorTy159_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee159_)))))(b)))((CodexType)_mFunTy152_.Field0)))((CodexType)_mFunTy152_.Field1) : (_scrutinee152_ is ListTy _mListTy152_ ? ((Func<CodexType, UnifyResult>)((ea) => ((Func<CodexType, UnifyResult>)((_scrutinee160_) => (_scrutinee160_ is ListTy _mListTy160_ ? ((Func<CodexType, UnifyResult>)((eb) => unify(st, ea, eb)))((CodexType)_mListTy160_.Field0) : (_scrutinee160_ is ErrorTy _mErrorTy160_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee160_)))))(b)))((CodexType)_mListTy152_.Field0) : (_scrutinee152_ is ConstructedTy _mConstructedTy152_ ? ((Func<List<CodexType>, UnifyResult>)((args_a) => ((Func<Name, UnifyResult>)((na) => ((Func<CodexType, UnifyResult>)((_scrutinee161_) => (_scrutinee161_ is ConstructedTy _mConstructedTy161_ ? ((Func<List<CodexType>, UnifyResult>)((args_b) => ((Func<Name, UnifyResult>)((nb) => ((na.value == nb.value) ? unify_constructed_args(st, args_a, args_b, 0L, ((long)args_a.Count)) : unify_mismatch(st, a, b))))((Name)_mConstructedTy161_.Field0)))((List<CodexType>)_mConstructedTy161_.Field1) : (_scrutinee161_ is SumTy _mSumTy161_ ? ((Func<List<SumCtor>, UnifyResult>)((sb_ctors) => ((Func<Name, UnifyResult>)((sb_name) => ((na.value == sb_name.value) ? new UnifyResult(true, st) : unify_mismatch(st, a, b))))((Name)_mSumTy161_.Field0)))((List<SumCtor>)_mSumTy161_.Field1) : (_scrutinee161_ is RecordTy _mRecordTy161_ ? ((Func<List<RecordField>, UnifyResult>)((rb_fields) => ((Func<Name, UnifyResult>)((rb_name) => ((na.value == rb_name.value) ? new UnifyResult(true, st) : unify_mismatch(st, a, b))))((Name)_mRecordTy161_.Field0)))((List<RecordField>)_mRecordTy161_.Field1) : (_scrutinee161_ is ErrorTy _mErrorTy161_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee161_)))))))(b)))((Name)_mConstructedTy152_.Field0)))((List<CodexType>)_mConstructedTy152_.Field1) : (_scrutinee152_ is SumTy _mSumTy152_ ? ((Func<List<SumCtor>, UnifyResult>)((sa_ctors) => ((Func<Name, UnifyResult>)((sa_name) => ((Func<CodexType, UnifyResult>)((_scrutinee162_) => (_scrutinee162_ is SumTy _mSumTy162_ ? ((Func<List<SumCtor>, UnifyResult>)((sb_ctors) => ((Func<Name, UnifyResult>)((sb_name) => ((sa_name.value == sb_name.value) ? new UnifyResult(true, st) : unify_mismatch(st, a, b))))((Name)_mSumTy162_.Field0)))((List<SumCtor>)_mSumTy162_.Field1) : (_scrutinee162_ is ConstructedTy _mConstructedTy162_ ? ((Func<List<CodexType>, UnifyResult>)((args_b) => ((Func<Name, UnifyResult>)((nb) => ((sa_name.value == nb.value) ? new UnifyResult(true, st) : unify_mismatch(st, a, b))))((Name)_mConstructedTy162_.Field0)))((List<CodexType>)_mConstructedTy162_.Field1) : (_scrutinee162_ is ErrorTy _mErrorTy162_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee162_))))))(b)))((Name)_mSumTy152_.Field0)))((List<SumCtor>)_mSumTy152_.Field1) : (_scrutinee152_ is RecordTy _mRecordTy152_ ? ((Func<List<RecordField>, UnifyResult>)((ra_fields) => ((Func<Name, UnifyResult>)((ra_name) => ((Func<CodexType, UnifyResult>)((_scrutinee163_) => (_scrutinee163_ is RecordTy _mRecordTy163_ ? ((Func<List<RecordField>, UnifyResult>)((rb_fields) => ((Func<Name, UnifyResult>)((rb_name) => ((ra_name.value == rb_name.value) ? new UnifyResult(true, st) : unify_mismatch(st, a, b))))((Name)_mRecordTy163_.Field0)))((List<RecordField>)_mRecordTy163_.Field1) : (_scrutinee163_ is ConstructedTy _mConstructedTy163_ ? ((Func<List<CodexType>, UnifyResult>)((args_b) => ((Func<Name, UnifyResult>)((nb) => ((ra_name.value == nb.value) ? new UnifyResult(true, st) : unify_mismatch(st, a, b))))((Name)_mConstructedTy163_.Field0)))((List<CodexType>)_mConstructedTy163_.Field1) : (_scrutinee163_ is ErrorTy _mErrorTy163_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(_scrutinee163_))))))(b)))((Name)_mRecordTy152_.Field0)))((List<RecordField>)_mRecordTy152_.Field1) : (_scrutinee152_ is ForAllTy _mForAllTy152_ ? ((Func<CodexType, UnifyResult>)((body) => ((Func<long, UnifyResult>)((id) => unify(st, body, b)))((long)_mForAllTy152_.Field0)))((CodexType)_mForAllTy152_.Field1) : ((Func<CodexType, UnifyResult>)((_) => (b is ErrorTy _mErrorTy164_ ? new UnifyResult(true, st) : ((Func<CodexType, UnifyResult>)((_) => unify_mismatch(st, a, b)))(b))))(_scrutinee152_))))))))))))))))(a);
    }
    ...
    {
        return ((Func<CodexType, string>)((_scrutinee165_) => (_scrutinee165_ is IntegerTy _mIntegerTy165_ ? "+\u0012\u000E\u000D\u001D\u000D\u0015" : (_scrutinee165_ is NumberTy _mNumberTy165_ ? ",\u0019\u001A \u000D\u0015" : (_scrutinee165_ is TextTy _mTextTy165_ ? "(\u000D$\u000E" : (_scrutinee165_ is BooleanTy _mBooleanTy165_ ? ":\u0010\u0010\u0017\u000D\u000F\u0012" : (_scrutinee165_ is CharTy _mCharTy165_ ? "2\u0014\u000F\u0015" : (_scrutinee165_ is VoidTy _mVoidTy165_ ? ";\u0010\u0011\u0016" : (_scrutinee165_ is NothingTy _mNothingTy165_ ? ",\u0010\u000E\u0014\u0011\u0012\u001D" : (_scrutinee165_ is ErrorTy _mErrorTy165_ ? "'\u0015\u0015\u0010\u0015" : (_scrutinee165_ is FunTy _mFunTy165_ ? ((Func<CodexType, string>)((r) => ((Func<CodexType, string>)((p) => "6\u0019\u0012"))((CodexType)_mFunTy165_.Field0)))((CodexType)_mFunTy165_.Field1) : (_scrutinee165_ is ListTy _mListTy165_ ? ((Func<CodexType, string>)((e) => "1\u0011\u0013\u000E"))((CodexType)_mListTy165_.Field0) : (_scrutinee165_ is TypeVar _mTypeVar165_ ? ((Func<long, string>)((id) => string.Concat("(", _Cce.FromUnicode(id.ToString()))))((long)_mTypeVar165_.Field0) : (_scrutinee165_ is ForAllTy _mForAllTy165_ ? ((Func<CodexType, string>)((body) => ((Func<long, string>)((id) => "6\u0010\u0015)\u0017\u0017"))((long)_mForAllTy165_.Field0)))((CodexType)_mForAllTy165_.Field1) : (_scrutinee165_ is SumTy _mSumTy165_ ? ((Func<List<SumCtor>, string>)((ctors) => ((Func<Name, string>)((name) => string.Concat("-\u0019\u001AE", name.value)))((Name)_mSumTy165_.Field0)))((List<SumCtor>)_mSumTy165_.Field1) : (_scrutinee165_ is RecordTy _mRecordTy165_ ? ((Func<List<RecordField>, string>)((fields) => ((Func<Name, string>)((name) => string.Concat("/\u000D\u0018E", name.value)))((Name)_mRecordTy165_.Field0)))((List<RecordField>)_mRecordTy165_.Field1) : (_scrutinee165_ is ConstructedTy _mConstructedTy165_ ? ((Func<List<CodexType>, string>)((args) => ((Func<Name, string>)((name) => string.Concat("2\u0010\u0012E", name.value)))((Name)_mConstructedTy165_.Field0)))((List<CodexType>)_mConstructedTy165_.Field1) : throw new InvalidOperationException("Non-exhaustive match"))))))))))))))))))(ty);
    }

    public static CodexType deep_resolve(UnificationState st, CodexType ty)
    {
        return ((Func<CodexType, CodexType>)((resolved) => ((Func<CodexType, CodexType>)((_scrutinee166_) => (_scrutinee166_ is FunTy _mFunTy166_ ? ((Func<CodexType, CodexType>)((ret) => ((Func<CodexType, CodexType>)((param) => new FunTy(deep_resolve(st, param), deep_resolve(st, ret))))((CodexType)_mFunTy166_.Field0)))((CodexType)_mFunTy166_.Field1) : (_scrutinee166_ is ListTy _mListTy166_ ? ((Func<CodexType, CodexType>)((elem) => new ListTy(deep_resolve(st, elem))))((CodexType)_mListTy166_.Field0) : (_scrutinee166_ is ConstructedTy _mConstructedTy166_ ? ((Func<List<CodexType>, CodexType>)((args) => ((Func<Name, CodexType>)((name) => new ConstructedTy(name, deep_resolve_list(st, args, 0L, ((long)args.Count), new List<CodexType>()))))((Name)_mConstructedTy166_.Field0)))((List<CodexType>)_mConstructedTy166_.Field1) : (_scrutinee166_ is ForAllTy _mForAllTy166_ ? ((Func<CodexType, CodexType>)((body) => ((Func<long, CodexType>)((id) => new ForAllTy(id, deep_resolve(st, body))))((long)_mForAllTy166_.Field0)))((CodexType)_mForAllTy166_.Field1) : (_scrutinee166_ is SumTy _mSumTy166_ ? ((Func<List<SumCtor>, CodexType>)((ctors) => ((Func<Name, CodexType>)((name) => resolved))((Name)_mSumTy166_.Field0)))((List<SumCtor>)_mSumTy166_.Field1) : (_scrutinee166_ is RecordTy _mRecordTy166_ ? ((Func<List<RecordField>, CodexType>)((fields) => ((Func<Name, CodexType>)((name) => resolved))((Name)_mRecordTy166_.Field0)))((List<RecordField>)_mRecordTy166_.Field1) : ((Func<CodexType, CodexType>)((_) => resolved))(_scrutinee166_)))))))))(resolved)))(resolve(st, ty));
    }
    ...
    {
        return (r is ExprOk _mExprOk167_ ? ((Func<ParseState, Expr>)((st) => ((Func<Expr, Expr>)((e) => e))((Expr)_mExprOk167_.Field0)))((ParseState)_mExprOk167_.Field1) : throw new InvalidOperationException("Non-exhaustive match"));
    }
