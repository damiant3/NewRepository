...
public partial class IntegrationTests
{
    ...
    public void Text_length_compiles_to_csharp()
    {
        ...
        string? cs = CompileToCS(source, "strlen");
        Assert.NotNull(cs);
    ...
    public void Char_at_compiles_to_csharp()
    {
        ...
        string? cs = CompileToCS(source, "charat");
        Assert.NotNull(cs);
    ...
    public void Substring_compiles_to_csharp()
    {
        ...
        string? cs = CompileToCS(source, "substr");
        Assert.NotNull(cs);
    ...
    public void String_builtins_compose()
    {
        ...
        string? cs = CompileToCS(source, "compose");
        Assert.NotNull(cs);
    }
    ...
    public void String_ops_sample_compiles()
    {
        ...
        string? cs = CompileToCS(source, "stringops");
        Assert.NotNull(cs);
